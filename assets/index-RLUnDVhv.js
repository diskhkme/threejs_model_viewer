...
*/
const Za = "174", Ti = { ROTATE: 0, DOLLY: 1, PAN: 2 }, Ei = { ROTATE: 0, PAN: 1, DOLLY_PAN: 2, DOLLY_ROTATE: 3 }, eh = 0, Ao = 1, th = 2, ec = 1, nh = 2, xn = 3, En = 0, Ut = 1, sn = 2, On = 0, Ai = 1, wo = 2, Ro = 3, Co = 4, ih = 5, Zn = 100, sh = 101, rh = 102, ah = 103, oh = 104, lh = 200, ch = 201, hh = 202, uh = 203, aa = 204, oa = 205, dh = 206, fh = 207, ph = 208, mh = 209, gh = 210, _h = 211, xh = 212, vh = 213, Mh = 214, la = 0, ca = 1, ha = 2, Pi = 3, ua = 4, da = 5, fa = 6, pa = 7, tc = 0, yh = 1, Sh = 2, Bn = 0, Eh = 1, bh = 2, Th = 3, Ah = 4, wh = 5, Rh = 6, Ch = 7, Po = "attached", Ph = "detached", nc = 300, Li = 301, Di = 302, ma = 303, ga = 304, mr = 306, Ii = 1e3, Un = 1001, cr = 1002, Ct = 1003, ic = 1004, ss = 1005, Bt = 1006, nr = 1007, Mn = 1008, bn = 1009, sc = 1010, rc = 1011, hs = 1012, Ja = 1013, ei = 1014, Jt = 1015, _s = 1016, Qa = 1017, eo = 1018, Ui = 1020, ac = 35902, oc = 1021, lc = 1022, Xt = 1023, cc = 1024, hc = 1025, wi = 1026, Ni = 1027, to = 1028, no = 1029, uc = 1030, io = 1031, so = 1033, ir = 33776, sr = 33777, rr = 33778, ar = 33779, _a = 35840, xa = 35841, va = 35842, Ma = 35843, ya = 36196, Sa = 37492, Ea = 37496, ba = 37808, Ta = 37809, Aa = 37810, wa = 37811, Ra = 37812, Ca = 37813, Pa = 37814, La = 37815, Da = 37816, Ia = 37817, Ua = 37818, Na = 37819, Fa = 37820, Oa = 37821, or = 36492, Ba = 36494, za = 36495, dc = 36283, ka = 36284, Ha = 36285, Va = 36286, us = 2300, ds = 2301, yr = 2302, Lo = 2400, Do = 2401, Io = 2402, Lh = 2500, Dh = 0, fc = 1, Ga = 2, Ih = 3200, Uh = 3201, pc = 0, Nh = 1, In = "", xt = "srgb", Lt = "srgb-linear", hr = "linear", Qe = "srgb", si = 7680, Uo = 519, Fh = 512, Oh = 513, Bh = 514, mc = 515, zh = 516, kh = 517, Hh = 518, Vh = 519, Wa = 35044, No = "300 es", yn = 2e3, ur = 2001;
class ni {
...
const gc = { DEG2RAD: as, RAD2DEG: Fi, generateUUID: Qt, clamp: Ne, euclideanModulo: ro, mapLinear: Gh, inverseLerp: Wh, lerp: os, damp: Xh, pingpong: Yh, smoothstep: qh, smootherstep: jh, randInt: $h, randFloat: Kh, randFloatSpread: Zh, seededRandom: Jh, degToRad: Qh, radToDeg: eu, isPowerOfTwo: tu, ceilPowerOfTwo: nu, floorPowerOfTwo: iu, setQuaternionFromProperEuler: su, normalize: Ze, denormalize: Zt };
class ye {
  constructor(e = 0, t = 0) {
...
class De {
  ...
  multiplyMatrices(e, t) {
    const n = e.elements, i = t.elements, r = this.elements, a = n[0], o = n[3], l = n[6], c = n[1], h = n[4], u = n[7], d = n[2], p = n[5], g = n[8], _ = i[0], m = i[3], f = i[6], T = i[1], b = i[4], y = i[7], L = i[2], C = i[5], A = i[8];
    return r[0] = a * _ + o * T + l * L, r[3] = a * m + o * b + l * C, r[6] = a * f + o * y + l * A, r[1] = c * _ + h * T + u * L, r[4] = c * m + h * b + u * C, r[7] = c * f + h * y + u * A, r[2] = d * _ + p * T + g * L, r[5] = d * m + p * b + g * C, r[8] = d * f + p * y + g * A, this;
  }
  multiplyScalar(e) {
...
const Oo = {};
function $n(s) {
  s in Oo || (Oo[s] = true, console.warn(s));
}
function au(s, e, t) {
...
const Bo = new De().set(0.4123908, 0.3575843, 0.1804808, 0.212639, 0.7151687, 0.0721923, 0.0193308, 0.1191948, 0.9505322), zo = new De().set(3.2409699, -1.5373832, -0.4986108, -0.9692436, 1.8759675, 0.0415551, 0.0556301, -0.203977, 1.0569715);
function cu() {
  const s = { enabled: true, workingColorSpace: Lt, spaces: {}, convert: function(i, r, a) {
    return this.enabled === false || r === a || !r || !a || (this.spaces[r].transfer === Qe && (i.r = Sn(i.r), i.g = Sn(i.g), i.b = Sn(i.b)), this.spaces[r].primaries !== this.spaces[a].primaries && (i.applyMatrix3(this.spaces[r].toXYZ), i.applyMatrix3(this.spaces[a].fromXYZ)), this.spaces[a].transfer === Qe && (i.r = Ri(i.r), i.g = Ri(i.g), i.b = Ri(i.b))), i;
    ...
    return i === In ? hr : this.spaces[i].transfer;
  ...
  return s.define({ [Lt]: { primaries: e, whitePoint: n, transfer: hr, toXYZ: Bo, fromXYZ: zo, luminanceCoefficients: t, workingColorSpaceConfig: { unpackColorSpace: xt }, outputColorSpaceConfig: { drawingBufferColorSpace: xt } }, [xt]: { primaries: e, whitePoint: n, transfer: Qe, toXYZ: Bo, fromXYZ: zo, luminanceCoefficients: t, outputColorSpaceConfig: { drawingBufferColorSpace: xt } } }), s;
}
const Ve = cu();
function Sn(s) {
...
class ao {
  constructor(e = null) {
    this.isSource = true, Object.defineProperty(this, "id", { value: uu++ }), this.uuid = Qt(), this.data = e, this.dataReady = true, this.version = 0;
  }
  set needsUpdate(e) {
    e === true && this.version++;
  }
  toJSON(e) {
    ...
    if (i !== null) {
      ...
      if (Array.isArray(i)) {
        r = [];
        for (let a = 0, o = i.length; a < o; a++) i[a].isDataTexture ? r.push(Er(i[a].image)) : r.push(Er(i[a]));
      } else r = Er(i);
      n.url = r;
    }
...
function Er(s) {
  return typeof HTMLImageElement < "u" && s instanceof HTMLImageElement || typeof HTMLCanvasElement < "u" && s instanceof HTMLCanvasElement || typeof ImageBitmap < "u" && s instanceof ImageBitmap ? hu.getDataURL(s) : s.data ? { data: Array.from(s.data), width: s.width, height: s.height, type: s.data.constructor.name } : (console.warn("THREE.Texture: Unable to serialize Texture."), {});
}
let du = 0;
class ft extends ni {
  constructor(e = ft.DEFAULT_IMAGE, t = ft.DEFAULT_MAPPING, n = Un, i = Un, r = Bt, a = Mn, o = Xt, l = bn, c = ft.DEFAULT_ANISOTROPY, h = In) {
    super(), this.isTexture = true, Object.defineProperty(this, "id", { value: du++ }), this.uuid = Qt(), this.name = "", this.source = new ao(e), this.mipmaps = [], this.mapping = t, this.channel = 0, this.wrapS = n, this.wrapT = i, this.magFilter = r, this.minFilter = a, this.anisotropy = c, this.format = o, this.internalFormat = null, this.type = l, this.offset = new ye(0, 0), this.repeat = new ye(1, 1), this.center = new ye(0, 0), this.rotation = 0, this.matrixAutoUpdate = true, this.matrix = new De(), this.generateMipmaps = true, this.premultiplyAlpha = false, this.flipY = true, this.unpackAlignment = 4, this.colorSpace = h, this.userData = {}, this.version = 0, this.onUpdate = null, this.renderTarget = null, this.isRenderTargetTexture = false, this.pmremVersion = 0;
  }
  get image() {
...
class qe {
  ...
  setAxisAngleFromRotationMatrix(e) {
    ...
    if (Math.abs(h - d) < 0.01 && Math.abs(u - _) < 0.01 && Math.abs(g - m) < 0.01) {
      ...
      t = Math.PI;
      const b = (c + 1) / 2, y = (p + 1) / 2, L = (f + 1) / 2, C = (h + d) / 4, A = (u + _) / 4, N = (g + m) / 4;
      return b > y && b > L ? b < 0.01 ? (n = 0, i = 0.707106781, r = 0.707106781) : (n = Math.sqrt(b), i = C / n, r = A / n) : y > L ? y < 0.01 ? (n = 0.707106781, i = 0, r = 0.707106781) : (i = Math.sqrt(y), n = C / i, r = N / i) : L < 0.01 ? (n = 0.707106781, i = 0.707106781, r = 0) : (r = Math.sqrt(L), n = A / r, i = N / r), this.set(n, i, r, t), this;
    }
...
class fu extends ni {
  ...
  copy(e) {
    ...
    for (let t = 0, n = e.textures.length; t < n; t++) {
      ...
      this.textures[t].source = new ao(i);
    }
...
class xc extends ft {
  constructor(e = null, t = 1, n = 1, i = 1) {
    super(null), this.isDataArrayTexture = true, this.image = { data: e, width: t, height: n, depth: i }, this.magFilter = Ct, this.minFilter = Ct, this.wrapR = Un, this.generateMipmaps = false, this.flipY = false, this.unpackAlignment = 1, this.layerUpdates = /* @__PURE__ */ new Set();
  }
  addLayerUpdate(e) {
...
class pu extends ft {
  constructor(e = null, t = 1, n = 1, i = 1) {
    super(null), this.isData3DTexture = true, this.image = { data: e, width: t, height: n, depth: i }, this.magFilter = Ct, this.minFilter = Ct, this.wrapR = Un, this.generateMipmaps = false, this.flipY = false, this.unpackAlignment = 1;
  }
}
class an {
  constructor(e = 0, t = 0, n = 0, i = 1) {
  ...
  static slerpFlat(e, t, n, i, r, a, o) {
    ...
    if (u !== _ || l !== d || c !== p || h !== g) {
      let m = 1 - o;
      const f = l * d + c * p + h * g + u * _, T = f >= 0 ? 1 : -1, b = 1 - f * f;
      if (b > Number.EPSILON) {
        const L = Math.sqrt(b), C = Math.atan2(L, f * T);
        m = Math.sin(m * C) / L, o = Math.sin(o * C) / L;
      }
      const y = o * T;
...
class tn {
  ...
  intersectsTriangle(e) {
    ...
    this.getCenter(Yi), As.subVectors(this.max, Yi), ai.subVectors(e.a, Yi), oi.subVectors(e.b, Yi), li.subVectors(e.c, Yi), Tn.subVectors(oi, ai), An.subVectors(li, oi), Vn.subVectors(ai, li);
    let t = [0, -Tn.z, Tn.y, 0, -An.z, An.y, 0, -Vn.z, Vn.y, Tn.z, 0, -Tn.x, An.z, 0, -An.x, Vn.z, 0, -Vn.x, -Tn.y, Tn.x, 0, -An.y, An.x, 0, -Vn.y, Vn.x, 0];
    return !Tr(t, ai, oi, li, As) || (t = [1, 0, 0, 0, 1, 0, 0, 0, 1], !Tr(t, ai, oi, li, As)) ? false : (ws.crossVectors(Tn, An), t = [ws.x, ws.y, ws.z], Tr(t, ai, oi, li, As));
  }
  clampPoint(e, t) {
...
const dn = [new R(), new R(), new R(), new R(), new R(), new R(), new R(), new R()], jt = new R(), Ts = new tn(), ai = new R(), oi = new R(), li = new R(), Tn = new R(), An = new R(), Vn = new R(), Yi = new R(), As = new R(), ws = new R(), Gn = new R();
...
const mu = new tn(), qi = new R(), Ar = new R();
class ln {
  ...
  setFromPoints(e, t) {
    const n = this.center;
    t !== void 0 ? n.copy(t) : mu.setFromPoints(e).getCenter(n);
    let i = 0;
  ...
  union(e) {
    return e.isEmpty() ? this : this.isEmpty() ? (this.copy(e), this) : (this.center.equals(e.center) === true ? this.radius = Math.max(this.radius, e.radius) : (Ar.subVectors(e.center, this.center).setLength(e.radius), this.expandByPoint(qi.copy(e.center).add(Ar)), this.expandByPoint(qi.copy(e.center).sub(Ar))), this);
  }
  equals(e) {
...
const fn = new R(), wr = new R(), Rs = new R(), wn = new R(), Rr = new R(), Cs = new R(), Cr = new R();
class xs {
  ...
  distanceSqToSegment(e, t, n, i) {
    wr.copy(e).add(t).multiplyScalar(0.5), Rs.copy(t).sub(e).normalize(), wn.copy(this.origin).sub(wr);
    const r = e.distanceTo(t) * 0.5, a = -this.direction.dot(Rs), o = wn.dot(this.direction), l = -wn.dot(Rs), c = wn.lengthSq(), h = Math.abs(1 - a * a);
    let u, d, p, g;
    ...
    return n && n.copy(this.origin).addScaledVector(this.direction, u), i && i.copy(wr).addScaledVector(Rs, d), p;
  }
  intersectSphere(e, t) {
  ...
  intersectTriangle(e, t, n, i, r) {
    Rr.subVectors(t, e), Cs.subVectors(n, e), Cr.crossVectors(Rr, Cs);
    ...
    const l = o * this.direction.dot(Cs.crossVectors(wn, Cs));
    if (l < 0) return null;
    const c = o * this.direction.dot(Rr.cross(wn));
...
class Pe {
  ...
  makeRotationFromQuaternion(e) {
    return this.compose(gu, e, _u);
  }
  lookAt(e, t, n) {
    const i = this.elements;
    return Ft.subVectors(e, t), Ft.lengthSq() === 0 && (Ft.z = 1), Ft.normalize(), Rn.crossVectors(n, Ft), Rn.lengthSq() === 0 && (Math.abs(n.z) === 1 ? Ft.x += 1e-4 : Ft.z += 1e-4, Ft.normalize(), Rn.crossVectors(n, Ft)), Rn.normalize(), Ps.crossVectors(Ft, Rn), i[0] = Rn.x, i[4] = Ps.x, i[8] = Ft.x, i[1] = Rn.y, i[5] = Ps.y, i[9] = Ft.y, i[2] = Rn.z, i[6] = Ps.z, i[10] = Ft.z, this;
  }
  multiply(e) {
    return this.multiplyMatrices(this, e);
  }
  ...
  multiplyMatrices(e, t) {
    const n = e.elements, i = t.elements, r = this.elements, a = n[0], o = n[4], l = n[8], c = n[12], h = n[1], u = n[5], d = n[9], p = n[13], g = n[2], _ = n[6], m = n[10], f = n[14], T = n[3], b = n[7], y = n[11], L = n[15], C = i[0], A = i[4], N = i[8], S = i[12], M = i[1], P = i[5], G = i[9], z = i[13], j = i[2], $ = i[6], X = i[10], Z = i[14], H = i[3], se = i[7], he = i[11], xe = i[15];
    return r[0] = a * C + o * M + l * j + c * H, r[4] = a * A + o * P + l * $ + c * se, r[8] = a * N + o * G + l * X + c * he, r[12] = a * S + o * z + l * Z + c * xe, r[1] = h * C + u * M + d * j + p * H, r[5] = h * A + u * P + d * $ + p * se, r[9] = h * N + u * G + d * X + p * he, r[13] = h * S + u * z + d * Z + p * xe, r[2] = g * C + _ * M + m * j + f * H, r[6] = g * A + _ * P + m * $ + f * se, r[10] = g * N + _ * G + m * X + f * he, r[14] = g * S + _ * z + m * Z + f * xe, r[3] = T * C + b * M + y * j + L * H, r[7] = T * A + b * P + y * $ + L * se, r[11] = T * N + b * G + y * X + L * he, r[15] = T * S + b * z + y * Z + L * xe, this;
  }
  multiplyScalar(e) {
    const t = this.elements;
  ...
  compose(e, t, n) {
    const i = this.elements, r = t._x, a = t._y, o = t._z, l = t._w, c = r + r, h = a + a, u = o + o, d = r * c, p = r * h, g = r * u, _ = a * h, m = a * u, f = o * u, T = l * c, b = l * h, y = l * u, L = n.x, C = n.y, A = n.z;
    return i[0] = (1 - (_ + f)) * L, i[1] = (p + y) * L, i[2] = (g - b) * L, i[3] = 0, i[4] = (p - y) * C, i[5] = (1 - (d + f)) * C, i[6] = (m + T) * C, i[7] = 0, i[8] = (g + b) * A, i[9] = (m - T) * A, i[10] = (1 - (d + _)) * A, i[11] = 0, i[12] = e.x, i[13] = e.y, i[14] = e.z, i[15] = 1, this;
  }
  decompose(e, t, n) {
    const i = this.elements;
    let r = ci.set(i[0], i[1], i[2]).length();
    const a = ci.set(i[4], i[5], i[6]).length(), o = ci.set(i[8], i[9], i[10]).length();
  ...
  makePerspective(e, t, n, i, r, a, o = yn) {
    ...
    else if (o === ur) p = -a / (a - r), g = -a * r / (a - r);
...
const ci = new R(), $t = new Pe(), gu = new R(0, 0, 0), _u = new R(1, 1, 1), Rn = new R(), Ps = new R(), Ft = new R(), Ho = new Pe(), Vo = new an();
class on {
...
let xu = 0;
const Go = new R(), hi = new an(), pn = new Pe(), Ls = new R(), ji = new R(), vu = new R(), Mu = new an(), Wo = new R(1, 0, 0), Xo = new R(0, 1, 0), Yo = new R(0, 0, 1), qo = { type: "added" }, yu = { type: "removed" }, ui = { type: "childadded", child: null }, Pr = { type: "childremoved", child: null };
class rt extends ni {
  constructor() {
    super(), this.isObject3D = true, Object.defineProperty(this, "id", { value: xu++ }), this.uuid = Qt(), this.name = "", this.type = "Object3D", this.parent = null, this.children = [], this.up = rt.DEFAULT_UP.clone();
    const e = new R(), t = new on(), n = new an(), i = new R(1, 1, 1);
    function r() {
  ...
  lookAt(e, t, n) {
    ...
    const i = this.parent;
    this.updateWorldMatrix(true, false), ji.setFromMatrixPosition(this.matrixWorld), this.isCamera || this.isLight ? pn.lookAt(ji, Ls, this.up) : pn.lookAt(Ls, ji, this.up), this.quaternion.setFromRotationMatrix(pn), i && (pn.extractRotation(i.matrixWorld), hi.setFromRotationMatrix(pn), this.quaternion.premultiply(hi.invert()));
  }
  add(e) {
  ...
  remove(e) {
    ...
    return t !== -1 && (e.parent = null, this.children.splice(t, 1), e.dispatchEvent(yu), Pr.child = e, this.dispatchEvent(Pr), Pr.child = null), this;
  }
  removeFromParent() {
    const e = this.parent;
  ...
  attach(e) {
    return this.updateWorldMatrix(true, false), pn.copy(this.matrixWorld).invert(), e.parent !== null && (e.parent.updateWorldMatrix(true, false), pn.multiply(e.parent.matrixWorld)), e.applyMatrix4(pn), e.removeFromParent(), e.parent = this, this.children.push(e), e.updateWorldMatrix(false, true), e.dispatchEvent(qo), ui.child = e, this.dispatchEvent(ui), ui.child = null, this;
  }
  getObjectById(e) {
  ...
  getWorldQuaternion(e) {
    return this.updateWorldMatrix(true, false), this.matrixWorld.decompose(ji, e, vu), e;
  }
  getWorldScale(e) {
    return this.updateWorldMatrix(true, false), this.matrixWorld.decompose(ji, Mu, e), e;
  }
  getWorldDirection(e) {
...
const Kt = new R(), mn = new R(), Lr = new R(), gn = new R(), di = new R(), fi = new R(), jo = new R(), Dr = new R(), Ir = new R(), Ur = new R(), Nr = new qe(), Fr = new qe(), Or = new qe();
class Wt {
  ...
  static getBarycoord(e, t, n, i, r) {
    Kt.subVectors(i, t), mn.subVectors(n, t), Lr.subVectors(e, t);
    const a = Kt.dot(Kt), o = Kt.dot(mn), l = Kt.dot(Lr), c = mn.dot(mn), h = mn.dot(Lr), u = a * c - o * o;
  ...
  static getInterpolation(e, t, n, i, r, a, o, l) {
    return this.getBarycoord(e, t, n, i, gn) === null ? (l.x = 0, l.y = 0, "z" in l && (l.z = 0), "w" in l && (l.w = 0), null) : (l.setScalar(0), l.addScaledVector(r, gn.x), l.addScaledVector(a, gn.y), l.addScaledVector(o, gn.z), l);
  }
  static getInterpolatedAttribute(e, t, n, i, r, a) {
    return Nr.setScalar(0), Fr.setScalar(0), Or.setScalar(0), Nr.fromBufferAttribute(e, t), Fr.fromBufferAttribute(e, n), Or.fromBufferAttribute(e, i), a.setScalar(0), a.addScaledVector(Nr, r.x), a.addScaledVector(Fr, r.y), a.addScaledVector(Or, r.z), a;
  }
  static isFrontFacing(e, t, n, i) {
    return Kt.subVectors(n, t), mn.subVectors(e, t), Kt.cross(mn).dot(i) < 0;
  }
  set(e, t, n) {
  ...
  getArea() {
    return Kt.subVectors(this.c, this.b), mn.subVectors(this.a, this.b), Kt.cross(mn).length() * 0.5;
  }
  getMidpoint(e) {
  ...
  closestPointToPoint(e, t) {
    ...
    const d = l * u - h * c;
    if (d <= 0 && l >= 0 && h <= 0) return a = l / (l - h), t.copy(n).addScaledVector(di, a);
    Ur.subVectors(e, r);
    const p = di.dot(Ur), g = fi.dot(Ur);
    if (g >= 0 && p <= g) return t.copy(r);
    const _ = p * c - l * g;
    if (_ <= 0 && c >= 0 && g <= 0) return o = c / (c - g), t.copy(n).addScaledVector(fi, o);
    const m = h * g - p * u;
    if (m <= 0 && u - h >= 0 && p - g >= 0) return jo.subVectors(r, i), o = (u - h) / (u - h + (p - g)), t.copy(i).addScaledVector(jo, o);
    const f = 1 / (m + _ + d);
...
class Ee {
  ...
  setHSL(e, t, n, i = Ve.workingColorSpace) {
    if (e = ro(e, 1), t = Ne(t, 0, 1), n = Ne(n, 0, 1), t === 0) this.r = this.g = this.b = n;
    else {
  ...
  lerpHSL(e, t) {
    this.getHSL(Cn), e.getHSL(Ds);
    const n = os(Cn.h, Ds.h, t), i = os(Cn.s, Ds.s, t), r = os(Cn.l, Ds.l, t);
...
class en extends ni {
  constructor() {
    super(), this.isMaterial = true, Object.defineProperty(this, "id", { value: Su++ }), this.uuid = Qt(), this.name = "", this.type = "Material", this.blending = Ai, this.side = En, this.vertexColors = false, this.opacity = 1, this.transparent = false, this.alphaHash = false, this.blendSrc = aa, this.blendDst = oa, this.blendEquation = Zn, this.blendSrcAlpha = null, this.blendDstAlpha = null, this.blendEquationAlpha = null, this.blendColor = new Ee(0, 0, 0), this.blendAlpha = 0, this.depthFunc = Pi, this.depthTest = true, this.depthWrite = true, this.stencilWriteMask = 255, this.stencilFunc = Uo, this.stencilRef = 0, this.stencilFuncMask = 255, this.stencilFail = si, this.stencilZFail = si, this.stencilZPass = si, this.stencilWrite = false, this.clippingPlanes = null, this.clipIntersection = false, this.clipShadows = false, this.shadowSide = null, this.colorWrite = true, this.precision = null, this.polygonOffset = false, this.polygonOffsetFactor = 0, this.polygonOffsetUnits = 0, this.dithering = false, this.alphaToCoverage = false, this.premultipliedAlpha = false, this.forceSinglePass = false, this.visible = true, this.toneMapped = true, this.userData = {}, this.version = 0, this._alphaTest = 0;
  }
  get alphaTest() {
...
const ut = new R(), Is = new ye();
let Eu = 0;
class Pt {
  constructor(e, t, n = false) {
    if (Array.isArray(e)) throw new TypeError("THREE.BufferAttribute: array should be a Typed Array.");
    this.isBufferAttribute = true, Object.defineProperty(this, "id", { value: Eu++ }), this.name = "", this.array = e, this.itemSize = t, this.count = e !== void 0 ? e.length / t : 0, this.normalized = n, this.usage = Wa, this.updateRanges = [], this.gpuType = Jt, this.version = 0;
  }
  onUploadCallback() {
  }
  set needsUpdate(e) {
  ...
  applyMatrix3(e) {
    if (this.itemSize === 2) for (let t = 0, n = this.count; t < n; t++) Is.fromBufferAttribute(this, t), Is.applyMatrix3(e), this.setXY(t, Is.x, Is.y);
...
class vt extends ni {
  ...
  computeBoundingBox() {
    ...
    if (e !== void 0) {
      if (this.boundingBox.setFromBufferAttribute(e), t) for (let n = 0, i = t.length; n < i; n++) {
        const r = t[n];
        Ot.setFromBufferAttribute(r), this.morphTargetsRelative ? (gt.addVectors(this.boundingBox.min, Ot.min), this.boundingBox.expandByPoint(gt), gt.addVectors(this.boundingBox.max, Ot.max), this.boundingBox.expandByPoint(gt)) : (this.boundingBox.expandByPoint(Ot.min), this.boundingBox.expandByPoint(Ot.max));
      }
  ...
  computeBoundingSphere() {
    ...
    if (e) {
      ...
      if (Ot.setFromBufferAttribute(e), t) for (let r = 0, a = t.length; r < a; r++) {
        const o = t[r];
        $i.setFromBufferAttribute(o), this.morphTargetsRelative ? (gt.addVectors(Ot.min, $i.min), Ot.expandByPoint(gt), gt.addVectors(Ot.max, $i.max), Ot.expandByPoint(gt)) : (Ot.expandByPoint($i.min), Ot.expandByPoint($i.max));
      }
      Ot.getCenter(n);
      let i = 0;
      ...
      if (t) for (let r = 0, a = t.length; r < a; r++) {
        ...
        for (let c = 0, h = o.count; c < h; c++) gt.fromBufferAttribute(o, c), l && (pi.fromBufferAttribute(e, c), gt.add(pi)), i = Math.max(i, n.distanceToSquared(gt));
      }
  ...
  computeTangents() {
    ...
    const c = new R(), h = new R(), u = new R(), d = new ye(), p = new ye(), g = new ye(), _ = new R(), m = new R();
    function f(N, S, M) {
    ...
    for (let N = 0, S = T.length; N < S; ++N) {
      const M = T[N], P = M.start, G = M.count;
      for (let z = P, j = P + G; z < j; z += 3) f(e.getX(z + 0), e.getX(z + 1), e.getX(z + 2));
    }
    const b = new R(), y = new R(), L = new R(), C = new R();
    function A(N) {
      L.fromBufferAttribute(i, N), C.copy(L);
      const S = o[N];
      b.copy(S), b.sub(L.multiplyScalar(L.dot(S))).normalize(), y.crossVectors(C, S);
      const P = y.dot(l[N]) < 0 ? -1 : 1;
      a.setXYZW(N, b.x, b.y, b.z, P);
    }
    for (let N = 0, S = T.length; N < S; ++N) {
      const M = T[N], P = M.start, G = M.count;
...
const $o = new Pe(), Wn = new xs(), Us = new ln(), Ko = new R(), Ns = new R(), Fs = new R(), Os = new R(), kr = new R(), Bs = new R(), Zo = new R(), zs = new R();
class bt extends rt {
  constructor(e = new vt(), t = new Nn()) {
  ...
  getVertexPosition(e, t) {
    ...
    if (r && o) {
      ...
      for (let l = 0, c = r.length; l < c; l++) {
        const h = o[l], u = r[l];
        h !== 0 && (kr.fromBufferAttribute(u, e), a ? Bs.addScaledVector(kr, h) : Bs.addScaledVector(kr.sub(t), h));
      }
      t.add(Bs);
    }
    return t;
  ...
  raycast(e, t) {
    ...
    i !== void 0 && (n.boundingSphere === null && n.computeBoundingSphere(), Us.copy(n.boundingSphere), Us.applyMatrix4(r), Wn.copy(e.ray).recast(e.near), !(Us.containsPoint(Wn.origin) === false && (Wn.intersectSphere(Us, Ko) === null || Wn.origin.distanceToSquared(Ko) > (e.far - e.near) ** 2)) && ($o.copy(r).invert(), Wn.copy(e.ray).applyMatrix4($o), !(n.boundingBox !== null && Wn.intersectsBox(n.boundingBox) === false) && this._computeIntersections(e, t, Wn)));
  }
  _computeIntersections(e, t, n) {
    ...
    if (o !== null) if (Array.isArray(a)) for (let g = 0, _ = d.length; g < _; g++) {
      const m = d[g], f = a[m.materialIndex], T = Math.max(m.start, p.start), b = Math.min(o.count, Math.min(m.start + m.count, p.start + p.count));
      for (let y = T, L = b; y < L; y += 3) {
        const C = o.getX(y), A = o.getX(y + 1), N = o.getX(y + 2);
        i = ks(this, f, e, n, c, h, u, C, A, N), i && (i.faceIndex = Math.floor(y / 3), i.face.materialIndex = m.materialIndex, t.push(i));
      }
    }
    else {
      ...
      for (let m = g, f = _; m < f; m += 3) {
        ...
        i = ks(this, a, e, n, c, h, u, T, b, y), i && (i.faceIndex = Math.floor(m / 3), t.push(i));
      }
    }
    else if (l !== void 0) if (Array.isArray(a)) for (let g = 0, _ = d.length; g < _; g++) {
      const m = d[g], f = a[m.materialIndex], T = Math.max(m.start, p.start), b = Math.min(l.count, Math.min(m.start + m.count, p.start + p.count));
      for (let y = T, L = b; y < L; y += 3) {
        const C = y, A = y + 1, N = y + 2;
        i = ks(this, f, e, n, c, h, u, C, A, N), i && (i.faceIndex = Math.floor(y / 3), i.face.materialIndex = m.materialIndex, t.push(i));
      }
    }
    else {
...
function Tu(s, e, t, n, i, r, a, o) {
  let l;
  if (e.side === Ut ? l = n.intersectTriangle(a, r, i, true, o) : l = n.intersectTriangle(i, r, a, e.side === En, o), l === null) return null;
  zs.copy(o), zs.applyMatrix4(s.matrixWorld);
  const c = t.ray.origin.distanceTo(zs);
  return c < t.near || c > t.far ? null : { distance: c, point: zs.clone(), object: s };
}
function ks(s, e, t, n, i, r, a, o, l, c) {
  s.getVertexPosition(o, Ns), s.getVertexPosition(l, Fs), s.getVertexPosition(c, Os);
  const h = Tu(s, e, t, n, Ns, Fs, Os, Zo);
  if (h) {
    const u = new R();
    Wt.getBarycoord(Zo, Ns, Fs, Os, u), i && (h.uv = Wt.getInterpolatedAttribute(i, o, l, c, u, new ye())), r && (h.uv1 = Wt.getInterpolatedAttribute(r, o, l, c, u, new ye())), a && (h.normal = Wt.getInterpolatedAttribute(a, o, l, c, u, new R()), h.normal.dot(n.direction) > 0 && h.normal.multiplyScalar(-1));
    const d = { a: o, b: l, c, normal: new R(), materialIndex: 0 };
    Wt.getNormal(Ns, Fs, Os, d.normal), h.face = d, h.barycoord = u;
  }
  return h;
}
class vs extends vt {
  constructor(e = 1, t = 1, n = 1, i = 1, r = 1, a = 1) {
    ...
    const l = [], c = [], h = [], u = [];
    let d = 0, p = 0;
    g("z", "y", "x", -1, -1, n, t, e, a, r, 0), g("z", "y", "x", 1, -1, n, t, -e, a, r, 1), g("x", "z", "y", 1, 1, e, n, t, i, a, 2), g("x", "z", "y", 1, -1, e, n, -t, i, a, 3), g("x", "y", "z", 1, -1, e, t, n, i, r, 4), g("x", "y", "z", -1, -1, e, t, -n, i, r, 5), this.setIndex(l), this.setAttribute("position", new Tt(c, 3)), this.setAttribute("normal", new Tt(h, 3)), this.setAttribute("uv", new Tt(u, 2));
    function g(_, m, f, T, b, y, L, C, A, N, S) {
      const M = y / A, P = L / N, G = y / 2, z = L / 2, j = C / 2, $ = A + 1, X = N + 1;
      let Z = 0, H = 0;
      const se = new R();
      for (let he = 0; he < X; he++) {
        ...
        for (let Fe = 0; Fe < $; Fe++) {
          const tt = Fe * M - G;
          se[_] = tt * T, se[m] = xe * b, se[f] = j, c.push(se.x, se.y, se.z), se[_] = 0, se[m] = 0, se[f] = C > 0 ? 1 : -1, h.push(se.x, se.y, se.z), u.push(Fe / A), u.push(1 - he / N), Z += 1;
        }
      }
      for (let he = 0; he < N; he++) for (let xe = 0; xe < A; xe++) {
        const Fe = d + xe + $ * he, tt = d + xe + $ * (he + 1), W = d + (xe + 1) + $ * (he + 1), ee = d + (xe + 1) + $ * he;
        l.push(Fe, tt, ee), l.push(tt, W, ee), H += 6;
      }
      o.addGroup(p, H, S), p += H, d += Z;
    }
  }
  copy(e) {
...
class zn extends en {
  constructor(e) {
    super(), this.isShaderMaterial = true, this.type = "ShaderMaterial", this.defines = {}, this.uniforms = {}, this.uniformsGroups = [], this.vertexShader = Ru, this.fragmentShader = Cu, this.linewidth = 1, this.wireframe = false, this.wireframeLinewidth = 1, this.fog = false, this.lights = false, this.clipping = false, this.forceSinglePass = true, this.extensions = { clipCullDistance: false, multiDraw: false }, this.defaultAttributeValues = { color: [1, 1, 1], uv: [0, 0], uv1: [0, 0] }, this.index0AttributeName = void 0, this.uniformsNeedUpdate = false, this.glslVersion = null, e !== void 0 && this.setValues(e);
  }
  copy(e) {
...
class bc extends rt {
  constructor() {
    super(), this.isCamera = true, this.type = "Camera", this.matrixWorldInverse = new Pe(), this.projectionMatrix = new Pe(), this.projectionMatrixInverse = new Pe(), this.coordinateSystem = yn;
  }
  copy(e, t) {
...
const Pn = new R(), Jo = new ye(), Qo = new ye();
class Et extends bc {
  ...
  getViewSize(e, t) {
    return this.getViewBounds(e, Jo, Qo), t.subVectors(Qo, Jo);
  }
...
class Pu extends rt {
  constructor(e, t, n) {
    ...
    const i = new Et(mi, gi, e, t);
    i.layers = this.layers, this.add(i);
    const r = new Et(mi, gi, e, t);
    r.layers = this.layers, this.add(r);
    const a = new Et(mi, gi, e, t);
    a.layers = this.layers, this.add(a);
    const o = new Et(mi, gi, e, t);
    o.layers = this.layers, this.add(o);
    const l = new Et(mi, gi, e, t);
    l.layers = this.layers, this.add(l);
    const c = new Et(mi, gi, e, t);
  ...
  updateCoordinateSystem() {
    ...
    else if (e === ur) n.up.set(0, -1, 0), n.lookAt(-1, 0, 0), i.up.set(0, -1, 0), i.lookAt(1, 0, 0), r.up.set(0, 0, 1), r.lookAt(0, 1, 0), a.up.set(0, 0, -1), a.lookAt(0, -1, 0), o.up.set(0, -1, 0), o.lookAt(0, 0, 1), l.up.set(0, -1, 0), l.lookAt(0, 0, -1);
...
class Lu extends ti {
  constructor(e = 1, t = {}) {
    ...
    this.texture = new Tc(i, t.mapping, t.wrapS, t.wrapT, t.magFilter, t.minFilter, t.format, t.type, t.anisotropy, t.colorSpace), this.texture.isRenderTargetTexture = true, this.texture.generateMipmaps = t.generateMipmaps !== void 0 ? t.generateMipmaps : false, this.texture.minFilter = t.minFilter !== void 0 ? t.minFilter : Bt;
  }
  fromEquirectangularTexture(e, t) {
    ...
    return t.minFilter === Mn && (t.minFilter = Bt), new Pu(1, 10, this).update(e, a), t.minFilter = o, a.geometry.dispose(), a.material.dispose(), this;
  }
  clear(e, t, n, i) {
...
class Hr {
  ...
  update(e, t, n) {
    ...
    if (e && t.session.visibilityState !== "visible-blurred") {
      ...
      o !== null && (i = t.getPose(e.targetRaySpace, n), i === null && r !== null && (i = r), i !== null && (o.matrix.fromArray(i.transform.matrix), o.matrix.decompose(o.position, o.rotation, o.scale), o.matrixWorldNeedsUpdate = true, i.linearVelocity ? (o.hasLinearVelocity = true, o.linearVelocity.copy(i.linearVelocity)) : o.hasLinearVelocity = false, i.angularVelocity ? (o.hasAngularVelocity = true, o.angularVelocity.copy(i.angularVelocity)) : o.hasAngularVelocity = false, this.dispatchEvent(Du)));
    }
...
class wc {
  constructor(e, t) {
    this.isInterleavedBuffer = true, this.array = e, this.stride = t, this.count = e !== void 0 ? e.length / t : 0, this.usage = Wa, this.updateRanges = [], this.version = 0, this.uuid = Qt();
  }
  onUploadCallback() {
  }
  set needsUpdate(e) {
...
let _i;
const Ki = new R(), xi = new R(), vi = new R(), Mi = new ye(), Zi = new ye(), Cc = new Pe(), Hs = new R(), Ji = new R(), Vs = new R(), el = new ye(), Vr = new ye(), tl = new ye();
class Iu extends rt {
  constructor(e = new Rc()) {
    if (super(), this.isSprite = true, this.type = "Sprite", _i === void 0) {
      _i = new vt();
      const t = new Float32Array([-0.5, -0.5, 0, 0, 0, 0.5, -0.5, 0, 1, 0, 0.5, 0.5, 0, 1, 1, -0.5, 0.5, 0, 0, 1]), n = new wc(t, 5);
      _i.setIndex([0, 1, 2, 0, 2, 3]), _i.setAttribute("position", new ps(n, 3, 0, false)), _i.setAttribute("uv", new ps(n, 2, 3, false));
    }
    this.geometry = _i, this.material = e, this.center = new ye(0.5, 0.5);
  }
  raycast(e, t) {
    ...
    const a = this.center;
    Gs(Hs.set(-0.5, -0.5, 0), vi, a, xi, i, r), Gs(Ji.set(0.5, -0.5, 0), vi, a, xi, i, r), Gs(Vs.set(0.5, 0.5, 0), vi, a, xi, i, r), el.set(0, 0), Vr.set(1, 0), tl.set(1, 1);
    let o = e.ray.intersectTriangle(Hs, Ji, Vs, false, Ki);
    if (o === null && (Gs(Ji.set(-0.5, 0.5, 0), vi, a, xi, i, r), Vr.set(0, 1), o = e.ray.intersectTriangle(Hs, Vs, Ji, false, Ki), o === null)) return;
    const l = e.ray.origin.distanceTo(Ki);
    l < e.near || l > e.far || t.push({ distance: l, point: Ki.clone(), uv: Wt.getInterpolation(Ki, Hs, Ji, Vs, el, Vr, tl, new ye()), face: null, object: this });
  }
  copy(e, t) {
    return super.copy(e, t), e.center !== void 0 && this.center.copy(e.center), this.material = e.material, this;
  }
}
function Gs(s, e, t, n, i, r) {
  Mi.subVectors(s, t).addScalar(0.5).multiply(n), i !== void 0 ? (Zi.x = r * Mi.x - i * Mi.y, Zi.y = i * Mi.x + r * Mi.y) : Zi.copy(Mi), s.copy(e), s.x += Zi.x, s.y += Zi.y, s.applyMatrix4(Cc);
}
const nl = new R(), il = new qe(), sl = new qe(), Uu = new R(), rl = new Pe(), Ws = new R(), Gr = new ln(), al = new Pe(), Wr = new xs();
class Nu extends bt {
  constructor(e, t) {
  ...
  computeBoundingBox() {
    ...
    for (let n = 0; n < t.count; n++) this.getVertexPosition(n, Ws), this.boundingBox.expandByPoint(Ws);
  }
  computeBoundingSphere() {
    const e = this.geometry;
    this.boundingSphere === null && (this.boundingSphere = new ln()), this.boundingSphere.makeEmpty();
    const t = e.getAttribute("position");
    for (let n = 0; n < t.count; n++) this.getVertexPosition(n, Ws), this.boundingSphere.expandByPoint(Ws);
  }
  copy(e, t) {
  ...
  raycast(e, t) {
    ...
    n !== void 0 && (this.boundingSphere === null && this.computeBoundingSphere(), Gr.copy(this.boundingSphere), Gr.applyMatrix4(i), e.ray.intersectsSphere(Gr) !== false && (al.copy(i).invert(), Wr.copy(e.ray).applyMatrix4(al), !(this.boundingBox !== null && Wr.intersectsBox(this.boundingBox) === false) && this._computeIntersections(e, t, Wr)));
  }
  getVertexPosition(e, t) {
  ...
  updateMatrixWorld(e) {
    super.updateMatrixWorld(e), this.bindMode === Po ? this.bindMatrixInverse.copy(this.matrixWorld).invert() : this.bindMode === Ph ? this.bindMatrixInverse.copy(this.bindMatrix).invert() : console.warn("THREE.SkinnedMesh: Unrecognized bindMode: " + this.bindMode);
  }
  applyBoneTransform(e, t) {
    ...
    for (let r = 0; r < 4; r++) {
      ...
      if (a !== 0) {
        ...
        rl.multiplyMatrices(n.bones[o].matrixWorld, n.boneInverses[o]), t.addScaledVector(Uu.copy(nl).applyMatrix4(rl), a);
      }
    }
...
class Lc extends ft {
  constructor(e = null, t = 1, n = 1, i, r, a, o, l, c = Ct, h = Ct, u, d) {
...
class oo {
  ...
  update() {
    ...
    for (let r = 0, a = e.length; r < a; r++) {
      const o = e[r] ? e[r].matrixWorld : Fu;
...
const yi = new Pe(), ll = new Pe(), Xs = [], cl = new tn(), Ou = new Pe(), Qi = new bt(), es = new ln();
class Bu extends bt {
  constructor(e, t, n) {
    super(e, t), this.isInstancedMesh = true, this.instanceMatrix = new Xa(new Float32Array(n * 16), 16), this.instanceColor = null, this.morphTexture = null, this.count = n, this.boundingBox = null, this.boundingSphere = null;
    for (let i = 0; i < n; i++) this.setMatrixAt(i, Ou);
  }
  computeBoundingBox() {
    const e = this.geometry, t = this.count;
    this.boundingBox === null && (this.boundingBox = new tn()), e.boundingBox === null && e.computeBoundingBox(), this.boundingBox.makeEmpty();
    for (let n = 0; n < t; n++) this.getMatrixAt(n, yi), cl.copy(e.boundingBox).applyMatrix4(yi), this.boundingBox.union(cl);
  }
  computeBoundingSphere() {
    const e = this.geometry, t = this.count;
    ...
    for (let n = 0; n < t; n++) this.getMatrixAt(n, yi), es.copy(e.boundingSphere).applyMatrix4(yi), this.boundingSphere.union(es);
  }
  copy(e, t) {
  ...
  raycast(e, t) {
    ...
    if (Qi.geometry = this.geometry, Qi.material = this.material, Qi.material !== void 0 && (this.boundingSphere === null && this.computeBoundingSphere(), es.copy(this.boundingSphere), es.applyMatrix4(n), e.ray.intersectsSphere(es) !== false)) for (let r = 0; r < i; r++) {
      this.getMatrixAt(r, yi), ll.multiplyMatrices(n, yi), Qi.matrixWorld = ll, Qi.raycast(e, Xs);
      for (let a = 0, o = Xs.length; a < o; a++) {
        const l = Xs[a];
  ...
  setColorAt(e, t) {
    this.instanceColor === null && (this.instanceColor = new Xa(new Float32Array(this.instanceMatrix.count * 3).fill(1), 3)), t.toArray(this.instanceColor.array, e * 3);
  }
  setMatrixAt(e, t) {
  ...
  setMorphAt(e, t) {
    ...
    this.morphTexture === null && (this.morphTexture = new Lc(new Float32Array(i * this.count), i, this.count, to, Jt));
...
const Xr = new R(), zu = new R(), ku = new De();
class Dn {
  ...
  setFromCoplanarPoints(e, t, n) {
    const i = Xr.subVectors(n, t).cross(zu.subVectors(e, t)).normalize();
  ...
  applyMatrix4(e, t) {
    const n = t || ku.getNormalMatrix(e), i = this.coplanarPoint(Xr).applyMatrix4(e), r = this.normal.applyMatrix3(n).normalize();
...
class lo {
  ...
  setFromProjectionMatrix(e, t = yn) {
    const n = this.planes, i = e.elements, r = i[0], a = i[1], o = i[2], l = i[3], c = i[4], h = i[5], u = i[6], d = i[7], p = i[8], g = i[9], _ = i[10], m = i[11], f = i[12], T = i[13], b = i[14], y = i[15];
    if (n[0].setComponents(l - r, d - c, m - p, y - f).normalize(), n[1].setComponents(l + r, d + c, m + p, y + f).normalize(), n[2].setComponents(l + a, d + h, m + g, y + T).normalize(), n[3].setComponents(l - a, d - h, m - g, y - T).normalize(), n[4].setComponents(l - o, d - u, m - _, y - b).normalize(), t === yn) n[5].setComponents(l + o, d + u, m + _, y + b).normalize();
    else if (t === ur) n[5].setComponents(o, u, _, b).normalize();
...
const dr = new R(), fr = new R(), hl = new Pe(), ts = new xs(), qs = new ln(), Yr = new R(), ul = new R();
class ms extends rt {
  constructor(e = new vt(), t = new Ms()) {
  ...
  computeLineDistances() {
    ...
    if (e.index === null) {
      ...
      for (let i = 1, r = t.count; i < r; i++) dr.fromBufferAttribute(t, i - 1), fr.fromBufferAttribute(t, i), n[i] = n[i - 1], n[i] += dr.distanceTo(fr);
  ...
  raycast(e, t) {
    ...
    hl.copy(i).invert(), ts.copy(e.ray).applyMatrix4(hl);
    ...
    if (h !== null) {
      ...
      for (let _ = p, m = g - 1; _ < m; _ += c) {
        const f = h.getX(_), T = h.getX(_ + 1), b = js(this, e, ts, l, f, T, _);
        b && t.push(b);
      }
      if (this.isLineLoop) {
        const _ = h.getX(g - 1), m = h.getX(p), f = js(this, e, ts, l, _, m, g - 1);
        f && t.push(f);
      }
    } else {
      const p = Math.max(0, a.start), g = Math.min(d.count, a.start + a.count);
      for (let _ = p, m = g - 1; _ < m; _ += c) {
        const f = js(this, e, ts, l, _, _ + 1, _);
        f && t.push(f);
      }
      if (this.isLineLoop) {
        const _ = js(this, e, ts, l, g - 1, p, g - 1);
        _ && t.push(_);
      }
    }
  }
...
function js(s, e, t, n, i, r, a) {
  const o = s.geometry.attributes.position;
  if (dr.fromBufferAttribute(o, i), fr.fromBufferAttribute(o, r), t.distanceSqToSegment(dr, fr, Yr, ul) > n) return;
  Yr.applyMatrix4(s.matrixWorld);
  const c = e.ray.origin.distanceTo(Yr);
  if (!(c < e.near || c > e.far)) return { distance: c, point: ul.clone().applyMatrix4(s.matrixWorld), index: a, face: null, faceIndex: null, barycoord: null, object: s };
}
const dl = new R(), fl = new R();
class co extends ms {
  constructor(e, t) {
  ...
  computeLineDistances() {
    ...
    if (e.index === null) {
      ...
      for (let i = 0, r = t.count; i < r; i += 2) dl.fromBufferAttribute(t, i), fl.fromBufferAttribute(t, i + 1), n[i] = i === 0 ? 0 : n[i - 1], n[i + 1] = n[i] + dl.distanceTo(fl);
      e.setAttribute("lineDistance", new Tt(n, 1));
...
const pl = new Pe(), Ya = new xs(), $s = new ln(), Ks = new R();
class Vu extends rt {
  constructor(e = new vt(), t = new Dc()) {
  ...
  raycast(e, t) {
    ...
    if (n.boundingSphere === null && n.computeBoundingSphere(), $s.copy(n.boundingSphere), $s.applyMatrix4(i), $s.radius += r, e.ray.intersectsSphere($s) === false) return;
    pl.copy(i).invert(), Ya.copy(e.ray).applyMatrix4(pl);
    ...
    if (c !== null) {
      ...
      for (let g = d, _ = p; g < _; g++) {
        const m = c.getX(g);
        Ks.fromBufferAttribute(u, m), ml(Ks, m, l, i, e, t, this);
      }
    } else {
      const d = Math.max(0, a.start), p = Math.min(u.count, a.start + a.count);
      for (let g = d, _ = p; g < _; g++) Ks.fromBufferAttribute(u, g), ml(Ks, g, l, i, e, t, this);
    }
  }
  updateMorphTargets() {
    const t = this.geometry.morphAttributes, n = Object.keys(t);
...
function ml(s, e, t, n, i, r, a) {
  const o = Ya.distanceSqToPoint(s);
  if (o < t) {
    const l = new R();
    Ya.closestPointToPoint(s, l), l.applyMatrix4(n);
...
class Ic extends ft {
  constructor(e, t, n, i, r, a, o, l, c, h = wi) {
    ...
    n === void 0 && h === wi && (n = ei), n === void 0 && h === Ni && (n = Ui), super(null, i, r, a, o, l, h, n, c), this.isDepthTexture = true, this.image = { width: e, height: t }, this.magFilter = o !== void 0 ? o : Ct, this.minFilter = l !== void 0 ? l : Ct, this.flipY = false, this.generateMipmaps = false, this.compareFunction = null;
  }
  copy(e) {
    return super.copy(e), this.source = new ao(Object.assign({}, e.image)), this.compareFunction = e.compareFunction, this;
  }
  toJSON(e) {
    const t = super.toJSON(e);
...
class gr extends vt {
  constructor(e = 1, t = 1, n = 1, i = 1) {
    ...
    for (let f = 0; f < l; f++) for (let T = 0; T < o; T++) {
      const b = T + c * f, y = T + c * (f + 1), L = T + 1 + c * (f + 1), C = T + 1 + c * f;
      p.push(b, y, C), p.push(y, L, C);
    }
...
class ho extends vt {
  constructor(e = 1, t = 32, n = 16, i = 0, r = Math.PI * 2, a = 0, o = Math.PI) {
    ...
    for (let f = 0; f <= n; f++) {
      ...
      for (let L = 0; L <= t; L++) {
        const C = L / t;
        u.x = -e * Math.cos(i + C * r) * Math.sin(a + b * o), u.y = e * Math.cos(a + b * o), u.z = e * Math.sin(i + C * r) * Math.sin(a + b * o), g.push(u.x, u.y, u.z), d.copy(u).normalize(), _.push(d.x, d.y, d.z), m.push(C + y, 1 - b), T.push(c++);
      }
      h.push(T);
    }
    for (let f = 0; f < n; f++) for (let T = 0; T < t; T++) {
      const b = h[f][T + 1], y = h[f][T], L = h[f + 1][T], C = h[f + 1][T + 1];
      (f !== 0 || a > 0) && p.push(b, y, C), (f !== n - 1 || l < Math.PI) && p.push(y, L, C);
    }
    this.setIndex(p), this.setAttribute("position", new Tt(g, 3)), this.setAttribute("normal", new Tt(_, 3)), this.setAttribute("uv", new Tt(m, 2));
  }
  copy(e) {
...
class ju extends ys {
  constructor(e, t, n, i) {
    super(e, t, n, i), this._weightPrev = -0, this._offsetPrev = -0, this._weightNext = -0, this._offsetNext = -0, this.DefaultSettings_ = { endingStart: Lo, endingEnd: Lo };
  }
  ...
  interpolate_(e, t, n, i) {
    const r = this.resultBuffer, a = this.sampleValues, o = this.valueSize, l = e * o, c = l - o, h = this._offsetPrev, u = this._offsetNext, d = this._weightPrev, p = this._weightNext, g = (n - t) / (i - t), _ = g * g, m = _ * g, f = -d * m + 2 * d * _ - d * g, T = (1 + d) * m + (-1.5 - 2 * d) * _ + (-0.5 + d) * g + 1, b = (-1 - p) * m + (1.5 + p) * _ + 0.5 * g, y = p * m - p * _;
    for (let L = 0; L !== o; ++L) r[L] = f * a[h + L] + T * a[c + L] + b * a[l + L] + y * a[u + L];
    return r;
  }
}
class $u extends ys {
...
class hn {
  ...
  validate() {
    ...
    if (i !== void 0 && Yu(i)) for (let o = 0, l = i.length; o !== l; ++o) {
      const c = i[o];
      if (isNaN(c)) {
...
hn.prototype.DefaultInterpolation = ds;
class Hi extends hn {
  constructor(e, t, n) {
    super(e, t, n);
  }
...
class Zu extends ys {
  ...
  interpolate_(e, t, n, i) {
    ...
    let c = e * o;
    for (let h = c + o; c !== h; c += 4) an.slerpFlat(r, 0, a, c - o, a, c, l);
    return r;
  }
}
class zi extends hn {
...
Vi.prototype.DefaultInterpolation = us;
...
class Ju {
  ...
  static parse(e) {
    ...
    for (let a = 0, o = n.length; a !== o; ++a) t.push(ed(n[a]).scale(i));
  ...
  static CreateFromMorphTargetSequence(e, t, n, i) {
    ...
    for (let o = 0; o < r; o++) {
      ...
      const h = qu(l);
      l = gl(l, 1, h), c = gl(c, 1, h), !i && l[0] === 0 && (l.push(r), c.push(c[0])), a.push(new Bi(".morphTargetInfluences[" + t[o].name + "]", l, c).scale(1 / n));
    }
  ...
  static parseAnimation(e, t) {
    ...
    const n = function(u, d, p, g, _) {
      if (p.length !== 0) {
        const m = [], f = [];
        Uc(p, m, f, g), m.length !== 0 && _.push(new u(d, m, f));
      }
...
function ed(s) {
  ...
  if (s.times === void 0) {
    const t = [], n = [];
    Uc(s.keys, t, n, "value"), s.times = t, s.values = n;
  }
...
class Fc extends Gi {
  ...
  load(e, t, n, i) {
    ...
    fetch(a).then((c) => {
      ...
      } else throw new id(`fetch for "${c.url}" responded with ${c.status}: ${c.statusText}`, c);
    }).then((c) => {
      switch (l) {
        case "arraybuffer":
...
class rd extends Gi {
  ...
  load(e, t, n, i) {
    const r = new ft(), a = new sd(this.manager);
...
class fo {
  ...
  updateMatrices(e) {
    ...
    _l.setFromMatrixPosition(e.matrixWorld), t.position.copy(_l), xl.setFromMatrixPosition(e.target.matrixWorld), t.lookAt(xl), t.updateMatrixWorld(), qr.multiplyMatrices(t.projectionMatrix, t.matrixWorldInverse), this._frustum.setFromProjectionMatrix(qr), n.set(0.5, 0, 0, 0.5, 0, 0.5, 0, 0.5, 0, 0, 0.5, 0.5, 0, 0, 0, 1), n.multiply(qr);
  }
  getViewport(e) {
...
class od extends _r {
  constructor(e, t, n = 0, i = Math.PI / 3, r = 0, a = 2) {
    super(e, t), this.isSpotLight = true, this.type = "SpotLight", this.position.copy(rt.DEFAULT_UP), this.updateMatrix(), this.target = new rt(), this.distance = n, this.angle = i, this.penumbra = r, this.decay = a, this.map = null, this.shadow = new ad();
  }
  get power() {
...
const vl = new Pe(), ns = new R(), jr = new R();
class ld extends fo {
  constructor() {
    super(new Et(90, 1, 0.5, 500)), this.isPointLightShadow = true, this._frameExtents = new ye(4, 2), this._viewportCount = 6, this._viewports = [new qe(2, 1, 1, 1), new qe(0, 1, 1, 1), new qe(3, 1, 1, 1), new qe(1, 1, 1, 1), new qe(3, 0, 1, 1), new qe(1, 0, 1, 1)], this._cubeDirections = [new R(1, 0, 0), new R(-1, 0, 0), new R(0, 0, 1), new R(0, 0, -1), new R(0, 1, 0), new R(0, -1, 0)], this._cubeUps = [new R(0, 1, 0), new R(0, 1, 0), new R(0, 1, 0), new R(0, 1, 0), new R(0, 0, 1), new R(0, 0, -1)];
  }
  updateMatrices(e, t = 0) {
    const n = this.camera, i = this.matrix, r = e.distance || n.far;
    r !== n.far && (n.far = r, n.updateProjectionMatrix()), ns.setFromMatrixPosition(e.matrixWorld), n.position.copy(ns), jr.copy(n.position), jr.add(this._cubeDirections[t]), n.up.copy(this._cubeUps[t]), n.lookAt(jr), n.updateMatrixWorld(), i.makeTranslation(-ns.x, -ns.y, -ns.z), vl.multiplyMatrices(n.projectionMatrix, n.matrixWorldInverse), this._frustum.setFromProjectionMatrix(vl);
  }
}
class cd extends _r {
  constructor(e, t, n = 0, i = 2) {
    super(e, t), this.isPointLight = true, this.type = "PointLight", this.distance = n, this.decay = i, this.shadow = new ld();
  }
  get power() {
...
class pr extends _r {
  constructor(e, t) {
    super(e, t), this.isDirectionalLight = true, this.type = "DirectionalLight", this.position.copy(rt.DEFAULT_UP), this.updateMatrix(), this.target = new rt(), this.shadow = new hd();
  }
  dispose() {
    this.shadow.dispose();
  }
...
const po = "\\[\\]\\.:\\/", fd = new RegExp("[" + po + "]", "g"), mo = "[^" + po + "]", pd = "[^" + po.replace("\\.", "") + "]", md = /((?:WC+[\/:])*)/.source.replace("WC", mo), gd = /(WCOD+)?/.source.replace("WCOD", pd), _d = /(?:\.(WC+)(?:\[(.+)\])?)?/.source.replace("WC", mo), xd = /\.(WC+)(?:\[(.+)\])?/.source.replace("WC", mo), vd = new RegExp("^" + md + gd + _d + xd + "$"), Md = ["material", "materials", "bones", "map"];
class yd {
  constructor(e, t, n) {
...
class Je {
  ...
  static parseTrackName(e) {
    ...
    if (i !== void 0 && i !== -1) {
      ...
      Md.indexOf(r) !== -1 && (n.nodeName = n.nodeName.substring(0, i), n.objectName = r);
    }
...
class Bc extends co {
  constructor(e = 1) {
    const t = [0, 0, 0, e, 0, 0, 0, 0, 0, 0, e, 0, 0, 0, 0, 0, 0, e], n = [1, 0, 0, 1, 0.6, 0, 0, 1, 0, 0.6, 1, 0, 0, 0, 1, 0, 0.6, 1], i = new vt();
...
function om(s, e, t, n, i, r, a) {
  ...
  function _(b) {
    ...
    C === "additive" ? n.buffers.color.setClear(0, 0, 0, 1, a) : C === "alpha-blend" && n.buffers.color.setClear(0, 0, 0, 0, a), (s.autoClear || y) && (n.buffers.depth.setTest(true), n.buffers.depth.setMask(true), n.buffers.color.setMask(true), s.clear(s.autoClearColor, s.autoClearDepth, s.autoClearStencil));
  }
  function m(b, y) {
    const L = g(y);
    L && (L.isCubeTexture || L.mapping === mr) ? (h === void 0 && (h = new bt(new vs(1, 1, 1), new zn({ name: "BackgroundCubeMaterial", uniforms: Oi(nn.backgroundCube.uniforms), vertexShader: nn.backgroundCube.vertexShader, fragmentShader: nn.backgroundCube.fragmentShader, side: Ut, depthTest: false, depthWrite: false, fog: false })), h.geometry.deleteAttribute("normal"), h.geometry.deleteAttribute("uv"), h.onBeforeRender = function(C, A, N) {
      this.matrixWorld.copyPosition(N.matrixWorld);
    }, Object.defineProperty(h.material, "envMap", { get: function() {
      return this.uniforms.envMap.value;
    } }), i.update(h)), Yn.copy(y.backgroundRotation), Yn.x *= -1, Yn.y *= -1, Yn.z *= -1, L.isCubeTexture && L.isRenderTargetTexture === false && (Yn.y *= -1, Yn.z *= -1), h.material.uniforms.envMap.value = L, h.material.uniforms.flipEnvMap.value = L.isCubeTexture && L.isRenderTargetTexture === false ? -1 : 1, h.material.uniforms.backgroundBlurriness.value = y.backgroundBlurriness, h.material.uniforms.backgroundIntensity.value = y.backgroundIntensity, h.material.uniforms.backgroundRotation.value.setFromMatrix4(am.makeRotationFromEuler(Yn)), h.material.toneMapped = Ve.getTransfer(L.colorSpace) !== Qe, (u !== L || d !== L.version || p !== s.toneMapping) && (h.material.needsUpdate = true, u = L, d = L.version, p = s.toneMapping), h.layers.enableAll(), b.unshift(h, h.geometry, h.material, 0, 0, null)) : L && L.isTexture && (c === void 0 && (c = new bt(new gr(2, 2), new zn({ name: "BackgroundMaterial", uniforms: Oi(nn.background.uniforms), vertexShader: nn.background.vertexShader, fragmentShader: nn.background.fragmentShader, side: En, depthTest: false, depthWrite: false, fog: false })), c.geometry.deleteAttribute("normal"), Object.defineProperty(c.material, "map", { get: function() {
      return this.uniforms.t2D.value;
    } }), i.update(c)), c.material.uniforms.t2D.value = L, c.material.uniforms.backgroundIntensity.value = y.backgroundIntensity, c.material.toneMapped = Ve.getTransfer(L.colorSpace) !== Qe, L.matrixAutoUpdate === true && L.updateMatrix(), c.material.uniforms.uvTransform.value.copy(L.matrix), (u !== L || d !== L.version || p !== s.toneMapping) && (c.material.needsUpdate = true, u = L, d = L.version, p = s.toneMapping), c.layers.enableAll(), b.unshift(c, c.geometry, c.material, 0, 0, null));
  }
  function f(b, y) {
    b.getRGB(Js, Ec(s)), n.buffers.color.setClear(Js.r, Js.g, Js.b, y, a);
  }
  function T() {
...
function lm(s, e) {
  ...
  let r = i, a = false;
  function o(M, P, G, z, j) {
    let $ = false;
    const X = u(z, G, P);
    r !== X && (r = X, c(r.object)), $ = p(M, z, G, j), $ && g(M, z, G, j), j !== null && e.update(j, s.ELEMENT_ARRAY_BUFFER), ($ || a) && (a = false, y(M, P, G, z), j !== null && s.bindBuffer(s.ELEMENT_ARRAY_BUFFER, e.get(j).buffer));
  }
  function l() {
  ...
  function d(M) {
    ...
    return { geometry: null, program: null, wireframe: false, newAttributes: P, enabledAttributes: G, attributeDivisors: z, object: M, attributes: {}, index: null };
  }
  function p(M, P, G, z) {
    const j = r.attributes, $ = P.attributes;
    let X = 0;
    const Z = G.getAttributes();
    for (const H in Z) if (Z[H].location >= 0) {
      const he = j[H];
      let xe = $[H];
      if (xe === void 0 && (H === "instanceMatrix" && M.instanceMatrix && (xe = M.instanceMatrix), H === "instanceColor" && M.instanceColor && (xe = M.instanceColor)), he === void 0 || he.attribute !== xe || xe && he.data !== xe.data) return true;
      X++;
    }
  ...
  function g(M, P, G, z) {
    ...
    for (const H in Z) if (Z[H].location >= 0) {
      ...
      const xe = {};
      xe.attribute = he, he && he.data && (xe.data = he.data), j[H] = xe, X++;
    }
  ...
  function f(M, P) {
    ...
    G[M] = 1, z[M] === 0 && (s.enableVertexAttribArray(M), z[M] = 1), j[M] !== P && (s.vertexAttribDivisor(M, P), j[M] = P);
  }
  function T() {
    const M = r.newAttributes, P = r.enabledAttributes;
    for (let G = 0, z = P.length; G < z; G++) P[G] !== M[G] && (s.disableVertexAttribArray(G), P[G] = 0);
  }
  function b(M, P, G, z, j, $, X) {
    X === true ? s.vertexAttribIPointer(M, P, G, j, $) : s.vertexAttribPointer(M, P, G, z, j, $);
  }
  function y(M, P, G, z) {
    _();
    ...
    for (const Z in $) {
      ...
      if (H.location >= 0) {
        let se = j[Z];
        if (se === void 0 && (Z === "instanceMatrix" && M.instanceMatrix && (se = M.instanceMatrix), Z === "instanceColor" && M.instanceColor && (se = M.instanceColor)), se !== void 0) {
          const he = se.normalized, xe = se.itemSize, Fe = e.get(se);
          if (Fe === void 0) continue;
          const tt = Fe.buffer, W = Fe.type, ee = Fe.bytesPerElement, me = W === s.INT || W === s.UNSIGNED_INT || se.gpuType === Ja;
          if (se.isInterleavedBufferAttribute) {
            const re = se.data, be = re.stride, Ye = se.offset;
            if (re.isInstancedInterleavedBuffer) {
              for (let Ae = 0; Ae < H.locationSize; Ae++) f(H.location + Ae, re.meshPerAttribute);
            ...
            for (let Ae = 0; Ae < H.locationSize; Ae++) b(H.location + Ae, xe / H.locationSize, W, he, be * ee, (Ye + xe / H.locationSize * Ae) * ee, me);
          } else {
            ...
            s.bindBuffer(s.ARRAY_BUFFER, tt);
            for (let re = 0; re < H.locationSize; re++) b(H.location + re, xe / H.locationSize, W, he, xe * ee, xe / H.locationSize * re * ee, me);
          }
        } else if (X !== void 0) {
          const he = X[Z];
  ...
  return { setup: o, reset: N, resetDefaultState: S, dispose: L, releaseStatesOfGeometry: C, releaseStatesOfProgram: A, initAttributes: _, enableAttribute: m, disableUnusedAttributes: T };
}
function cm(s, e, t) {
  let n;
  function i(c) {
...
function hm(s, e, t, n) {
  ...
  function o(A) {
    const N = A === _s && (e.has("EXT_color_buffer_half_float") || e.has("EXT_color_buffer_float"));
    return !(A !== bn && n.convert(A) !== s.getParameter(s.IMPLEMENTATION_COLOR_READ_TYPE) && A !== Jt && !N);
  }
  function l(A) {
    if (A === "highp") {
...
function um(s) {
  ...
  this.uniform = l, this.numPlanes = 0, this.numIntersection = 0, this.init = function(u, d) {
    ...
    if (!i || g === null || g.length === 0 || r && !m) r ? h(null) : c();
      ...
      l.value = y, y = h(g, d, b, p);
      for (let L = 0; L !== b; ++L) y[L] = t[L];
  ...
  function h(u, d, p, g) {
    ...
    if (_ !== 0) {
      if (m = l.value, g !== true || m === null) {
        ...
        for (let b = 0, y = p; b !== _; ++b, y += 4) a.copy(u[b]).applyMatrix4(T, o), a.normal.toArray(m, y), m[y + 3] = a.constant;
      }
...
function dm(s) {
  ...
  function t(a, o) {
    return o === ma ? a.mapping = Li : o === ga && (a.mapping = Di), a;
  }
  function n(a) {
    if (a && a.isTexture) {
      const o = a.mapping;
      if (o === ma || o === ga) if (e.has(a)) {
...
const bi = 4, Sl = [0.125, 0.215, 0.35, 0.446, 0.526, 0.582], Jn = 20, $r = new Ss(), El = new Ee();
let Kr = null, Zr = 0, Jr = 0, Qr = false;
const Kn = (1 + Math.sqrt(5)) / 2, Si = 1 / Kn, bl = [new R(-Kn, Si, 0), new R(Kn, Si, 0), new R(-Si, 0, Kn), new R(Si, 0, Kn), new R(0, Kn, -Si), new R(0, Kn, Si), new R(-1, 1, -1), new R(1, 1, -1), new R(-1, 1, 1), new R(1, 1, 1)], fm = new R();
class Tl {
  constructor(e) {
    this._renderer = e, this._pingPongRenderTarget = null, this._lodMax = 0, this._cubeSize = 0, this._lodPlanes = [], this._sizeLods = [], this._sigmas = [], this._blurMaterial = null, this._cubemapMaterial = null, this._equirectMaterial = null, this._compileMaterial(this._blurMaterial);
  }
  fromScene(e, t = 0, n = 0.1, i = 100, r = {}) {
    const { size: a = 256, position: o = fm } = r;
    Kr = this._renderer.getRenderTarget(), Zr = this._renderer.getActiveCubeFace(), Jr = this._renderer.getActiveMipmapLevel(), Qr = this._renderer.xr.enabled, this._renderer.xr.enabled = false, this._setSize(a);
  ...
  _cleanup(e) {
    this._renderer.setRenderTarget(Kr, Zr, Jr), this._renderer.xr.enabled = Qr, e.scissorTest = false, Qs(e, 0, 0, e.width, e.height);
  }
  _fromTexture(e, t) {
  ...
  _allocateTargets() {
    const e = 3 * Math.max(this._cubeSize, 112), t = 4 * this._cubeSize, n = { magFilter: Bt, minFilter: Bt, generateMipmaps: false, type: _s, format: Xt, colorSpace: Lt, depthBuffer: false }, i = Al(e, t, n);
  ...
  _sceneToCubeUV(e, t, n, i, r) {
    const l = new Et(90, 1, t, n), c = [1, -1, 1, 1, 1, 1], h = [1, 1, 1, -1, -1, -1], u = this._renderer, d = u.autoClear, p = u.toneMapping;
    u.getClearColor(El), u.toneMapping = Bn, u.autoClear = false;
    const g = new Nn({ name: "PMREM.Background", side: Ut, depthWrite: false, depthTest: false }), _ = new bt(new vs(), g);
    let m = false;
    const f = e.background;
    f ? f.isColor && (g.color.copy(f), e.background = null, m = true) : (g.color.copy(El), m = true);
    for (let T = 0; T < 6; T++) {
      const b = T % 3;
      ...
      Qs(i, b * y, T > 2 ? y : 0, y, y), u.setRenderTarget(i), m && u.render(_, l), u.render(e, l);
    }
  ...
  _textureToCubeUV(e, t) {
    ...
    i ? (this._cubemapMaterial === null && (this._cubemapMaterial = Rl()), this._cubemapMaterial.uniforms.flipEnvMap.value = e.isRenderTargetTexture === false ? -1 : 1) : this._equirectMaterial === null && (this._equirectMaterial = wl());
    const r = i ? this._cubemapMaterial : this._equirectMaterial, a = new bt(this._lodPlanes[0], r), o = r.uniforms;
    o.envMap.value = e;
    const l = this._cubeSize;
    Qs(t, 0, 0, 3 * l, 2 * l), n.setRenderTarget(t), n.render(a, $r);
  }
  _applyPMREM(e) {
    ...
    for (let r = 1; r < i; r++) {
      const a = Math.sqrt(this._sigmas[r] * this._sigmas[r] - this._sigmas[r - 1] * this._sigmas[r - 1]), o = bl[(i - r - 1) % bl.length];
  ...
  _halfBlur(e, t, n, i, r, a, o) {
    ...
    const h = 3, u = new bt(this._lodPlanes[i], c), d = c.uniforms, p = this._sizeLods[n] - 1, g = isFinite(r) ? Math.PI / (2 * p) : 2 * Math.PI / (2 * Jn - 1), _ = r / g, m = isFinite(r) ? 1 + Math.floor(h * _) : Jn;
    ...
    const y = this._sizeLods[i], L = 3 * y * (i > b - bi ? i - b + bi : 0), C = 4 * (this._cubeSize - y);
    Qs(t, L, C, 3 * y, 2 * y), l.setRenderTarget(t), l.render(u, $r);
  }
}
function pm(s) {
  const e = [], t = [], n = [];
  let i = s;
  const r = s - bi + 1 + Sl.length;
  for (let a = 0; a < r; a++) {
    const o = Math.pow(2, i);
    t.push(o);
    let l = 1 / o;
    a > s - bi ? l = Sl[a - s + bi - 1] : a === 0 && (l = 0), n.push(l);
    const c = 1 / (o - 2), h = -c, u = 1 + c, d = [h, h, u, h, u, u, h, h, u, u, h, u], p = 6, g = 6, _ = 3, m = 2, f = 1, T = new Float32Array(_ * g * p), b = new Float32Array(m * g * p), y = new Float32Array(f * g * p);
    for (let C = 0; C < p; C++) {
      const A = C % 3 * 2 / 3 - 1, N = C > 2 ? 0 : -1, S = [A, N, 0, A + 2 / 3, N, 0, A + 2 / 3, N + 1, 0, A, N, 0, A + 2 / 3, N + 1, 0, A, N + 1, 0];
      T.set(S, _ * g * C), b.set(d, m * g * C);
      const M = [C, C, C, C, C, C];
      y.set(M, f * g * C);
    }
    const L = new vt();
    L.setAttribute("position", new Pt(T, _)), L.setAttribute("uv", new Pt(b, m)), L.setAttribute("faceIndex", new Pt(y, f)), e.push(L), i > bi && i--;
  }
  return { lodPlanes: e, sizeLods: t, sigmas: n };
}
function Al(s, e, t) {
  const n = new ti(s, e, t);
  return n.texture.mapping = mr, n.texture.name = "PMREM.cubeUv", n.scissorTest = true, n;
}
...
function mm(s, e, t) {
  ...
  return new zn({ name: "SphericalGaussianBlur", defines: { n: Jn, CUBEUV_TEXEL_WIDTH: 1 / e, CUBEUV_TEXEL_HEIGHT: 1 / t, CUBEUV_MAX_MIP: `${s}.0` }, uniforms: { envMap: { value: null }, samples: { value: 1 }, weights: { value: n }, latitudinal: { value: false }, dTheta: { value: 0 }, mipInt: { value: 0 }, poleAxis: { value: i } }, vertexShader: go(), fragmentShader: `
...
function wl() {
  return new zn({ name: "EquirectangularToCubeUV", uniforms: { envMap: { value: null } }, vertexShader: go(), fragmentShader: `
...
function Rl() {
  return new zn({ name: "CubemapToCubeUV", uniforms: { envMap: { value: null }, flipEnvMap: { value: -1 } }, vertexShader: go(), fragmentShader: `
...
function gm(s) {
  ...
  function n(o) {
    if (o && o.isTexture) {
      const l = o.mapping, c = l === ma || l === ga, h = l === Li || l === Di;
      if (c || h) {
        let u = e.get(o);
        const d = u !== void 0 ? u.texture.pmremVersion : 0;
        if (o.isRenderTargetTexture && o.pmremVersion !== d) return t === null && (t = new Tl(s)), u = c ? t.fromEquirectangular(o, u) : t.fromCubemap(o, u), u.texture.pmremVersion = o.pmremVersion, e.set(o, u), u.texture;
        if (u !== void 0) return u.texture;
        {
          const p = o.image;
          return c && p && p.height > 0 || h && p && i(p) ? (t === null && (t = new Tl(s)), u = c ? t.fromEquirectangular(o) : t.fromCubemap(o), u.texture.pmremVersion = o.pmremVersion, e.set(o, u), o.addEventListener("dispose", r), u.texture) : null;
        }
      }
    }
    return o;
  ...
  function c(u) {
    ...
    if (p !== null) {
      ...
      for (let b = 0, y = T.length / 3 - 1; b < y; b += 3) {
        const L = b + 0, C = b + 1, A = b + 2;
        d.push(L, C, C, A, A, L);
      }
    } else return;
    const m = new (_c(d) ? Sc : yc)(d, 1);
    m.version = _;
    const f = r.get(u);
...
function ym(s, e, t) {
  ...
  function r(a, o, l) {
    ...
    if (d === void 0 || d.count !== u) {
      ...
      let L = o.attributes.position.count * y, C = 1;
      L > e.maxTextureSize && (C = Math.ceil(L / e.maxTextureSize), L = e.maxTextureSize);
      const A = new Float32Array(L * C * 4 * u), N = new xc(A, L, C, u);
      N.type = Jt, N.needsUpdate = true;
      const S = y * 4;
      for (let P = 0; P < u; P++) {
        const G = f[P], z = T[P], j = b[P], $ = L * C * 4 * P;
      ...
      d = { count: u, texture: N, size: new ye(L, C) }, n.set(o, d), o.addEventListener("dispose", M);
    }
...
const kc = new ft(), Cl = new Ic(1, 1), Hc = new xc(), Vc = new pu(), Gc = new Tc(), Pl = [], Ll = [], Dl = new Float32Array(16), Il = new Float32Array(9), Ul = new Float32Array(4);
function Wi(s, e, t) {
  const n = s[0];
  if (n <= 0 || n > 0) return s;
  const i = e * t;
...
function wm(s, e) {
  ...
  if (n === void 0) {
    ...
    if (pt(t, n)) return;
    Ul.set(n), s.uniformMatrix2fv(this.addr, false, Ul), mt(t, n);
  }
}
function Rm(s, e) {
  const t = this.cache, n = e.elements;
  if (n === void 0) {
    ...
    if (pt(t, n)) return;
    Il.set(n), s.uniformMatrix3fv(this.addr, false, Il), mt(t, n);
  }
}
function Cm(s, e) {
  const t = this.cache, n = e.elements;
  if (n === void 0) {
    ...
    if (pt(t, n)) return;
    Dl.set(n), s.uniformMatrix4fv(this.addr, false, Dl), mt(t, n);
  }
}
function Pm(s, e) {
  const t = this.cache;
...
function Bm(s, e, t) {
  ...
  let r;
  this.type === s.SAMPLER_2D_SHADOW ? (Cl.compareFunction = mc, r = Cl) : r = kc, t.setTexture2D(e || r, i);
}
function zm(s, e, t) {
  const n = this.cache, i = t.allocateTextureUnit();
  n[0] !== i && (s.uniform1i(this.addr, i), n[0] = i), t.setTexture3D(e || Vc, i);
}
function km(s, e, t) {
  const n = this.cache, i = t.allocateTextureUnit();
  n[0] !== i && (s.uniform1i(this.addr, i), n[0] = i), t.setTextureCube(e || Gc, i);
}
function Hm(s, e, t) {
  const n = this.cache, i = t.allocateTextureUnit();
  n[0] !== i && (s.uniform1i(this.addr, i), n[0] = i), t.setTexture2DArray(e || Hc, i);
}
function Vm(s) {
  switch (s) {
    case 5126:
...
function sg(s, e, t) {
  ...
  for (let a = 0; a !== i; ++a) t.setTexture2D(e[a] || kc, r[a]);
}
function rg(s, e, t) {
  const n = this.cache, i = e.length, r = xr(t, i);
  pt(n, r) || (s.uniform1iv(this.addr, r), mt(n, r));
  for (let a = 0; a !== i; ++a) t.setTexture3D(e[a] || Vc, r[a]);
}
function ag(s, e, t) {
  const n = this.cache, i = e.length, r = xr(t, i);
  pt(n, r) || (s.uniform1iv(this.addr, r), mt(n, r));
  for (let a = 0; a !== i; ++a) t.setTextureCube(e[a] || Gc, r[a]);
}
function og(s, e, t) {
  const n = this.cache, i = e.length, r = xr(t, i);
  pt(n, r) || (s.uniform1iv(this.addr, r), mt(n, r));
  for (let a = 0; a !== i; ++a) t.setTexture2DArray(e[a] || Hc, r[a]);
}
function lg(s) {
  switch (s) {
    case 5126:
...
function dg(s, e, t) {
  ...
  for (ea.lastIndex = 0; ; ) {
    const r = ea.exec(n), a = ea.lastIndex;
    let o = r[1];
    const l = r[2] === "]", c = r[3];
    if (l && (o = o | 0), c === void 0 || c === "[" && a + 2 === i) {
      Nl(t, c === void 0 ? new cg(o, s, e) : new hg(o, s, e));
      break;
    } else {
      let u = t.map[o];
      u === void 0 && (u = new ug(o), Nl(t, u)), t = u;
    }
  }
}
class lr {
...
const Ol = new De();
function gg(s) {
  Ve._getMatrix(Ol, Ve.workingColorSpace, s);
...
const er = new R();
function vg() {
  Ve.getLuminanceCoefficients(er);
...
function Rg(s) {
  ...
  return s.shadowMapType === ec ? e = "SHADOWMAP_TYPE_PCF" : s.shadowMapType === nh ? e = "SHADOWMAP_TYPE_PCF_SOFT" : s.shadowMapType === xn && (e = "SHADOWMAP_TYPE_VSM"), e;
}
function Cg(s) {
...
function Ig(s, e, t, n) {
  ...
  const l = Rg(t), c = Cg(t), h = Pg(t), u = Lg(t), d = Dg(t), p = Mg(t), g = yg(r), _ = i.createProgram();
...
`].filter(rs).join(`
`)), a = qa(a), a = zl(a, t), a = kl(a, t), o = qa(o), o = zl(o, t), o = kl(o, t), a = Hl(a), o = Hl(o), t.isRawShaderMaterial !== true && (T = `#version 300 es
...
`) + `
` + f);
  const b = T + m + a, y = T + f + o, L = Fl(i, i.VERTEX_SHADER, b), C = Fl(i, i.FRAGMENT_SHADER, y);
  ...
  function A(P) {
    if (s.debug.checkShaderErrors) {
      ...
      if (i.getProgramParameter(_, i.LINK_STATUS) === false) if ($ = false, typeof s.debug.onShaderError == "function") s.debug.onShaderError(i, _, L, C);
        ...
        const Z = Bl(i, L, "vertex"), H = Bl(i, C, "fragment");
...
` + H);
    ...
    i.deleteShader(L), i.deleteShader(C), N = new lr(i, _), S = Sg(i, _);
  }
  let N;
  ...
  return this.isReady = function() {
    return M === false && (M = i.getProgramParameter(_, fg)), M;
  }, this.destroy = function() {
    n.releaseStatesOfProgram(this), i.deleteProgram(_), this.program = void 0;
  }, this.type = t.shaderType, this.name = t.shaderName, this.id = pg++, this.cacheKey = e, this.usedTimes = 1, this.program = _, this.vertexShader = L, this.fragmentShader = C, this;
}
let Ug = 0;
class Ng {
  constructor() {
...
function Og(s, e, t, n, i, r, a) {
  const o = new vc(), l = new Ng(), c = /* @__PURE__ */ new Set(), h = [], u = i.logarithmicDepthBuffer, d = i.vertexTextures;
  let p = i.precision;
  ...
  function m(S, M, P, G, z) {
    const j = G.fog, $ = z.geometry, X = S.isMeshStandardMaterial ? G.environment : null, Z = (S.isMeshStandardMaterial ? t : e).get(S.envMap || X), H = Z && Z.mapping === mr ? Z.image.height : null, se = g[S.type];
  ...
  function f(S) {
    ...
    return S.isRawShaderMaterial === false && (T(M, S), b(M, S), M.push(s.outputColorSpace)), M.push(S.customProgramCacheKey), M.join();
  }
  function T(S, M) {
  ...
  function L(S, M) {
    ...
    return P === void 0 && (P = new Ig(s, M, S, r), h.push(P)), P;
  }
  function C(S) {
    if (--S.usedTimes === 0) {
      const M = h.indexOf(S);
  ...
  return { getParameters: m, getProgramCacheKey: f, getUniforms: y, acquireProgram: L, releaseProgram: C, releaseShaderCache: A, programs: h, dispose: N };
}
function Bg() {
...
function Wl() {
  ...
  function c(u, d) {
    t.length > 1 && t.sort(u || zg), n.length > 1 && n.sort(d || Gl), i.length > 1 && i.sort(d || Gl);
  }
  function h() {
...
function kg() {
  ...
  function e(n, i) {
    const r = s.get(n);
    let a;
    return r === void 0 ? (a = new Wl(), s.set(n, [a])) : i >= r.length ? (a = new Wl(), r.push(a)) : a = r[i], a;
  }
  function t() {
    s = /* @__PURE__ */ new WeakMap();
  }
...
function Xg(s) {
  ...
  const i = new R(), r = new Pe(), a = new Pe();
  function o(c) {
    let h = 0, u = 0, d = 0;
    for (let S = 0; S < 9; S++) n.probe[S].set(0, 0, 0);
    let p = 0, g = 0, _ = 0, m = 0, f = 0, T = 0, b = 0, y = 0, L = 0, C = 0, A = 0;
    c.sort(Wg);
    for (let S = 0, M = c.length; S < M; S++) {
      ...
      if (P.isAmbientLight) h += G.r * z, u += G.g * z, d += G.b * z;
        ...
        if (X.color.copy(P.color).multiplyScalar(P.intensity), P.castShadow) {
          ...
          H.shadowIntensity = Z.intensity, H.shadowBias = Z.bias, H.shadowNormalBias = Z.normalBias, H.shadowRadius = Z.radius, H.shadowMapSize = Z.mapSize, n.directionalShadow[p] = H, n.directionalShadowMap[p] = $, n.directionalShadowMatrix[p] = P.shadow.matrix, T++;
        }
        n.directional[p] = X, p++;
        ...
        if (P.map && (n.spotLightMap[L] = P.map, L++, Z.updateMatrices(P), P.castShadow && C++), n.spotLightMatrix[_] = Z.matrix, P.castShadow) {
          const H = t.get(P);
          H.shadowIntensity = Z.intensity, H.shadowBias = Z.bias, H.shadowNormalBias = Z.normalBias, H.shadowRadius = Z.radius, H.shadowMapSize = Z.mapSize, n.spotShadow[_] = H, n.spotShadowMap[_] = $, y++;
        }
        _++;
        ...
        if (X.color.copy(P.color).multiplyScalar(P.intensity), X.distance = P.distance, X.decay = P.decay, P.castShadow) {
          const Z = P.shadow, H = t.get(P);
          H.shadowIntensity = Z.intensity, H.shadowBias = Z.bias, H.shadowNormalBias = Z.normalBias, H.shadowRadius = Z.radius, H.shadowMapSize = Z.mapSize, H.shadowCameraNear = Z.camera.near, H.shadowCameraFar = Z.camera.far, n.pointShadow[g] = H, n.pointShadowMap[g] = $, n.pointShadowMatrix[g] = P.shadow.matrix, b++;
        }
        n.point[g] = X, g++;
    ...
    const N = n.hash;
    (N.directionalLength !== p || N.pointLength !== g || N.spotLength !== _ || N.rectAreaLength !== m || N.hemiLength !== f || N.numDirectionalShadows !== T || N.numPointShadows !== b || N.numSpotShadows !== y || N.numSpotMaps !== L || N.numLightProbes !== A) && (n.directional.length = p, n.spot.length = _, n.rectArea.length = m, n.point.length = g, n.hemi.length = f, n.directionalShadow.length = T, n.directionalShadowMap.length = T, n.pointShadow.length = b, n.pointShadowMap.length = b, n.spotShadow.length = y, n.spotShadowMap.length = y, n.directionalShadowMatrix.length = T, n.pointShadowMatrix.length = b, n.spotLightMatrix.length = y + L - C, n.spotLightMap.length = L, n.numSpotLightShadowsWithMaps = C, n.numLightProbes = A, N.directionalLength = p, N.pointLength = g, N.spotLength = _, N.rectAreaLength = m, N.hemiLength = f, N.numDirectionalShadows = T, N.numPointShadows = b, N.numSpotShadows = y, N.numSpotMaps = L, N.numLightProbes = A, n.version = Gg++);
  }
  function l(c, h) {
    ...
    for (let f = 0, T = c.length; f < T; f++) {
      ...
      if (b.isDirectionalLight) {
        ...
        y.direction.setFromMatrixPosition(b.matrixWorld), i.setFromMatrixPosition(b.target.matrixWorld), y.direction.sub(i), y.direction.transformDirection(m), u++;
      } else if (b.isSpotLight) {
        const y = n.spot[p];
        y.position.setFromMatrixPosition(b.matrixWorld), y.position.applyMatrix4(m), y.direction.setFromMatrixPosition(b.matrixWorld), i.setFromMatrixPosition(b.target.matrixWorld), y.direction.sub(i), y.direction.transformDirection(m), p++;
      } else if (b.isRectAreaLight) {
        const y = n.rectArea[g];
        y.position.setFromMatrixPosition(b.matrixWorld), y.position.applyMatrix4(m), a.identity(), r.copy(b.matrixWorld), r.premultiply(m), a.extractRotation(r), y.halfWidth.set(b.width * 0.5, 0, 0), y.halfHeight.set(0, b.height * 0.5, 0), y.halfWidth.applyMatrix4(a), y.halfHeight.applyMatrix4(a), g++;
      } else if (b.isPointLight) {
        const y = n.point[d];
        y.position.setFromMatrixPosition(b.matrixWorld), y.position.applyMatrix4(m), d++;
...
function $g(s, e, t) {
  let n = new lo();
  const i = new ye(), r = new ye(), a = new qe(), o = new Wu({ depthPacking: Uh }), l = new Xu(), c = {}, h = t.maxTextureSize, u = { [En]: Ut, [Ut]: En, [sn]: sn }, d = new zn({ defines: { VSM_SAMPLES: 8 }, uniforms: { shadow_pass: { value: null }, resolution: { value: new ye() }, radius: { value: 4 } }, vertexShader: qg, fragmentShader: jg }), p = d.clone();
  ...
  this.render = function(C, A, N) {
    ...
    const z = f !== xn && this.type === xn, j = f === xn && this.type !== xn;
    for (let $ = 0, X = C.length; $ < X; $++) {
      const Z = C[$], H = Z.shadow;
      if (H === void 0) {
      ...
      if (i.multiply(se), r.copy(H.mapSize), (i.x > h || i.y > h) && (i.x > h && (r.x = Math.floor(h / se.x), i.x = r.x * se.x, H.mapSize.x = r.x), i.y > h && (r.y = Math.floor(h / se.y), i.y = r.y * se.y, H.mapSize.y = r.y)), H.map === null || z === true || j === true) {
        const xe = this.type !== xn ? { minFilter: Ct, magFilter: Ct } : {};
        H.map !== null && H.map.dispose(), H.map = new ti(i.x, i.y, xe), H.map.texture.name = Z.name + ".shadowMap", H.camera.updateProjectionMatrix();
      }
      s.setRenderTarget(H.map), s.clear();
      const he = H.getViewportCount();
      for (let xe = 0; xe < he; xe++) {
        const Fe = H.getViewport(xe);
        a.set(r.x * Fe.x, r.y * Fe.y, r.x * Fe.z, r.y * Fe.w), G.viewport(a), H.updateMatrices(Z, xe), n = H.getFrustum(), y(A, N, H.camera, Z, this.type);
      }
      H.isPointLightShadow !== true && this.type === xn && T(H, N), H.needsUpdate = false;
    }
  ...
  function b(C, A, N, S) {
    ...
    if (P !== void 0) M = P;
      ...
      const G = M.uuid, z = A.uuid;
      let j = c[G];
      j === void 0 && (j = {}, c[G] = j);
      let $ = j[z];
      $ === void 0 && ($ = M.clone(), j[z] = $, A.addEventListener("dispose", L)), M = $;
    }
  ...
  function y(C, A, N, S, M) {
    if (C.visible === false) return;
    if (C.layers.test(A.layers) && (C.isMesh || C.isLine || C.isPoints) && (C.castShadow || C.receiveShadow && M === xn) && (!C.frustumCulled || n.intersectsObject(C))) {
      ...
      if (Array.isArray(j)) {
        ...
        for (let X = 0, Z = $.length; X < Z; X++) {
          const H = $[X], se = j[H.materialIndex];
          if (se && se.visible) {
            const he = b(C, se, S, M);
            C.onBeforeShadow(s, C, A, N, z, he, H), s.renderBufferDirect(N, null, z, he, C, H), C.onAfterShadow(s, C, A, N, z, he, H);
          }
        }
      } else if (j.visible) {
        const $ = b(C, j, S, M);
    ...
    const G = C.children;
    for (let z = 0, j = G.length; z < j; z++) y(G[z], A, N, S, M);
  }
  function L(C) {
...
const Kg = { [la]: ca, [ha]: fa, [ua]: pa, [Pi]: da, [ca]: la, [fa]: ha, [pa]: ua, [da]: Pi };
function Zg(s, e) {
  function t() {
    let D = false;
    const ne = new qe();
    ...
    return { setMask: function(le) {
      ...
      Mt === true && (le *= ot, oe *= ot, Le *= ot), ne.set(le, oe, Le, ot), q.equals(ne) === false && (s.clearColor(le, oe, Le, ot), q.copy(ne));
    }, reset: function() {
  ...
  function n() {
    ...
    return { setReversed: function(oe) {
      ...
      oe ? re(s.DEPTH_TEST) : be(s.DEPTH_TEST);
    }, setMask: function(oe) {
      k !== oe && !D && (s.depthMask(oe), k = oe);
    }, setFunc: function(oe) {
      if (ne && (oe = Kg[oe]), q !== oe) {
        switch (oe) {
          case la:
  ...
  function i() {
    let D = false, ne = null, k = null, q = null, le = null, oe = null, Le = null, ot = null, Mt = null;
    return { setTest: function(Ke) {
      D || (Ke ? re(s.STENCIL_TEST) : be(s.STENCIL_TEST));
    }, setMask: function(Ke) {
      ne !== Ke && !D && (s.stencilMask(Ke), ne = Ke);
    }, setFunc: function(Ke, Yt, un) {
      (k !== Ke || q !== Yt || le !== un) && (s.stencilFunc(Ke, Yt, un), k = Ke, q = Yt, le = un);
    }, setOp: function(Ke, Yt, un) {
      (oe !== Ke || Le !== Yt || ot !== un) && (s.stencilOp(Ke, Yt, un), oe = Ke, Le = Yt, ot = un);
    }, setLocked: function(Ke) {
      D = Ke;
    }, setClear: function(Ke) {
      Mt !== Ke && (s.clearStencil(Ke), Mt = Ke);
    }, reset: function() {
      D = false, ne = null, k = null, q = null, le = null, oe = null, Le = null, ot = null, Mt = null;
    } };
  }
  const r = new t(), a = new n(), o = new i(), l = /* @__PURE__ */ new WeakMap(), c = /* @__PURE__ */ new WeakMap();
  let h = {}, u = {}, d = /* @__PURE__ */ new WeakMap(), p = [], g = null, _ = false, m = null, f = null, T = null, b = null, y = null, L = null, C = null, A = new Ee(0, 0, 0), N = 0, S = false, M = null, P = null, G = null, z = null, j = null;
  const $ = s.getParameter(s.MAX_COMBINED_TEXTURE_IMAGE_UNITS);
  let X = false, Z = 0;
  const H = s.getParameter(s.VERSION);
  H.indexOf("WebGL") !== -1 ? (Z = parseFloat(/^WebGL (\d)/.exec(H)[1]), X = Z >= 1) : H.indexOf("OpenGL ES") !== -1 && (Z = parseFloat(/^OpenGL ES (\d)/.exec(H)[1]), X = Z >= 2);
  let se = null, he = {};
  ...
  function Ae(D, ne) {
    ...
    if (D) {
      ...
      if (k.length !== le.length || k[0] !== s.COLOR_ATTACHMENT0) {
        for (let oe = 0, Le = le.length; oe < Le; oe++) k[oe] = s.COLOR_ATTACHMENT0 + oe;
  ...
  const at = { [Zn]: s.FUNC_ADD, [sh]: s.FUNC_SUBTRACT, [rh]: s.FUNC_REVERSE_SUBTRACT };
  at[ah] = s.MIN, at[oh] = s.MAX;
  const Be = { [lh]: s.ZERO, [ch]: s.ONE, [hh]: s.SRC_COLOR, [aa]: s.SRC_ALPHA, [gh]: s.SRC_ALPHA_SATURATE, [ph]: s.DST_COLOR, [dh]: s.DST_ALPHA, [uh]: s.ONE_MINUS_SRC_COLOR, [oa]: s.ONE_MINUS_SRC_ALPHA, [mh]: s.ONE_MINUS_DST_COLOR, [fh]: s.ONE_MINUS_DST_ALPHA, [_h]: s.CONSTANT_COLOR, [xh]: s.ONE_MINUS_CONSTANT_COLOR, [vh]: s.CONSTANT_ALPHA, [Mh]: s.ONE_MINUS_CONSTANT_ALPHA };
  function w(D, ne, k, q, le, oe, Le, ot, Mt, Ke) {
    if (D === On) {
      _ === true && (be(s.BLEND), _ = false);
      return;
    }
    if (_ === false && (re(s.BLEND), _ = true), D !== ih) {
      if (D !== m || Ke !== S) {
        if ((f !== Zn || y !== Zn) && (s.blendEquation(s.FUNC_ADD), f = Zn, y = Zn), Ke) switch (D) {
          case Ai:
        ...
        T = null, b = null, L = null, C = null, A.set(0, 0, 0), N = 0, m = D, S = Ke;
      }
      return;
    }
    le = le || ne, oe = oe || k, Le = Le || q, (ne !== f || le !== y) && (s.blendEquationSeparate(at[ne], at[le]), f = ne, y = le), (k !== T || q !== b || oe !== L || Le !== C) && (s.blendFuncSeparate(Be[k], Be[q], Be[oe], Be[Le]), T = k, b = q, L = oe, C = Le), (ot.equals(A) === false || Mt !== N) && (s.blendColor(ot.r, ot.g, ot.b, Mt), A.copy(ot), N = Mt), m = D, S = false;
  }
  function zt(D, ne) {
    D.side === sn ? be(s.CULL_FACE) : re(s.CULL_FACE);
    let k = D.side === Ut;
    ne && (k = !k), ze(k), D.blending === Ai && D.transparent === false ? w(On) : w(D.blending, D.blendEquation, D.blendSrc, D.blendDst, D.blendEquationAlpha, D.blendSrcAlpha, D.blendDstAlpha, D.blendColor, D.blendAlpha, D.premultipliedAlpha), a.setFunc(D.depthFunc), a.setTest(D.depthTest), a.setMask(D.depthWrite), r.setMask(D.colorWrite);
    const q = D.stencilWrite;
    o.setTest(q), q && (o.setMask(D.stencilWriteMask), o.setFunc(D.stencilFunc, D.stencilRef, D.stencilFuncMask), o.setOp(D.stencilFail, D.stencilZFail, D.stencilZPass)), it(D.polygonOffset, D.polygonOffsetFactor, D.polygonOffsetUnits), D.alphaToCoverage === true ? re(s.SAMPLE_ALPHA_TO_COVERAGE) : be(s.SAMPLE_ALPHA_TO_COVERAGE);
  }
  function ze(D) {
    M !== D && (D ? s.frontFace(s.CW) : s.frontFace(s.CCW), M = D);
  }
  function ke(D) {
    D !== eh ? (re(s.CULL_FACE), D !== P && (D === Ao ? s.cullFace(s.BACK) : D === th ? s.cullFace(s.FRONT) : s.cullFace(s.FRONT_AND_BACK))) : be(s.CULL_FACE), P = D;
  }
  function ve(D) {
...
function Jg(s, e, t, n, i, r, a) {
  ...
  function b(E, x, F, Y, K = false) {
    ...
    if (x === s.RED && (F === s.FLOAT && (V = s.R32F), F === s.HALF_FLOAT && (V = s.R16F), F === s.UNSIGNED_BYTE && (V = s.R8)), x === s.RED_INTEGER && (F === s.UNSIGNED_BYTE && (V = s.R8UI), F === s.UNSIGNED_SHORT && (V = s.R16UI), F === s.UNSIGNED_INT && (V = s.R32UI), F === s.BYTE && (V = s.R8I), F === s.SHORT && (V = s.R16I), F === s.INT && (V = s.R32I)), x === s.RG && (F === s.FLOAT && (V = s.RG32F), F === s.HALF_FLOAT && (V = s.RG16F), F === s.UNSIGNED_BYTE && (V = s.RG8)), x === s.RG_INTEGER && (F === s.UNSIGNED_BYTE && (V = s.RG8UI), F === s.UNSIGNED_SHORT && (V = s.RG16UI), F === s.UNSIGNED_INT && (V = s.RG32UI), F === s.BYTE && (V = s.RG8I), F === s.SHORT && (V = s.RG16I), F === s.INT && (V = s.RG32I)), x === s.RGB_INTEGER && (F === s.UNSIGNED_BYTE && (V = s.RGB8UI), F === s.UNSIGNED_SHORT && (V = s.RGB16UI), F === s.UNSIGNED_INT && (V = s.RGB32UI), F === s.BYTE && (V = s.RGB8I), F === s.SHORT && (V = s.RGB16I), F === s.INT && (V = s.RGB32I)), x === s.RGBA_INTEGER && (F === s.UNSIGNED_BYTE && (V = s.RGBA8UI), F === s.UNSIGNED_SHORT && (V = s.RGBA16UI), F === s.UNSIGNED_INT && (V = s.RGBA32UI), F === s.BYTE && (V = s.RGBA8I), F === s.SHORT && (V = s.RGBA16I), F === s.INT && (V = s.RGBA32I)), x === s.RGB && F === s.UNSIGNED_INT_5_9_9_9_REV && (V = s.RGB9_E5), x === s.RGBA) {
      const ge = K ? hr : Ve.getTransfer(Y);
      F === s.FLOAT && (V = s.RGBA32F), F === s.HALF_FLOAT && (V = s.RGBA16F), F === s.UNSIGNED_BYTE && (V = ge === Qe ? s.SRGB8_ALPHA8 : s.RGBA8), F === s.UNSIGNED_SHORT_4_4_4_4 && (V = s.RGBA4), F === s.UNSIGNED_SHORT_5_5_5_1 && (V = s.RGB5_A1);
    }
  ...
  const se = { [Ii]: s.REPEAT, [Un]: s.CLAMP_TO_EDGE, [cr]: s.MIRRORED_REPEAT }, he = { [Ct]: s.NEAREST, [ic]: s.NEAREST_MIPMAP_NEAREST, [ss]: s.NEAREST_MIPMAP_LINEAR, [Bt]: s.LINEAR, [nr]: s.LINEAR_MIPMAP_NEAREST, [Mn]: s.LINEAR_MIPMAP_LINEAR }, xe = { [Fh]: s.NEVER, [Vh]: s.ALWAYS, [Oh]: s.LESS, [mc]: s.LEQUAL, [Bh]: s.EQUAL, [Hh]: s.GEQUAL, [zh]: s.GREATER, [kh]: s.NOTEQUAL };
  function Fe(E, x) {
    if (x.type === Jt && e.has("OES_texture_float_linear") === false && (x.magFilter === Bt || x.magFilter === nr || x.magFilter === ss || x.magFilter === Mn || x.minFilter === Bt || x.minFilter === nr || x.minFilter === ss || x.minFilter === Mn) && console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."), s.texParameteri(E, s.TEXTURE_WRAP_S, se[x.wrapS]), s.texParameteri(E, s.TEXTURE_WRAP_T, se[x.wrapT]), (E === s.TEXTURE_3D || E === s.TEXTURE_2D_ARRAY) && s.texParameteri(E, s.TEXTURE_WRAP_R, se[x.wrapR]), s.texParameteri(E, s.TEXTURE_MAG_FILTER, he[x.magFilter]), s.texParameteri(E, s.TEXTURE_MIN_FILTER, he[x.minFilter]), x.compareFunction && (s.texParameteri(E, s.TEXTURE_COMPARE_MODE, s.COMPARE_REF_TO_TEXTURE), s.texParameteri(E, s.TEXTURE_COMPARE_FUNC, xe[x.compareFunction])), e.has("EXT_texture_filter_anisotropic") === true) {
      if (x.magFilter === Ct || x.minFilter !== ss && x.minFilter !== Mn || x.type === Jt && e.has("OES_texture_float_linear") === false) return;
  ...
  function tt(E, x) {
    ...
    const V = j(x);
    if (V !== E.__cacheKey) {
      K[V] === void 0 && (K[V] = { texture: s.createTexture(), usedTimes: 0 }, a.memory.textures++, F = true), K[V].usedTimes++;
      const ge = K[E.__cacheKey];
      ge !== void 0 && (K[E.__cacheKey].usedTimes--, ge.usedTimes === 0 && S(x)), E.__cacheKey = V, E.__webglTexture = K[V].texture;
    }
    return F;
  }
  function W(E, x, F) {
    ...
    const ge = n.get(V);
    if (V.version !== ge.__version || K === true) {
      t.activeTexture(s.TEXTURE0 + F);
      const ae = Ve.getPrimaries(Ve.workingColorSpace), ue = x.colorSpace === In ? null : Ve.getPrimaries(x.colorSpace), Ge = x.colorSpace === In || ae === ue ? s.NONE : s.BROWSER_DEFAULT_WEBGL;
      ...
      Fe(Y, x);
      let fe;
      const He = x.mipmaps, Ie = x.isVideoTexture !== true, nt = ge.__version === void 0 || K === true, D = V.dataReady, ne = L(x, Q);
      if (x.isDepthTexture) we = y(x.format === Ni, x.type), nt && (Ie ? t.texStorage2D(s.TEXTURE_2D, 1, we, Q.width, Q.height) : t.texImage2D(s.TEXTURE_2D, 0, we, Q.width, Q.height, 0, de, Te, null));
      else if (x.isDataTexture) if (He.length > 0) {
        Ie && nt && t.texStorage2D(s.TEXTURE_2D, ne, we, He[0].width, He[0].height);
        for (let k = 0, q = He.length; k < q; k++) fe = He[k], Ie ? D && t.texSubImage2D(s.TEXTURE_2D, k, 0, 0, fe.width, fe.height, de, Te, fe.data) : t.texImage2D(s.TEXTURE_2D, k, we, fe.width, fe.height, 0, de, Te, fe.data);
        ...
        for (let k = 0, q = He.length; k < q; k++) if (fe = He[k], x.format !== Xt) if (de !== null) if (Ie) {
          if (D) if (x.layerUpdates.size > 0) {
            ...
            for (const oe of x.layerUpdates) {
              ...
              t.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY, k, 0, 0, oe, fe.width, fe.height, 1, de, Le);
            }
            x.clearLayerUpdates();
        ...
        if (nt && t.texStorage3D(s.TEXTURE_2D_ARRAY, ne, we, Q.width, Q.height, Q.depth), D) if (x.layerUpdates.size > 0) {
          const k = yl(Q.width, Q.height, x.format, x.type);
        ...
        for (let k = 0, q = He.length; k < q; k++) fe = He[k], Ie ? D && t.texSubImage2D(s.TEXTURE_2D, k, 0, 0, de, Te, fe) : t.texImage2D(s.TEXTURE_2D, k, we, de, Te, fe);
        x.generateMipmaps = false;
      } else if (Ie) {
        if (nt) {
          const k = _e(Q);
  ...
  function ee(E, x, F) {
    ...
    const V = n.get(K);
    if (K.version !== V.__version || Y === true) {
      t.activeTexture(s.TEXTURE0 + F);
      ...
      const Te = de[0], we = r.convert(x.format, x.colorSpace), fe = r.convert(x.type), He = b(x.internalFormat, we, fe, x.colorSpace), Ie = x.isVideoTexture !== true, nt = V.__version === void 0 || Y === true, D = K.dataReady;
      let ne = L(x, Te);
      ...
      if (Ge) {
        ...
        for (let q = 0; q < 6; q++) {
          ...
          for (let le = 0; le < k.length; le++) {
            const oe = k[le];
            x.format !== Xt ? we !== null ? Ie ? D && t.compressedTexSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X + q, le, 0, 0, oe.width, oe.height, we, oe.data) : t.compressedTexImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X + q, le, He, oe.width, oe.height, 0, oe.data) : console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()") : Ie ? D && t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X + q, le, 0, 0, oe.width, oe.height, we, fe, oe.data) : t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X + q, le, He, oe.width, oe.height, 0, we, fe, oe.data);
          }
        }
      } else {
        ...
        for (let q = 0; q < 6; q++) if (Q) {
          ...
          for (let le = 0; le < k.length; le++) {
            ...
            Ie ? D && t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X + q, le + 1, 0, 0, Le.width, Le.height, we, fe, Le.data) : t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X + q, le + 1, He, Le.width, Le.height, 0, we, fe, Le.data);
          }
        } else {
          ...
          for (let le = 0; le < k.length; le++) {
            const oe = k[le];
            Ie ? D && t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X + q, le + 1, 0, 0, we, fe, oe.image[q]) : t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X + q, le + 1, He, we, fe, oe.image[q]);
          }
        }
      }
  ...
  function me(E, x, F, Y, K, V) {
    const ge = r.convert(F.format, F.colorSpace), ae = r.convert(F.type), ue = b(F.internalFormat, ge, ae, F.colorSpace), Ge = n.get(x), Q = n.get(F);
    if (Q.__renderTarget = x, !Ge.__hasExternalTextures) {
      const de = Math.max(1, x.width >> V), Te = Math.max(1, x.height >> V);
      K === s.TEXTURE_3D || K === s.TEXTURE_2D_ARRAY ? t.texImage3D(K, V, ue, de, Te, x.depth, 0, ge, ae, null) : t.texImage2D(K, V, ue, de, Te, 0, ge, ae, null);
    }
    t.bindFramebuffer(s.FRAMEBUFFER, E), ke(x) ? o.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER, Y, K, Q.__webglTexture, 0, ze(x)) : (K === s.TEXTURE_2D || K >= s.TEXTURE_CUBE_MAP_POSITIVE_X && K <= s.TEXTURE_CUBE_MAP_NEGATIVE_Z) && s.framebufferTexture2D(s.FRAMEBUFFER, Y, K, Q.__webglTexture, V), t.bindFramebuffer(s.FRAMEBUFFER, null);
  }
  function re(E, x, F) {
    if (s.bindRenderbuffer(s.RENDERBUFFER, E), x.depthBuffer) {
      const Y = x.depthTexture, K = Y && Y.isDepthTexture ? Y.type : null, V = y(x.stencilBuffer, K), ge = x.stencilBuffer ? s.DEPTH_STENCIL_ATTACHMENT : s.DEPTH_ATTACHMENT, ae = ze(x);
      ke(x) ? o.renderbufferStorageMultisampleEXT(s.RENDERBUFFER, ae, V, x.width, x.height) : F ? s.renderbufferStorageMultisample(s.RENDERBUFFER, ae, V, x.width, x.height) : s.renderbufferStorage(s.RENDERBUFFER, V, x.width, x.height), s.framebufferRenderbuffer(s.FRAMEBUFFER, ge, s.RENDERBUFFER, E);
    } else {
      const Y = x.textures;
      for (let K = 0; K < Y.length; K++) {
        const V = Y[K], ge = r.convert(V.format, V.colorSpace), ae = r.convert(V.type), ue = b(V.internalFormat, ge, ae, V.colorSpace), Ge = ze(x);
        F && ke(x) === false ? s.renderbufferStorageMultisample(s.RENDERBUFFER, Ge, ue, x.width, x.height) : ke(x) ? o.renderbufferStorageMultisampleEXT(s.RENDERBUFFER, Ge, ue, x.width, x.height) : s.renderbufferStorage(s.RENDERBUFFER, ue, x.width, x.height);
      }
    }
  ...
  function be(E, x) {
    ...
    const K = Y.__webglTexture, V = ze(x);
    if (x.depthTexture.format === wi) ke(x) ? o.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER, s.DEPTH_ATTACHMENT, s.TEXTURE_2D, K, 0, V) : s.framebufferTexture2D(s.FRAMEBUFFER, s.DEPTH_ATTACHMENT, s.TEXTURE_2D, K, 0);
    else if (x.depthTexture.format === Ni) ke(x) ? o.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER, s.DEPTH_STENCIL_ATTACHMENT, s.TEXTURE_2D, K, 0, V) : s.framebufferTexture2D(s.FRAMEBUFFER, s.DEPTH_STENCIL_ATTACHMENT, s.TEXTURE_2D, K, 0);
  ...
  function Ye(E) {
    ...
    if (E.depthTexture && !x.__autoAllocateDepthBuffer) {
      ...
      for (let Y = 0; Y < 6; Y++) if (t.bindFramebuffer(s.FRAMEBUFFER, x.__webglFramebuffer[Y]), x.__webglDepthbuffer[Y] === void 0) x.__webglDepthbuffer[Y] = s.createRenderbuffer(), re(x.__webglDepthbuffer[Y], E, false);
        ...
        const K = E.stencilBuffer ? s.DEPTH_STENCIL_ATTACHMENT : s.DEPTH_ATTACHMENT, V = x.__webglDepthbuffer[Y];
  ...
  function ct(E) {
    ...
    const K = E.textures, V = E.isWebGLCubeRenderTarget === true, ge = K.length > 1;
    if (ge || (Y.__webglTexture === void 0 && (Y.__webglTexture = s.createTexture()), Y.__version = x.version, a.memory.textures++), V) {
      ...
      if (ge) for (let ae = 0, ue = K.length; ae < ue; ae++) {
        const Ge = n.get(K[ae]);
        Ge.__webglTexture === void 0 && (Ge.__webglTexture = s.createTexture(), a.memory.textures++);
      }
      if (E.samples > 0 && ke(E) === false) {
        ...
        for (let ae = 0; ae < K.length; ae++) {
          ...
          const Ge = r.convert(ue.format, ue.colorSpace), Q = r.convert(ue.type), de = b(ue.internalFormat, Ge, Q, ue.colorSpace, E.isXRRenderTarget === true), Te = ze(E);
          s.renderbufferStorageMultisample(s.RENDERBUFFER, Te, de, E.width, E.height), s.framebufferRenderbuffer(s.FRAMEBUFFER, s.COLOR_ATTACHMENT0 + ae, s.RENDERBUFFER, F.__webglColorRenderbuffer[ae]);
        }
    ...
    if (V) {
      ...
      for (let ae = 0, ue = K.length; ae < ue; ae++) {
        const Ge = K[ae], Q = n.get(Ge);
        t.bindTexture(s.TEXTURE_2D, Q.__webglTexture), Fe(s.TEXTURE_2D, Ge), me(F.__webglFramebuffer, E, Ge, s.COLOR_ATTACHMENT0 + ae, s.TEXTURE_2D, 0), m(Ge) && f(s.TEXTURE_2D);
      }
      t.unbindTexture();
    } else {
      let ae = s.TEXTURE_2D;
      if ((E.isWebGL3DRenderTarget || E.isWebGLArrayRenderTarget) && (ae = E.isWebGL3DRenderTarget ? s.TEXTURE_3D : s.TEXTURE_2D_ARRAY), t.bindTexture(ae, Y.__webglTexture), Fe(ae, x), x.mipmaps && x.mipmaps.length > 0) for (let ue = 0; ue < x.mipmaps.length; ue++) me(F.__webglFramebuffer[ue], E, x, s.COLOR_ATTACHMENT0, ae, ue);
  ...
  function at(E) {
    ...
    for (let F = 0, Y = x.length; F < Y; F++) {
      const K = x[F];
      if (m(K)) {
        const V = T(E), ge = n.get(K).__webglTexture;
  ...
  function zt(E) {
    if (E.samples > 0) {
      if (ke(E) === false) {
        ...
        const V = E.stencilBuffer ? s.DEPTH_STENCIL_ATTACHMENT : s.DEPTH_ATTACHMENT, ge = n.get(E), ae = x.length > 1;
        ...
        for (let ue = 0; ue < x.length; ue++) {
          ...
          s.blitFramebuffer(0, 0, F, Y, 0, 0, F, Y, K, s.NEAREST), l === true && (Be.length = 0, w.length = 0, Be.push(s.COLOR_ATTACHMENT0 + ue), E.depthBuffer && E.resolveDepthBuffer === false && (Be.push(V), w.push(V), s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER, w)), s.invalidateFramebuffer(s.READ_FRAMEBUFFER, Be));
        }
  ...
  function it(E, x) {
    ...
    return E.isCompressedTexture === true || E.isVideoTexture === true || F !== Lt && F !== In && (Ve.getTransfer(F) === Qe ? (Y !== Xt || K !== bn) && console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType.") : console.error("THREE.WebGLTextures: Unsupported texture color space:", F)), x;
  }
  function _e(E) {
...
function Qg(s, e) {
  function t(n, i = In) {
    ...
    if (n === Qa) return s.UNSIGNED_SHORT_4_4_4_4;
    if (n === eo) return s.UNSIGNED_SHORT_5_5_5_1;
    if (n === ac) return s.UNSIGNED_INT_5_9_9_9_REV;
    if (n === sc) return s.BYTE;
    if (n === rc) return s.SHORT;
    if (n === hs) return s.UNSIGNED_SHORT;
    if (n === Ja) return s.INT;
    if (n === ei) return s.UNSIGNED_INT;
    if (n === Jt) return s.FLOAT;
    if (n === _s) return s.HALF_FLOAT;
    if (n === oc) return s.ALPHA;
    if (n === lc) return s.RGB;
    if (n === Xt) return s.RGBA;
    if (n === cc) return s.LUMINANCE;
    if (n === hc) return s.LUMINANCE_ALPHA;
    if (n === wi) return s.DEPTH_COMPONENT;
    if (n === Ni) return s.DEPTH_STENCIL;
    if (n === to) return s.RED;
    if (n === no) return s.RED_INTEGER;
    if (n === uc) return s.RG;
    if (n === io) return s.RG_INTEGER;
    if (n === so) return s.RGBA_INTEGER;
    if (n === ir || n === sr || n === rr || n === ar) if (a === Qe) if (r = e.get("WEBGL_compressed_texture_s3tc_srgb"), r !== null) {
    ...
    if (n === _a || n === xa || n === va || n === Ma) if (r = e.get("WEBGL_compressed_texture_pvrtc"), r !== null) {
      if (n === _a) return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;
    ...
    if (n === ya || n === Sa || n === Ea) if (r = e.get("WEBGL_compressed_texture_etc"), r !== null) {
      if (n === ya || n === Sa) return a === Qe ? r.COMPRESSED_SRGB8_ETC2 : r.COMPRESSED_RGB8_ETC2;
      if (n === Ea) return a === Qe ? r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC : r.COMPRESSED_RGBA8_ETC2_EAC;
    } else return null;
    if (n === ba || n === Ta || n === Aa || n === wa || n === Ra || n === Ca || n === Pa || n === La || n === Da || n === Ia || n === Ua || n === Na || n === Fa || n === Oa) if (r = e.get("WEBGL_compressed_texture_astc"), r !== null) {
      if (n === ba) return a === Qe ? r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR : r.COMPRESSED_RGBA_ASTC_4x4_KHR;
      if (n === Ta) return a === Qe ? r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR : r.COMPRESSED_RGBA_ASTC_5x4_KHR;
      if (n === Aa) return a === Qe ? r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR : r.COMPRESSED_RGBA_ASTC_5x5_KHR;
      if (n === wa) return a === Qe ? r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR : r.COMPRESSED_RGBA_ASTC_6x5_KHR;
      if (n === Ra) return a === Qe ? r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR : r.COMPRESSED_RGBA_ASTC_6x6_KHR;
      if (n === Ca) return a === Qe ? r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR : r.COMPRESSED_RGBA_ASTC_8x5_KHR;
      if (n === Pa) return a === Qe ? r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR : r.COMPRESSED_RGBA_ASTC_8x6_KHR;
      if (n === La) return a === Qe ? r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR : r.COMPRESSED_RGBA_ASTC_8x8_KHR;
      if (n === Da) return a === Qe ? r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR : r.COMPRESSED_RGBA_ASTC_10x5_KHR;
      if (n === Ia) return a === Qe ? r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR : r.COMPRESSED_RGBA_ASTC_10x6_KHR;
      if (n === Ua) return a === Qe ? r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR : r.COMPRESSED_RGBA_ASTC_10x8_KHR;
      if (n === Na) return a === Qe ? r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR : r.COMPRESSED_RGBA_ASTC_10x10_KHR;
      if (n === Fa) return a === Qe ? r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR : r.COMPRESSED_RGBA_ASTC_12x10_KHR;
      if (n === Oa) return a === Qe ? r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR : r.COMPRESSED_RGBA_ASTC_12x12_KHR;
    } else return null;
    if (n === or || n === Ba || n === za) if (r = e.get("EXT_texture_compression_bptc"), r !== null) {
      if (n === or) return a === Qe ? r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT : r.COMPRESSED_RGBA_BPTC_UNORM_EXT;
      if (n === Ba) return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;
      if (n === za) return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT;
    } else return null;
    if (n === dc || n === ka || n === Ha || n === Va) if (r = e.get("EXT_texture_compression_rgtc"), r !== null) {
...
class n_ {
  ...
  getMesh(e) {
    if (this.texture !== null && this.mesh === null) {
      const t = e.cameras[0].viewport, n = new zn({ vertexShader: e_, fragmentShader: t_, uniforms: { depthColor: { value: this.texture }, depthWidth: { value: t.z }, depthHeight: { value: t.w } } });
      this.mesh = new bt(new gr(20, 20), n);
    }
    return this.mesh;
  }
  reset() {
...
class i_ extends ni {
  constructor(e, t) {
    ...
    const _ = new n_(), m = t.getContextAttributes();
    let f = null, T = null;
    const b = [], y = [], L = new ye();
    let C = null;
    const A = new Et();
    ...
    const N = new Et();
    N.viewport = new qe();
    const S = [A, N], M = new dd();
    let P = null, G = null;
    this.cameraAutoUpdate = true, this.enabled = false, this.isPresenting = false, this.getController = function(W) {
      let ee = b[W];
      return ee === void 0 && (ee = new Hr(), b[W] = ee), ee.getTargetRaySpace();
    }, this.getControllerGrip = function(W) {
      let ee = b[W];
      return ee === void 0 && (ee = new Hr(), b[W] = ee), ee.getGripSpace();
    }, this.getHand = function(W) {
      let ee = b[W];
      return ee === void 0 && (ee = new Hr(), b[W] = ee), ee.getHandSpace();
    };
    function z(W) {
    ...
    function j() {
      ...
      for (let W = 0; W < b.length; W++) {
        const ee = y[W];
        ee !== null && (y[W] = null, b[W].disconnect(ee));
      }
      P = null, G = null, _.reset(), e.setRenderTarget(f), p = null, d = null, u = null, i = null, T = null, tt.stop(), n.isPresenting = false, e.setPixelRatio(C), e.setSize(L.width, L.height, false), n.dispatchEvent({ type: "sessionend" });
    }
    this.setFramebufferScaleFactor = function(W) {
      ...
      if (i = W, i !== null) {
        if (f = e.getRenderTarget(), i.addEventListener("select", z), i.addEventListener("selectstart", z), i.addEventListener("selectend", z), i.addEventListener("squeeze", z), i.addEventListener("squeezestart", z), i.addEventListener("squeezeend", z), i.addEventListener("end", j), i.addEventListener("inputsourceschange", $), m.xrCompatible !== true && await t.makeXRCompatible(), C = e.getPixelRatio(), e.getSize(L), typeof XRWebGLBinding < "u" && "createProjectionLayer" in XRWebGLBinding.prototype) {
          ...
          u = new XRWebGLBinding(i, t), d = u.createProjectionLayer(Ye), i.updateRenderState({ layers: [d] }), e.setPixelRatio(1), e.setSize(d.textureWidth, d.textureHeight, false), T = new ti(d.textureWidth, d.textureHeight, { format: Xt, type: bn, depthTexture: new Ic(d.textureWidth, d.textureHeight, re, void 0, void 0, void 0, void 0, void 0, void 0, me), stencilBuffer: m.stencil, colorSpace: e.outputColorSpace, samples: m.antialias ? 4 : 0, resolveDepthBuffer: d.ignoreDepthValues === false, resolveStencilBuffer: d.ignoreDepthValues === false });
        } else {
          const me = { antialias: m.antialias, alpha: true, depth: m.depth, stencil: m.stencil, framebufferScaleFactor: r };
          p = new XRWebGLLayer(i, t, me), i.updateRenderState({ baseLayer: p }), e.setPixelRatio(1), e.setSize(p.framebufferWidth, p.framebufferHeight, false), T = new ti(p.framebufferWidth, p.framebufferHeight, { format: Xt, type: bn, colorSpace: e.outputColorSpace, stencilBuffer: m.stencil, resolveDepthBuffer: p.ignoreDepthValues === false, resolveStencilBuffer: p.ignoreDepthValues === false });
        }
        T.isXRRenderTarget = true, this.setFoveation(l), c = null, a = await i.requestReferenceSpace(o), tt.setContext(i), tt.start(), n.isPresenting = true, n.dispatchEvent({ type: "sessionstart" });
      }
    ...
    function $(W) {
      for (let ee = 0; ee < W.removed.length; ee++) {
        const me = W.removed[ee], re = y.indexOf(me);
        re >= 0 && (y[re] = null, b[re].disconnect(me));
      }
      for (let ee = 0; ee < W.added.length; ee++) {
        const me = W.added[ee];
        let re = y.indexOf(me);
        if (re === -1) {
          for (let Ye = 0; Ye < b.length; Ye++) if (Ye >= y.length) {
            y.push(me), re = Ye;
            break;
          } else if (y[Ye] === null) {
            y[Ye] = me, re = Ye;
    ...
    function H(W, ee, me) {
      ...
      const re = X.distanceTo(Z), be = ee.projectionMatrix.elements, Ye = me.projectionMatrix.elements, Ae = be[14] / (be[10] - 1), ct = be[14] / (be[10] + 1), at = (be[9] + 1) / be[5], Be = (be[9] - 1) / be[5], w = (be[8] - 1) / be[0], zt = (Ye[8] + 1) / Ye[0], ze = Ae * w, ke = Ae * zt, ve = re / (-w + zt), it = ve * -w;
      if (ee.matrixWorld.decompose(W.position, W.quaternion, W.scale), W.translateX(it), W.translateZ(ve), W.matrixWorld.compose(W.position, W.quaternion, W.scale), W.matrixWorldInverse.copy(W.matrixWorld).invert(), be[10] === -1) W.projectionMatrix.copy(ee.projectionMatrix), W.projectionMatrixInverse.copy(ee.projectionMatrixInverse);
        ...
        const _e = Ae + ve, E = ct + ve, x = ze - it, F = ke + (re - it), Y = at * ct / E * _e, K = Be * ct / E * _e;
    ...
    this.updateCamera = function(W) {
      ...
      _.texture !== null && (_.depthNear > 0 && (ee = _.depthNear), _.depthFar > 0 && (me = _.depthFar)), M.near = N.near = A.near = ee, M.far = N.far = A.far = me, (P !== M.near || G !== M.far) && (i.updateRenderState({ depthNear: M.near, depthFar: M.far }), P = M.near, G = M.far), A.layers.mask = W.layers.mask | 2, N.layers.mask = W.layers.mask | 4, M.layers.mask = A.layers.mask | N.layers.mask;
      const re = W.parent, be = M.cameras;
      se(M, re);
      for (let Ye = 0; Ye < be.length; Ye++) se(be[Ye], re);
      be.length === 2 ? H(M, A, N) : M.projectionMatrix.copy(A.projectionMatrix), he(W, M, re);
    };
    function he(W, ee, me) {
    ...
    function Fe(W, ee) {
      if (h = ee.getViewerPose(c || a), g = ee, h !== null) {
        ...
        for (let Ae = 0; Ae < me.length; Ae++) {
          const ct = me[Ae];
          let at = null;
          if (p !== null) at = p.getViewport(ct);
          else {
            const w = u.getViewSubImage(d, ct);
            at = w.viewport, Ae === 0 && (e.setRenderTargetTextures(T, w.colorTexture, d.ignoreDepthValues ? void 0 : w.depthStencilTexture), e.setRenderTarget(T));
          }
          let Be = S[Ae];
          Be === void 0 && (Be = new Et(), Be.layers.enable(Ae), Be.viewport = new qe(), S[Ae] = Be), Be.matrix.fromArray(ct.transform.matrix), Be.matrix.decompose(Be.position, Be.quaternion, Be.scale), Be.projectionMatrix.fromArray(ct.projectionMatrix), Be.projectionMatrixInverse.copy(Be.projectionMatrix).invert(), Be.viewport.set(at.x, at.y, at.width, at.height), Ae === 0 && (M.matrix.copy(Be.matrix), M.matrix.decompose(M.position, M.quaternion, M.scale)), re === true && M.cameras.push(Be);
        }
      ...
      for (let me = 0; me < b.length; me++) {
        const re = y[me], be = b[me];
        re !== null && be !== void 0 && be.update(re, ee, c || a);
      }
...
const qn = new on(), s_ = new Pe();
function r_(s, e) {
  function t(m, f) {
    m.matrixAutoUpdate === true && m.updateMatrix(), f.value.copy(m.matrix);
  }
  function n(m, f) {
    f.color.getRGB(m.fogColor.value, Ec(s)), f.isFog ? (m.fogNear.value = f.near, m.fogFar.value = f.far) : f.isFogExp2 && (m.fogDensity.value = f.density);
  }
  function i(m, f, T, b, y) {
  ...
  function r(m, f) {
    ...
    b && (m.envMap.value = b, qn.copy(y), qn.x *= -1, qn.y *= -1, qn.z *= -1, b.isCubeTexture && b.isRenderTargetTexture === false && (qn.y *= -1, qn.z *= -1), m.envMapRotation.value.setFromMatrix4(s_.makeRotationFromEuler(qn)), m.flipEnvMap.value = b.isCubeTexture && b.isRenderTargetTexture === false ? -1 : 1, m.reflectivity.value = f.reflectivity, m.ior.value = f.ior, m.refractionRatio.value = f.refractionRatio), f.lightMap && (m.lightMap.value = f.lightMap, m.lightMapIntensity.value = f.lightMapIntensity, t(f.lightMap, m.lightMapTransform)), f.aoMap && (m.aoMap.value = f.aoMap, m.aoMapIntensity.value = f.aoMapIntensity, t(f.aoMap, m.aoMapTransform));
  }
  function a(m, f) {
...
function a_(s, e, t, n) {
  ...
  function c(T, b) {
    let y = i[T.id];
    y === void 0 && (g(T), y = h(T), i[T.id] = y, T.addEventListener("dispose", m));
    const L = b.program;
  ...
  function h(T) {
    ...
    const y = s.createBuffer(), L = T.__size, C = T.usage;
    return s.bindBuffer(s.UNIFORM_BUFFER, y), s.bufferData(s.UNIFORM_BUFFER, L, C), s.bindBuffer(s.UNIFORM_BUFFER, null), s.bindBufferBase(s.UNIFORM_BUFFER, b, y), y;
  }
  function u() {
  ...
  function d(T) {
    const b = i[T.id], y = T.uniforms, L = T.__cache;
    s.bindBuffer(s.UNIFORM_BUFFER, b);
    for (let C = 0, A = y.length; C < A; C++) {
    ...
    for (let A = 0, N = b.length; A < N; A++) {
      ...
      for (let M = 0, P = S.length; M < P; M++) {
        ...
        for (let j = 0, $ = z.length; j < $; j++) {
          const X = z[j], Z = _(X), H = y % L, se = H % Z.boundary, he = H + se;
          y += se, he !== 0 && L - he < Z.storage && (y += L - he), G.__data = new Float32Array(Z.storage / Float32Array.BYTES_PER_ELEMENT), G.__offset = y, y += Z.storage;
        }
      }
    }
    const C = y % L;
    return C > 0 && (y += L - C), T.__size = y, T.__cache = {}, this;
  }
  function _(T) {
...
class Wc {
  constructor(e = {}) {
    const { canvas: t = ru(), context: n = null, depth: i = true, stencil: r = false, alpha: a = false, antialias: o = false, premultipliedAlpha: l = true, preserveDrawingBuffer: c = false, powerPreference: h = "default", failIfMajorPerformanceCaveat: u = false, reverseDepthBuffer: d = false } = e;
    ...
    let m = null, f = null;
    const T = [], b = [];
    this.domElement = t, this.debug = { checkShaderErrors: true, onShaderError: null }, this.autoClear = true, this.autoClearColor = true, this.autoClearDepth = true, this.autoClearStencil = true, this.sortObjects = true, this.clippingPlanes = [], this.localClippingEnabled = false, this._outputColorSpace = xt, this.toneMapping = Bn, this.toneMappingExposure = 1;
    const y = this;
    let L = false, C = 0, A = 0, N = null, S = -1, M = null;
    const P = new qe(), G = new qe();
    let z = null;
    const j = new Ee(0);
    let $ = 0, X = t.width, Z = t.height, H = 1, se = null, he = null;
    ...
    try {
      ...
      if ("setAttribute" in t && t.setAttribute("data-engine", `three.js r${Za}`), t.addEventListener("webglcontextlost", q, false), t.addEventListener("webglcontextrestored", le, false), t.addEventListener("webglcontextcreationerror", oe, false), w === null) {
        const I = "webgl2";
    ...
    let ze, ke, ve, it, _e, E, x, F, Y, K, V, ge, ae, ue, Ge, Q, de, Te, we, fe, He, Ie, nt, D;
    function ne() {
      ze = new _m(w), ze.init(), Ie = new Qg(w, ze), ke = new hm(w, ze, e, Ie), ve = new Zg(w, ze), ke.reverseDepthBuffer && d && ve.buffers.depth.setReversed(true), it = new Mm(w), _e = new Bg(), E = new Jg(w, ze, ve, _e, ke, Ie, it), x = new dm(y), F = new gm(y), Y = new Td(w), nt = new lm(w, Y), K = new xm(w, Y, it, nt), V = new Sm(w, K, Y, it), we = new ym(w, ke, E), Q = new um(_e), ge = new Og(y, x, F, ze, ke, nt, Q), ae = new r_(y, _e), ue = new kg(), Ge = new Yg(ze), Te = new om(y, x, F, ve, V, p, l), de = new $g(y, V, ke), D = new a_(w, it, ke, ve), fe = new cm(w, ze, it), He = new vm(w, ze, it), it.programs = ge.programs, y.capabilities = ke, y.extensions = ze, y.properties = _e, y.renderLists = ue, y.shadowMap = de, y.state = ve, y.info = it;
    }
    ne();
    const k = new i_(y, w);
    this.xr = k, this.getContext = function() {
      ...
      v !== void 0 && (H = v, this.setSize(X, Z, false));
      ...
      X = v, Z = I, t.width = Math.floor(v * H), t.height = Math.floor(I * H), O === true && (t.style.width = v + "px", t.style.height = I + "px"), this.setViewport(0, 0, v, I);
    }, this.getDrawingBufferSize = function(v) {
      return v.set(X * H, Z * H).floor();
    }, this.setDrawingBufferSize = function(v, I, O) {
      X = v, Z = I, H = O, t.width = Math.floor(v * O), t.height = Math.floor(I * O), this.setViewport(0, 0, v, I);
    }, this.getCurrentViewport = function(v) {
      return v.copy(P);
    }, this.getViewport = function(v) {
      return v.copy(xe);
    }, this.setViewport = function(v, I, O, B) {
      v.isVector4 ? xe.set(v.x, v.y, v.z, v.w) : xe.set(v, I, O, B), ve.viewport(P.copy(xe).multiplyScalar(H).round());
    }, this.getScissor = function(v) {
      return v.copy(Fe);
    }, this.setScissor = function(v, I, O, B) {
      v.isVector4 ? Fe.set(v.x, v.y, v.z, v.w) : Fe.set(v, I, O, B), ve.scissor(G.copy(Fe).multiplyScalar(H).round());
      ...
      if (v) {
        ...
        if (U) {
          const J = N.texture.type, ie = J === bn || J === ei || J === hs || J === Ui || J === Qa || J === eo, ce = Te.getClearColor(), pe = Te.getClearAlpha(), Re = ce.r, Ce = ce.g, Me = ce.b;
          ie ? (g[0] = Re, g[1] = Ce, g[2] = Me, g[3] = pe, w.clearBufferuiv(w.COLOR, 0, g)) : (_[0] = Re, _[1] = Ce, _[2] = Me, _[3] = pe, w.clearBufferiv(w.COLOR, 0, _));
      ...
      t.removeEventListener("webglcontextlost", q, false), t.removeEventListener("webglcontextrestored", le, false), t.removeEventListener("webglcontextcreationerror", oe, false), Te.dispose(), ue.dispose(), Ge.dispose(), _e.dispose(), x.dispose(), F.dispose(), V.dispose(), nt.dispose(), D.dispose(), ge.dispose(), k.dispose(), k.removeEventListener("sessionstart", vo), k.removeEventListener("sessionend", Mo), kn.stop();
    };
    function q(v) {
    ...
    this.renderBufferDirect = function(v, I, O, B, U, J) {
      I === null && (I = ct);
      const ie = U.isMesh && U.matrixWorld.determinant() < 0, ce = jc(v, I, O, B, U);
      ve.setMaterial(B, ie);
      let pe = O.index, Re = 1;
      if (B.wireframe === true) {
      ...
      J !== null && (We = Math.max(We, J.start * Re), je = Math.min(je, (J.start + J.count) * Re)), pe !== null ? (We = Math.max(We, 0), je = Math.min(je, pe.count)) : Me != null && (We = Math.max(We, 0), je = Math.min(je, Me.count));
      const ht = je - We;
      if (ht < 0 || ht === 1 / 0) return;
      nt.setup(U, B, ce, O, pe);
      let lt, Xe = fe;
      if (pe !== null && (lt = Y.get(pe), Xe = He, Xe.setIndex(lt)), U.isMesh) B.wireframe === true ? (ve.setLineWidth(B.wireframeLinewidth * Be()), Xe.setMode(w.LINES)) : Xe.setMode(w.TRIANGLES);
      else if (U.isLine) {
        let Se = B.linewidth;
      ...
      if (U.isBatchedMesh) if (U._multiDrawInstances !== null) $n("THREE.WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."), Xe.renderMultiDrawInstances(U._multiDrawStarts, U._multiDrawCounts, U._multiDrawCount, U._multiDrawInstances);
        ...
        const Se = U._multiDrawStarts, _t = U._multiDrawCounts, $e = U._multiDrawCount, qt = pe ? Y.get(pe).bytesPerElement : 1, ii = _e.get(B).currentProgram.getUniforms();
        for (let Nt = 0; Nt < $e; Nt++) ii.setValue(w, "_gl_DrawID", Nt), Xe.render(Se[Nt] / qt, _t[Nt]);
      }
    ...
    function Ke(v, I, O) {
      v.transparent === true && v.side === sn && v.forceSinglePass === false ? (v.side = Ut, v.needsUpdate = true, bs(v, I, O), v.side = En, v.needsUpdate = true, bs(v, I, O), v.side = sn) : bs(v, I, O);
    }
    this.compile = function(v, I, O = null) {
      O === null && (O = v), f = Ge.get(O), f.init(I), b.push(f), O.traverseVisible(function(U) {
    ...
    const kn = new zc();
    kn.setAnimationLoop(un), typeof self < "u" && kn.setContext(self), this.setAnimationLoop = function(v) {
      Yt = v, k.setAnimationLoop(v), v === null ? kn.stop() : kn.start();
    }, k.addEventListener("sessionstart", vo), k.addEventListener("sessionend", Mo), this.render = function(v, I) {
      if (I !== void 0 && I.isCamera !== true) {
        console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");
        return;
      }
      if (L === true) return;
      if (v.matrixWorldAutoUpdate === true && v.updateMatrixWorld(), I.parent === null && I.matrixWorldAutoUpdate === true && I.updateMatrixWorld(), k.enabled === true && k.isPresenting === true && (k.cameraAutoUpdate === true && k.updateCamera(I), I = k.getCamera()), v.isScene === true && v.onBeforeRender(y, v, I, N), f = Ge.get(v, b.length), f.init(I), b.push(f), be.multiplyMatrices(I.projectionMatrix, I.matrixWorldInverse), W.setFromProjectionMatrix(be), me = this.localClippingEnabled, ee = Q.init(this.clippingPlanes, me), m = ue.get(v, T.length), m.init(), T.push(m), k.enabled === true && k.isPresenting === true) {
        const J = y.xr.getDepthSensingMesh();
        J !== null && vr(J, I, -1 / 0, y.sortObjects);
      }
      vr(v, I, 0, y.sortObjects), m.finish(), y.sortObjects === true && m.sort(se, he), at = k.enabled === false || k.isPresenting === false || k.hasDepthSensing() === false, at && Te.addToRenderList(m, v), this.info.render.frame++, ee === true && Q.beginShadows();
      ...
      if (f.setupLights(), I.isArrayCamera) {
        ...
        for (let ie = 0, ce = J.length; ie < ce; ie++) {
          const pe = J[ie];
          yo(m, v, pe, pe.viewport);
        }
      } else U.length > 0 && So(B, U, v, I), at && Te.render(v), yo(m, v, I);
      N !== null && A === 0 && (E.updateMultisampleRenderTarget(N), E.updateRenderTargetMipmap(N)), v.isScene === true && v.onAfterRender(y, v, I), nt.resetDefaultState(), S = -1, M = null, b.pop(), b.length > 0 ? (f = b[b.length - 1], ee === true && Q.setGlobalState(y.clippingPlanes, f.state.camera)) : f = null, T.pop(), T.length > 0 ? m = T[T.length - 1] : m = null;
    };
    function vr(v, I, O, B) {
        ...
        if (v.isGroup) O = v.renderOrder;
          ...
          if (B && (v.boundingSphere !== void 0 ? (v.boundingSphere === null && v.computeBoundingSphere(), Ae.copy(v.boundingSphere.center)) : (ie.boundingSphere === null && ie.computeBoundingSphere(), Ae.copy(ie.boundingSphere.center)), Ae.applyMatrix4(v.matrixWorld).applyMatrix4(be)), Array.isArray(ce)) {
            ...
            for (let Re = 0, Ce = pe.length; Re < Ce; Re++) {
              const Me = pe[Re], We = ce[Me.materialIndex];
              We && We.visible && m.push(v, ie, We, O, Ae.z, Me);
            }
    ...
    function yo(v, I, O, B) {
      ...
      f.setupLightsView(O), ee === true && Q.setGlobalState(y.clippingPlanes, O), B && ve.viewport(P.copy(B)), U.length > 0 && Es(U, I, O), J.length > 0 && Es(J, I, O), ie.length > 0 && Es(ie, I, O), ve.buffers.depth.setTest(true), ve.buffers.depth.setMask(true), ve.buffers.color.setMask(true), ve.setPolygonOffset(false);
    }
    function So(v, I, O, B) {
      if ((O.isScene === true ? O.overrideMaterial : null) !== null) return;
      f.state.transmissionRenderTarget[B.id] === void 0 && (f.state.transmissionRenderTarget[B.id] = new ti(1, 1, { generateMipmaps: true, type: ze.has("EXT_color_buffer_half_float") || ze.has("EXT_color_buffer_float") ? _s : bn, minFilter: Mn, samples: 4, stencilBuffer: r, resolveDepthBuffer: false, resolveStencilBuffer: false, colorSpace: Ve.workingColorSpace }));
      ...
      y.setRenderTarget(J), y.getClearColor(j), $ = y.getClearAlpha(), $ < 1 && y.setClearColor(16777215, 0.5), y.clear(), at && Te.render(O);
      const pe = y.toneMapping;
      y.toneMapping = Bn;
      const Re = B.viewport;
      if (B.viewport !== void 0 && (B.viewport = void 0), f.setupLightsView(B), ee === true && Q.setGlobalState(y.clippingPlanes, B), Es(v, O, B), E.updateMultisampleRenderTarget(J), E.updateRenderTargetMipmap(J), ze.has("WEBGL_multisampled_render_to_texture") === false) {
        let Ce = false;
        for (let Me = 0, We = I.length; Me < We; Me++) {
          const je = I[Me], ht = je.object, lt = je.geometry, Xe = je.material, Se = je.group;
          if (Xe.side === sn && ht.layers.test(B.layers)) {
            const _t = Xe.side;
            Xe.side = Ut, Xe.needsUpdate = true, Eo(ht, O, B, lt, Xe, Se), Xe.side = _t, Xe.needsUpdate = true, Ce = true;
          }
        }
        Ce === true && (E.updateMultisampleRenderTarget(J), E.updateRenderTargetMipmap(J));
      }
      y.setRenderTarget(ce), y.setClearColor(j, $), Re !== void 0 && (B.viewport = Re), y.toneMapping = pe;
    }
    function Es(v, I, O) {
      ...
      for (let U = 0, J = v.length; U < J; U++) {
        ...
        ce.layers.test(O.layers) && Eo(ce, I, O, pe, Re, Ce);
      }
    }
    function Eo(v, I, O, B, U, J) {
      v.onBeforeRender(y, I, O, B, U, J), v.modelViewMatrix.multiplyMatrices(O.matrixWorldInverse, v.matrixWorld), v.normalMatrix.getNormalMatrix(v.modelViewMatrix), U.onBeforeRender(y, I, O, B, v, J), U.transparent === true && U.side === sn && U.forceSinglePass === false ? (U.side = Ut, U.needsUpdate = true, y.renderBufferDirect(O, I, B, U, v, J), U.side = En, U.needsUpdate = true, y.renderBufferDirect(O, I, B, U, v, J), U.side = sn) : y.renderBufferDirect(O, I, B, U, v, J), v.onAfterRender(y, I, O, B, U, J);
    }
    function bs(v, I, O) {
      I.isScene !== true && (I = ct);
      ...
      let Ce = Re.get(pe);
      if (Ce !== void 0) {
        if (B.currentProgram === Ce && B.lightsStateVersion === ie) return To(v, ce), Ce;
      } else ce.uniforms = ge.getUniforms(v), v.onBeforeCompile(ce, y), Ce = ge.acquireProgram(ce, pe), Re.set(pe, Ce), B.uniforms = ce.uniforms;
      const Me = B.uniforms;
      return (!v.isShaderMaterial && !v.isRawShaderMaterial || v.clipping === true) && (Me.clippingPlanes = Q.uniform), To(v, ce), B.needsLights = Kc(v), B.lightsStateVersion = ie, B.needsLights && (Me.ambientLightColor.value = U.state.ambient, Me.lightProbe.value = U.state.probe, Me.directionalLights.value = U.state.directional, Me.directionalLightShadows.value = U.state.directionalShadow, Me.spotLights.value = U.state.spot, Me.spotLightShadows.value = U.state.spotShadow, Me.rectAreaLights.value = U.state.rectArea, Me.ltc_1.value = U.state.rectAreaLTC1, Me.ltc_2.value = U.state.rectAreaLTC2, Me.pointLights.value = U.state.point, Me.pointLightShadows.value = U.state.pointShadow, Me.hemisphereLights.value = U.state.hemi, Me.directionalShadowMap.value = U.state.directionalShadowMap, Me.directionalShadowMatrix.value = U.state.directionalShadowMatrix, Me.spotShadowMap.value = U.state.spotShadowMap, Me.spotLightMatrix.value = U.state.spotLightMatrix, Me.spotLightMap.value = U.state.spotLightMap, Me.pointShadowMap.value = U.state.pointShadowMap, Me.pointShadowMatrix.value = U.state.pointShadowMatrix), B.currentProgram = Ce, B.uniformsList = null, Ce;
    }
    function bo(v) {
      if (v.uniformsList === null) {
        const I = v.currentProgram.getUniforms();
        v.uniformsList = lr.seqWithValue(I.seq, v.uniforms);
      }
    ...
    function jc(v, I, O, B, U) {
      ...
      if ((Ht.position !== void 0 || Ht.normal !== void 0 || Ht.color !== void 0) && we.update(U, O, qt), (Nt || Se.receiveShadow !== U.receiveShadow) && (Se.receiveShadow = U.receiveShadow, st.setValue(w, "receiveShadow", U.receiveShadow)), B.isMeshGouraudMaterial && B.envMap !== null && (kt.envMap.value = pe, kt.flipEnvMap.value = pe.isCubeTexture && pe.isRenderTargetTexture === false ? -1 : 1), B.isMeshStandardMaterial && B.envMap === null && I.environment !== null && (kt.envMapIntensity.value = I.environmentIntensity), Nt && (st.setValue(w, "toneMappingExposure", y.toneMappingExposure), Se.needsLights && $c(kt, Xi), J && B.fog === true && ae.refreshFogUniforms(kt, J), ae.refreshMaterialUniforms(kt, B, H, Z, f.state.transmissionRenderTarget[v.id]), lr.upload(w, bo(Se), kt, E)), B.isShaderMaterial && B.uniformsNeedUpdate === true && (lr.upload(w, bo(Se), kt, E), B.uniformsNeedUpdate = false), B.isSpriteMaterial && st.setValue(w, "center", U.center), st.setValue(w, "modelViewMatrix", U.modelViewMatrix), st.setValue(w, "normalMatrix", U.normalMatrix), st.setValue(w, "modelMatrix", U.matrixWorld), B.isShaderMaterial || B.isRawShaderMaterial) {
        const At = B.uniformsGroups;
        for (let Dt = 0, Mr = At.length; Dt < Mr; Dt++) {
          const Hn = At[Dt];
          D.update(Hn, qt), D.bind(Hn, qt);
        }
      }
      return qt;
    }
    ...
    this.setRenderTarget = function(v, I = 0, O = 0) {
      ...
      if (v) {
        ...
        if (pe.__useDefaultFramebuffer !== void 0) ve.bindFramebuffer(w.FRAMEBUFFER, null), B = false;
          ...
          if (pe.__boundDepthTexture !== Me) {
            if (Me !== null && _e.has(Me) && (v.width !== Me.image.width || v.height !== Me.image.height)) throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");
      ...
      } else P.copy(xe).multiplyScalar(H).floor(), G.copy(Fe).multiplyScalar(H).floor(), z = tt;
      if (O !== 0 && (U = Zc), ve.bindFramebuffer(w.FRAMEBUFFER, U) && B && ve.drawBuffers(v, U), ve.viewport(P), ve.scissor(G), ve.setScissorTest(z), J) {
      ...
      if (v.isWebGLCubeRenderTarget && ie !== void 0 && (ce = ce[ie]), ce) {
        ...
        if (I >= 0 && I <= v.width - B && O >= 0 && O <= v.height - U) {
          ...
          w.bindBuffer(w.PIXEL_PACK_BUFFER, Me), w.bufferData(w.PIXEL_PACK_BUFFER, J.byteLength, w.STREAM_READ), w.readPixels(I, O, B, U, Ie.convert(Re), Ie.convert(Ce), 0);
          ...
          return w.flush(), await au(w, je, 4), w.bindBuffer(w.PIXEL_PACK_BUFFER, Me), w.getBufferSubData(w.PIXEL_PACK_BUFFER, 0, J), w.deleteBuffer(Me), w.deleteSync(je), J;
    ...
    const Jc = w.createFramebuffer(), Qc = w.createFramebuffer();
    this.copyTextureToTexture = function(v, I, O = null, B = null, U = 0, J = null) {
      ...
      let ie, ce, pe, Re, Ce, Me, We, je, ht;
      const lt = v.isCompressedTexture ? v.mipmaps[J] : v.image;
      if (O !== null) ie = O.max.x - O.min.x, ce = O.max.y - O.min.y, pe = O.isBox3 ? O.max.z - O.min.z : 1, Re = O.min.x, Ce = O.min.y, Me = O.isBox3 ? O.min.z : 0;
      else {
        const Ht = Math.pow(2, -U);
        ie = Math.floor(lt.width * Ht), ce = Math.floor(lt.height * Ht), v.isDataArrayTexture ? pe = lt.depth : v.isData3DTexture ? pe = Math.floor(lt.depth * Ht) : pe = 1, Re = 0, Ce = 0, Me = 0;
      }
      B !== null ? (We = B.x, je = B.y, ht = B.z) : (We = 0, je = 0, ht = 0);
      const Xe = Ie.convert(I.format), Se = Ie.convert(I.type);
      let _t;
      I.isData3DTexture ? (E.setTexture3D(I, 0), _t = w.TEXTURE_3D) : I.isDataArrayTexture || I.isCompressedArrayTexture ? (E.setTexture2DArray(I, 0), _t = w.TEXTURE_2D_ARRAY) : (E.setTexture2D(I, 0), _t = w.TEXTURE_2D), w.pixelStorei(w.UNPACK_FLIP_Y_WEBGL, I.flipY), w.pixelStorei(w.UNPACK_PREMULTIPLY_ALPHA_WEBGL, I.premultiplyAlpha), w.pixelStorei(w.UNPACK_ALIGNMENT, I.unpackAlignment);
      const $e = w.getParameter(w.UNPACK_ROW_LENGTH), qt = w.getParameter(w.UNPACK_IMAGE_HEIGHT), ii = w.getParameter(w.UNPACK_SKIP_PIXELS), Nt = w.getParameter(w.UNPACK_SKIP_ROWS), Xi = w.getParameter(w.UNPACK_SKIP_IMAGES);
      w.pixelStorei(w.UNPACK_ROW_LENGTH, lt.width), w.pixelStorei(w.UNPACK_IMAGE_HEIGHT, lt.height), w.pixelStorei(w.UNPACK_SKIP_PIXELS, Re), w.pixelStorei(w.UNPACK_SKIP_ROWS, Ce), w.pixelStorei(w.UNPACK_SKIP_IMAGES, Me);
      const st = v.isDataArrayTexture || v.isData3DTexture, kt = I.isDataArrayTexture || I.isData3DTexture;
      if (v.isDepthTexture) {
        const Ht = _e.get(v), At = _e.get(I), Dt = _e.get(Ht.__renderTarget), Mr = _e.get(At.__renderTarget);
        ve.bindFramebuffer(w.READ_FRAMEBUFFER, Dt.__webglFramebuffer), ve.bindFramebuffer(w.DRAW_FRAMEBUFFER, Mr.__webglFramebuffer);
        for (let Hn = 0; Hn < pe; Hn++) st && (w.framebufferTextureLayer(w.READ_FRAMEBUFFER, w.COLOR_ATTACHMENT0, _e.get(v).__webglTexture, U, Me + Hn), w.framebufferTextureLayer(w.DRAW_FRAMEBUFFER, w.COLOR_ATTACHMENT0, _e.get(I).__webglTexture, J, ht + Hn)), w.blitFramebuffer(Re, Ce, ie, ce, We, je, ie, ce, w.DEPTH_BUFFER_BIT, w.NEAREST);
        ...
        ve.bindFramebuffer(w.READ_FRAMEBUFFER, Jc), ve.bindFramebuffer(w.DRAW_FRAMEBUFFER, Qc);
        for (let Dt = 0; Dt < pe; Dt++) st ? w.framebufferTextureLayer(w.READ_FRAMEBUFFER, w.COLOR_ATTACHMENT0, Ht.__webglTexture, U, Me + Dt) : w.framebufferTexture2D(w.READ_FRAMEBUFFER, w.COLOR_ATTACHMENT0, w.TEXTURE_2D, Ht.__webglTexture, U), kt ? w.framebufferTextureLayer(w.DRAW_FRAMEBUFFER, w.COLOR_ATTACHMENT0, At.__webglTexture, J, ht + Dt) : w.framebufferTexture2D(w.DRAW_FRAMEBUFFER, w.COLOR_ATTACHMENT0, w.TEXTURE_2D, At.__webglTexture, J), U !== 0 ? w.blitFramebuffer(Re, Ce, ie, ce, We, je, ie, ce, w.COLOR_BUFFER_BIT, w.NEAREST) : kt ? w.copyTexSubImage3D(_t, J, We, je, ht + Dt, Re, Ce, ie, ce) : w.copyTexSubImage2D(_t, J, We, je, Re, Ce, ie, ce);
        ve.bindFramebuffer(w.READ_FRAMEBUFFER, null), ve.bindFramebuffer(w.DRAW_FRAMEBUFFER, null);
      } else kt ? v.isDataTexture || v.isData3DTexture ? w.texSubImage3D(_t, J, We, je, ht, ie, ce, pe, Xe, Se, lt.data) : I.isCompressedArrayTexture ? w.compressedTexSubImage3D(_t, J, We, je, ht, ie, ce, pe, Xe, lt.data) : w.texSubImage3D(_t, J, We, je, ht, ie, ce, pe, Xe, Se, lt) : v.isDataTexture ? w.texSubImage2D(w.TEXTURE_2D, J, We, je, ie, ce, Xe, Se, lt.data) : v.isCompressedTexture ? w.compressedTexSubImage2D(w.TEXTURE_2D, J, We, je, lt.width, lt.height, Xe, lt.data) : w.texSubImage2D(w.TEXTURE_2D, J, We, je, ie, ce, Xe, Se, lt);
      w.pixelStorei(w.UNPACK_ROW_LENGTH, $e), w.pixelStorei(w.UNPACK_IMAGE_HEIGHT, qt), w.pixelStorei(w.UNPACK_SKIP_PIXELS, ii), w.pixelStorei(w.UNPACK_SKIP_ROWS, Nt), w.pixelStorei(w.UNPACK_SKIP_IMAGES, Xi), J === 0 && I.generateMipmaps && w.generateMipmap(_t), ve.unbindTexture();
...
var cs = function() {
  ...
  var i = (performance || Date).now(), r = i, a = 0, o = t(new cs.Panel("FPS", "#0ff", "#002")), l = t(new cs.Panel("MS", "#0f0", "#020"));
  if (self.performance && self.performance.memory) var c = t(new cs.Panel("MB", "#f08", "#201"));
...
cs.Panel = function(s, e, t) {
  ...
  return m.font = "bold " + 9 * a + "px Helvetica,Arial,sans-serif", m.textBaseline = "top", m.fillStyle = t, m.fillRect(0, 0, o, l), m.fillStyle = e, m.fillText(s, c, h), m.fillRect(u, d, p, g), m.fillStyle = t, m.globalAlpha = 0.9, m.fillRect(u, d, p, g), { dom: _, update: function(f, T) {
    n = Math.min(n, f), i = Math.max(i, f), m.fillStyle = t, m.globalAlpha = 1, m.fillRect(0, 0, o, d), m.fillStyle = e, m.fillText(r(f) + " " + s + " (" + r(n) + "-" + r(i) + ")", c, h), m.drawImage(_, u + a, d, p - a, g, u, d, p - a, g), m.fillRect(u + p - a, d, a, g), m.fillStyle = t, m.globalAlpha = 0.9, m.fillRect(u + p - a, d, a, r((1 - f / T) * g));
  } };
};
/**
* lil-gui
...
const l_ = { isPrimitive: true, match: (s) => typeof s == "string", fromHexString: ja, toHexString: ja }, gs = { isPrimitive: true, match: (s) => typeof s == "number", fromHexString: (s) => parseInt(s.substring(1), 16), toHexString: (s) => "#" + s.toString(16).padStart(6, 0) }, c_ = { isPrimitive: false, match: Array.isArray, fromHexString(s, e, t = 1) {
  const n = gs.fromHexString(s);
  e[0] = (n >> 16 & 255) / 255 * t, e[1] = (n >> 8 & 255) / 255 * t, e[2] = (255 & n) / 255 * t;
}, toHexString: ([s, e, t], n = 1) => gs.toHexString(s * (n = 255 / n) << 16 ^ e * n << 8 ^ t * n << 0) }, h_ = { isPrimitive: false, match: (s) => Object(s) === s, fromHexString(s, e, t = 1) {
  const n = gs.fromHexString(s);
  e.r = (n >> 16 & 255) / 255 * t, e.g = (n >> 8 & 255) / 255 * t, e.b = (255 & n) / 255 * t;
}, toHexString: ({ r: s, g: e, b: t }, n = 1) => gs.toHexString(s * (n = 255 / n) << 16 ^ e * n << 8 ^ t * n << 0) }, u_ = [l_, gs, c_, h_];
class d_ extends rn {
  constructor(e, t, n, i) {
    var r;
...
class f_ extends rn {
  ...
  _initSlider() {
    ...
    const e = (d) => {
      ...
      let g = (_ = d, m = p.left, f = p.right, T = this._min, b = this._max, (_ - m) / (f - m) * (b - T) + T);
      var _, m, f, T, b;
...
class _o {
  constructor({ parent: e, autoPlace: t = e === void 0, container: n, width: i, title: r = "Controls", injectStyles: a = true, touchStyles: o = true } = {}) {
    ...
    this.domElement.classList.add("root"), !Yl && a && (function(l) {
  ...
  addColor(e, t, n = 1) {
    return new d_(this, e, t, n);
  }
  addFolder(e) {
    return new _o({ parent: this, title: e });
  }
  load(e, t = true) {
    return e.controllers && this.controllers.forEach((n) => {
      n instanceof ta || n._name in e.controllers && n.load(e.controllers[n._name]);
...
class g_ {
  constructor() {
    ...
    this.scene = new Ac(), this.scene.background = new Ee(15790320);
    const e = window.innerWidth / window.innerHeight;
    this.camera = new Ss(-this.viewportSize * e / 2, this.viewportSize * e / 2, this.viewportSize / 2, -this.viewportSize / 2, 0.1, 1e3), this.camera.position.set(10, 10, 10), this.camera.lookAt(0, 0, 0), this.renderer = new Wc({ antialias: true, preserveDrawingBuffer: true }), this.renderer.setSize(window.innerWidth, window.innerHeight), this.renderer.setPixelRatio(window.devicePixelRatio), this.renderer.shadowMap.enabled = true, this.setupLights(), window.addEventListener("resize", this.onWindowResize.bind(this));
  }
  setupLights() {
    const e = new Oc(16777215, 0.3);
    this.scene.add(e);
    const t = new pr(16777215, 0.7);
  ...
  setViewportSize(e) {
    ...
    this.camera.left = -this.viewportSize * t / 2, this.camera.right = this.viewportSize * t / 2, this.camera.top = this.viewportSize / 2, this.camera.bottom = -this.viewportSize / 2, this.camera.updateProjectionMatrix();
  }
  getScene() {
    return this.scene;
  }
...
class x_ extends Ed {
  ...
  reset() {
    this.target.copy(this.target0), this.object.position.copy(this.position0), this.object.zoom = this.zoom0, this.object.updateProjectionMatrix(), this.dispatchEvent(ql), this.update(), this.state = et.NONE;
  }
  update(e = null) {
    ...
    if (dt.setFromSpherical(this._spherical), dt.applyQuaternion(this._quatInverse), t.copy(this.target).add(dt), this.object.lookAt(this.target), this.enableDamping === true ? (this._sphericalDelta.theta *= 1 - this.dampingFactor, this._sphericalDelta.phi *= 1 - this.dampingFactor, this._panOffset.multiplyScalar(1 - this.dampingFactor)) : (this._sphericalDelta.set(0, 0, 0), this._panOffset.set(0, 0, 0)), this.zoomToCursor && this._performCursorZoom) {
      ...
      a !== null && (this.screenSpacePanning ? this.target.set(0, 0, -1).transformDirection(this.object.matrix).multiplyScalar(a).add(this.object.position) : (tr.origin.copy(this.object.position), tr.direction.set(0, 0, -1).transformDirection(this.object.matrix), Math.abs(this.object.up.dot(tr.direction)) < __ ? this.object.lookAt(this.target) : (jl.setFromNormalAndCoplanarPoint(this.object.up, this.target), tr.intersectPlane(jl, this.target))));
    } else if (this.object.isOrthographicCamera) {
...
function y_(s) {
  switch (this._removePointer(s), this._pointers.length) {
    case 0:
      this.domElement.releasePointerCapture(s.pointerId), this.domElement.removeEventListener("pointermove", this._onPointerMove), this.domElement.removeEventListener("pointerup", this._onPointerUp), this.dispatchEvent(Xc), this.state = et.NONE;
      break;
    case 1:
...
function S_(s) {
  ...
  this.state !== et.NONE && this.dispatchEvent(xo);
}
function E_(s) {
  switch (this.state) {
    case et.ROTATE:
...
function b_(s) {
  this.enabled === false || this.enableZoom === false || this.state !== et.NONE || (s.preventDefault(), this.dispatchEvent(xo), this._handleMouseWheel(this._customWheelEvent(s)), this.dispatchEvent(Xc));
}
function T_(s) {
...
class L_ {
  constructor(e, t) {
    ...
    this.controls = new x_(e, t), this.controls.enableDamping = true, this.controls.dampingFactor = 0.25;
  }
  getControls() {
...
function $l(s, e) {
  ...
  if (e === Ga || e === fc) {
    ...
    const n = t.count - 2, i = [];
    if (e === Ga) for (let a = 1; a <= n; a++) i.push(t.getX(0)), i.push(t.getX(a)), i.push(t.getX(a + 1));
...
class D_ extends Gi {
  ...
  load(e, t, n, i) {
    ...
    if (this.resourcePath !== "") a = this.resourcePath;
      ...
      const c = ls.extractUrlBase(e);
      a = ls.resolveURL(c, this.path);
  ...
  parse(e, t, n, i) {
    ...
    else if (e instanceof ArrayBuffer) if (l.decode(new Uint8Array(e, 0, 4)) === Yc) {
      try {
        a[Oe.KHR_BINARY_GLTF] = new J_(e);
      } catch (u) {
        i && i(u);
        return;
      }
    ...
    const c = new ux(r, { path: t || this.resourcePath || "", crossOrigin: this.crossOrigin, requestHeader: this.requestHeader, manager: this.manager, ktx2Loader: this.ktx2Loader, meshoptDecoder: this.meshoptDecoder });
...
class U_ {
  ...
  _loadLight(e) {
    ...
    return c.position.set(0, 0, 0), vn(c, l), l.intensity !== void 0 && (c.intensity = l.intensity), c.name = t.createUniqueName(l.name || "light_" + e), i = Promise.resolve(c), t.cache.add(n, i), i;
  }
  getDependency(e, t) {
  ...
  extendParams(e, t, n) {
    ...
    if (r) {
      if (Array.isArray(r.baseColorFactor)) {
        ...
        e.color.setRGB(a[0], a[1], a[2], Lt), e.opacity = a[3];
      }
...
class k_ {
  ...
  extendMaterialParams(e, t) {
    ...
    if (a.sheenColorFactor !== void 0) {
      ...
      t.sheenColor.setRGB(o[0], o[1], o[2], Lt);
    }
...
class V_ {
  ...
  extendMaterialParams(e, t) {
    ...
    return t.attenuationColor = new Ee().setRGB(o[0], o[1], o[2], Lt), Promise.all(r);
  }
}
class G_ {
  constructor(e) {
...
class W_ {
  ...
  extendMaterialParams(e, t) {
    ...
    return t.specularColor = new Ee().setRGB(o[0], o[1], o[2], Lt), a.specularColorTexture !== void 0 && r.push(n.assignTexture(t, "specularColorMap", a.specularColorTexture, xt)), Promise.all(r);
  }
}
class X_ {
  constructor(e) {
...
class Z_ {
  ...
  createNodeMesh(e) {
    ...
    return o.length < 1 ? null : (o.push(this.parser.createNodeMesh(e)), Promise.all(o).then((c) => {
      ...
      for (const g of u) {
        const _ = new Pe(), m = new R(), f = new an(), T = new R(1, 1, 1), b = new Bu(g.geometry, g.material, d);
        for (let y = 0; y < d; y++) l.TRANSLATION && m.fromBufferAttribute(l.TRANSLATION, y), l.ROTATION && f.fromBufferAttribute(l.ROTATION, y), l.SCALE && T.fromBufferAttribute(l.SCALE, y), b.setMatrixAt(y, _.compose(m, f, T));
        for (const y in l) if (y === "_COLOR_0") {
          const L = l[y];
          b.instanceColor = new Xa(L.array, L.itemSize, L.normalized);
...
const Yc = "glTF", is = 12, Kl = { JSON: 1313821514, BIN: 5130562 };
class J_ {
  constructor(e) {
    ...
    for (; a < i; ) {
      ...
      if (a += 4, l === Kl.JSON) {
        const c = new Uint8Array(e, is + a, o);
...
class qc extends ys {
  ...
  interpolate_(e, t, n, i) {
    const r = this.resultBuffer, a = this.sampleValues, o = this.valueSize, l = o * 2, c = o * 3, h = i - t, u = (n - t) / h, d = u * u, p = d * u, g = e * c, _ = g - c, m = -2 * p + 3 * d, f = p - d, T = 1 - m, b = f - d + u;
    for (let y = 0; y !== o; y++) {
      const L = a[_ + y + o], C = a[_ + y + l] * h, A = a[g + y + o], N = a[g + y] * h;
      r[y] = T * L + b * C + m * A + f * N;
    }
    return r;
  }
...
class ix extends qc {
  interpolate_(e, t, n, i) {
    ...
    return nx.fromArray(r).normalize().toArray(r), r;
  }
}
const Gt = { POINTS: 0, LINES: 1, LINE_LOOP: 2, LINE_STRIP: 3, TRIANGLES: 4, TRIANGLE_STRIP: 5, TRIANGLE_FAN: 6 }, Ci = { 5120: Int8Array, 5121: Uint8Array, 5122: Int16Array, 5123: Uint16Array, 5125: Uint32Array, 5126: Float32Array }, Zl = { 9728: Ct, 9729: Bt, 9984: ic, 9985: nr, 9986: ss, 9987: Mn }, Jl = { 33071: Un, 33648: cr, 10497: Ii }, ia = { SCALAR: 1, VEC2: 2, VEC3: 3, VEC4: 4, MAT2: 4, MAT3: 9, MAT4: 16 }, $a = { POSITION: "position", NORMAL: "normal", TANGENT: "tangent", TEXCOORD_0: "uv", TEXCOORD_1: "uv1", TEXCOORD_2: "uv2", TEXCOORD_3: "uv3", COLOR_0: "color", WEIGHTS_0: "skinWeight", JOINTS_0: "skinIndex" }, Ln = { scale: "scale", translation: "position", rotation: "quaternion", weights: "morphTargetInfluences" }, sx = { CUBICSPLINE: void 0, LINEAR: ds, STEP: us }, sa = { OPAQUE: "OPAQUE", MASK: "MASK", BLEND: "BLEND" };
function rx(s) {
  return s.DefaultMaterial === void 0 && (s.DefaultMaterial = new uo({ color: 16777215, emissive: 0, metalness: 1, roughness: 1, transparent: false, depthTest: true, side: En })), s.DefaultMaterial;
}
function jn(s, e, t) {
...
function lx(s) {
  ...
  if (t ? e = "draco:" + t.bufferView + ":" + t.indices + ":" + ra(t.attributes) : e = s.indices + ":" + ra(s.attributes) + ":" + s.mode, s.targets !== void 0) for (let n = 0, i = s.targets.length; n < i; n++) e += ":" + ra(s.targets[n]);
  return e;
}
function ra(s) {
  let e = "";
...
class ux {
  constructor(e = {}, t = {}) {
    this.json = e, this.extensions = {}, this.plugins = {}, this.options = t, this.cache = new I_(), this.associations = /* @__PURE__ */ new Map(), this.primitiveCache = {}, this.nodeCache = {}, this.meshCache = { refs: {}, uses: {} }, this.cameraCache = { refs: {}, uses: {} }, this.lightCache = { refs: {}, uses: {} }, this.sourceCache = {}, this.textureCache = {}, this.nodeNamesUsed = {};
    ...
    typeof createImageBitmap > "u" || n && i < 17 || r && a < 98 ? this.textureLoader = new rd(this.options.manager) : this.textureLoader = new ud(this.options.manager), this.textureLoader.setCrossOrigin(this.options.crossOrigin), this.textureLoader.setRequestHeader(this.options.requestHeader), this.fileLoader = new Fc(this.options.manager), this.fileLoader.setResponseType("arraybuffer"), this.options.crossOrigin === "use-credentials" && this.fileLoader.setWithCredentials(true);
  }
  setExtensions(e) {
    this.extensions = e;
  }
  ...
  parse(e, t) {
    ...
    this.cache.removeAll(), this.nodeCache = {}, this._invokeAll(function(a) {
      ...
      return jn(r, o, i), vn(o, i), Promise.all(n._invokeAll(function(l) {
  ...
  loadAccessor(e) {
    ...
    if (i.bufferView === void 0 && i.sparse === void 0) {
      const a = ia[i.type], o = Ci[i.componentType], l = i.normalized === true, c = new o(i.count * a);
    ...
    return i.bufferView !== void 0 ? r.push(this.getDependency("bufferView", i.bufferView)) : r.push(null), i.sparse !== void 0 && (r.push(this.getDependency("bufferView", i.sparse.indices.bufferView)), r.push(this.getDependency("bufferView", i.sparse.values.bufferView))), Promise.all(r).then(function(a) {
      const o = a[0], l = ia[i.type], c = Ci[i.componentType], h = c.BYTES_PER_ELEMENT, u = h * l, d = i.byteOffset || 0, p = i.bufferView !== void 0 ? n.bufferViews[i.bufferView].byteStride : void 0, g = i.normalized === true;
      let _, m;
      if (p && p !== u) {
        const f = Math.floor(d / p), T = "InterleavedBuffer:" + i.bufferView + ":" + i.componentType + ":" + f + ":" + i.count;
        let b = t.cache.get(T);
        b || (_ = new c(o, f * p, i.count * p / h), b = new wc(_, p / h), t.cache.add(T, b)), m = new ps(b, l, d % p / h, g);
      } else o === null ? _ = new c(i.count * l) : _ = new c(o, d, i.count * l), m = new Pt(_, l, g);
      if (i.sparse !== void 0) {
        const f = ia.SCALAR, T = Ci[i.sparse.indices.componentType], b = i.sparse.indices.byteOffset || 0, y = i.sparse.values.byteOffset || 0, L = new T(a[1], b, i.sparse.count * f), C = new c(a[2], y, i.sparse.count * l);
  ...
  loadTextureImage(e, t, n) {
    ...
    const c = this.loadImageSource(t, n).then(function(h) {
      ...
      return h.magFilter = Zl[d.magFilter] || Bt, h.minFilter = Zl[d.minFilter] || Mn, h.wrapS = Jl[d.wrapS] || Ii, h.wrapT = Jl[d.wrapT] || Ii, h.generateMipmaps = !h.isCompressedTexture && h.minFilter !== Ct && h.minFilter !== Bt, i.associations.set(h, { textures: e }), h;
    }).catch(function() {
      return null;
    });
  ...
  loadImageSource(e, t) {
    ...
    const h = Promise.resolve(l).then(function(u) {
      return new Promise(function(d, p) {
        ...
        }), t.load(ls.resolveURL(u, r.path), g, void 0, p);
      });
    }).then(function(u) {
      return c === true && o.revokeObjectURL(l), vn(u, a), u.userData.mimeType = a.mimeType || cx(a.uri), u;
    }).catch(function(u) {
    ...
    return this.getDependency("texture", n.index).then(function(a) {
      ...
      if (n.texCoord !== void 0 && n.texCoord > 0 && (a = a.clone(), a.channel = n.texCoord), r.extensions[Oe.KHR_TEXTURE_TRANSFORM]) {
        ...
        if (o) {
          ...
          a = r.extensions[Oe.KHR_TEXTURE_TRANSFORM].extendTexture(a, o), r.associations.set(a, l);
        }
      }
  ...
  assignFinalMaterial(e) {
    ...
    if (e.isPoints) {
      ...
      l || (l = new Dc(), en.prototype.copy.call(l, n), l.color.copy(n.color), l.map = n.map, l.sizeAttenuation = false, this.cache.add(o, l)), n = l;
    } else if (e.isLine) {
      const o = "LineBasicMaterial:" + n.uuid;
      let l = this.cache.get(o);
      l || (l = new Ms(), en.prototype.copy.call(l, n), l.color.copy(n.color), l.map = n.map, this.cache.add(o, l)), n = l;
    }
    if (i || r || a) {
  ...
  loadMaterial(e) {
    ...
    if (l[Oe.KHR_MATERIALS_UNLIT]) {
      ...
      if (o.color = new Ee(1, 1, 1), o.opacity = 1, Array.isArray(u.baseColorFactor)) {
        ...
        o.color.setRGB(d[0], d[1], d[2], Lt), o.opacity = d[3];
      }
    ...
    r.doubleSided === true && (o.side = sn);
    const h = r.alphaMode || sa.OPAQUE;
    if (h === sa.BLEND ? (o.transparent = true, o.depthWrite = false) : (o.transparent = false, h === sa.MASK && (o.alphaTest = r.alphaCutoff !== void 0 ? r.alphaCutoff : 0.5)), r.normalTexture !== void 0 && a !== Nn && (c.push(t.assignTexture(o, "normalMap", r.normalTexture)), o.normalScale = new ye(1, 1), r.normalTexture.scale !== void 0)) {
      const u = r.normalTexture.scale;
      o.normalScale.set(u, u);
    }
    if (r.occlusionTexture !== void 0 && a !== Nn && (c.push(t.assignTexture(o, "aoMap", r.occlusionTexture)), r.occlusionTexture.strength !== void 0 && (o.aoMapIntensity = r.occlusionTexture.strength)), r.emissiveFactor !== void 0 && a !== Nn) {
      const u = r.emissiveFactor;
      o.emissive = new Ee().setRGB(u[0], u[1], u[2], Lt);
    }
    return r.emissiveTexture !== void 0 && a !== Nn && c.push(t.assignTexture(o, "emissiveMap", r.emissiveTexture, xt)), Promise.all(c).then(function() {
      const u = new a(o);
      return r.name && (u.name = r.name), vn(u, r), t.associations.set(u, { materials: e }), r.extensions && jn(i, u, r), u;
    });
  }
  createUniqueName(e) {
  ...
  loadGeometries(e) {
    ...
    const a = [];
    for (let o = 0, l = e.length; o < l; o++) {
      const c = e[o], h = lx(c), u = i[h];
      if (u) a.push(u.promise);
      else {
        let d;
        c.extensions && c.extensions[Oe.KHR_DRACO_MESH_COMPRESSION] ? d = r(c) : d = Ql(new vt(), c, t), i[h] = { primitive: c, promise: d }, a.push(d);
      }
    }
  ...
  loadMesh(e) {
    ...
    for (let l = 0, c = a.length; l < c; l++) {
      const h = a[l].material === void 0 ? rx(this.cache) : this.getDependency("material", a[l].material);
      o.push(h);
    }
    return o.push(t.loadGeometries(a)), Promise.all(o).then(function(l) {
      ...
      for (let p = 0, g = h.length; p < g; p++) {
        ...
        let f;
        const T = c[p];
        if (m.mode === Gt.TRIANGLES || m.mode === Gt.TRIANGLE_STRIP || m.mode === Gt.TRIANGLE_FAN || m.mode === void 0) f = r.isSkinnedMesh === true ? new Nu(_, T) : new bt(_, T), f.isSkinnedMesh === true && f.normalizeSkinWeights(), m.mode === Gt.TRIANGLE_STRIP ? f.geometry = $l(f.geometry, fc) : m.mode === Gt.TRIANGLE_FAN && (f.geometry = $l(f.geometry, Ga));
        else if (m.mode === Gt.LINES) f = new co(_, T);
        else if (m.mode === Gt.LINE_STRIP) f = new ms(_, T);
        else if (m.mode === Gt.LINE_LOOP) f = new Hu(_, T);
        else if (m.mode === Gt.POINTS) f = new Vu(_, T);
        else throw new Error("THREE.GLTFLoader: Primitive mode unsupported: " + m.mode);
        Object.keys(f.geometry.morphAttributes).length > 0 && ox(f, r), f.name = t.createUniqueName(r.name || "mesh_" + e), vn(f, r), m.extensions && jn(i, f, m), t.assignFinalMaterial(f), u.push(f);
      }
  ...
  loadCamera(e) {
    ...
    return n.type === "perspective" ? t = new Et(gc.radToDeg(i.yfov), i.aspectRatio || 1, i.znear || 1, i.zfar || 2e6) : n.type === "orthographic" && (t = new Ss(-i.xmag, i.xmag, i.ymag, -i.ymag, i.znear, i.zfar)), n.name && (t.name = this.createUniqueName(n.name)), vn(t, n), Promise.resolve(t);
  }
  loadSkin(e) {
  ...
  loadAnimation(e) {
    ...
    for (let u = 0, d = i.channels.length; u < d; u++) {
      const p = i.channels[u], g = i.samplers[p.sampler], _ = p.target, m = _.node, f = i.parameters !== void 0 ? i.parameters[g.input] : g.input, T = i.parameters !== void 0 ? i.parameters[g.output] : g.output;
    ...
    return Promise.all([Promise.all(a), Promise.all(o), Promise.all(l), Promise.all(c), Promise.all(h)]).then(function(u) {
      ...
      for (let T = 0, b = d.length; T < b; T++) {
        const y = d[T], L = p[T], C = g[T], A = _[T], N = m[T];
        if (y === void 0) continue;
        y.updateMatrix && y.updateMatrix();
        const S = n._createAnimationTracks(y, L, C, A, N);
        if (S) for (let M = 0; M < S.length; M++) f.push(S[M]);
      }
      return new Ju(r, void 0, f);
    });
  }
  createNodeMesh(e) {
  ...
  _loadNodeShallow(e) {
    ...
    return l && o.push(l), r.camera !== void 0 && o.push(i.getDependency("camera", r.camera).then(function(c) {
      ...
      let h;
      if (r.isBone === true ? h = new Pc() : c.length > 1 ? h = new Qn() : c.length === 1 ? h = c[0] : h = new rt(), h !== c[0]) for (let u = 0, d = c.length; u < d; u++) h.add(c[u]);
      if (r.name && (h.userData.name = r.name, h.name = a), vn(h, r), r.extensions && jn(n, h, r), r.matrix !== void 0) {
        const u = new Pe();
  ...
  loadScene(e) {
    ...
    n.name && (r.name = i.createUniqueName(n.name)), vn(r, n), n.extensions && jn(t, r, n);
    const a = n.nodes || [], o = [];
  ...
  _createAnimationTracks(e, t, n, i, r) {
    ...
    const h = i.interpolation !== void 0 ? sx[i.interpolation] : ds, u = this._getArrayFromAccessor(n);
  ...
  _createCubicSplineTrackInterpolant(e) {
    e.createInterpolant = function(n) {
      const i = this instanceof zi ? ix : qc;
...
function Ql(s, e, t) {
  ...
  return Ve.workingColorSpace !== Lt && "COLOR_0" in n && console.warn(`THREE.GLTFLoader: Converting vertex colors from "srgb-linear" to "${Ve.workingColorSpace}" not supported.`), vn(s, e), dx(s, e, t), Promise.all(i).then(function() {
    return e.targets !== void 0 ? ax(s, e.targets, t) : s;
  });
}
class fx {
...
class gx {
  constructor(e) {
    ...
    this.mainCamera = e, this.scene = new Ac(), this.scene.background = new Ee(2236962), this.camera = new Et(50, 1, 0.1, 100), this.camera.position.set(0, 0, this.cameraDistance), this.camera.lookAt(0, 0, 0), this.renderer = new Wc({ antialias: true, alpha: true }), this.renderer.setSize(100, 100), this.renderer.setPixelRatio(window.devicePixelRatio);
  ...
  createAxes() {
    this.axesHelper = new Bc(1), this.scene.add(this.axesHelper), this.createAxisLabel("X", new R(1 + 0.2, 0, 0), "#ff0000"), this.createAxisLabel("Y", new R(0, 1 + 0.2, 0), "#00ff00"), this.createAxisLabel("Z", new R(0, 0, 1 + 0.2), "#0000ff");
    const t = new ho(0.05, 16, 16), n = new Nn({ color: 16777215 }), i = new bt(t, n);
    this.scene.add(i);
    const r = new pr(16777215, 1);
    r.position.set(1, 1, 1), this.scene.add(r);
    const a = new Oc(16777215, 0.5);
    this.scene.add(a);
  }
  createAxisLabel(e, t, n) {
    ...
    const a = new Gu(i), o = new Rc({ map: a, transparent: true }), l = new Iu(o);
    l.position.copy(t), l.scale.set(0.5, 0.5, 0.5), this.scene.add(l), this.axesLabels.push(l);
  }
  update() {
    if (this.mainCamera instanceof Ss || this.mainCamera instanceof Et) {
      const e = new R();
...
class xx {
  ...
  createGrid() {
    this.gridHelper = new Sd(this.gridSize, this.gridDivisions, 8947848, 13421772), this.gridHelper.position.y = -0.01, this.scene.add(this.gridHelper);
    const e = new Ms({ color: 4473924, linewidth: 2 }), t = new vt().setFromPoints([new R(-this.gridSize / 2, 0, 0), new R(this.gridSize / 2, 0, 0)]), n = new ms(t, e);
    this.scene.add(n);
    const i = new vt().setFromPoints([new R(0, 0, -this.gridSize / 2), new R(0, 0, this.gridSize / 2)]), r = new ms(i, e);
    this.scene.add(r);
  }
  createAxes() {
    this.axesHelper = new Bc(this.gridSize / 10), this.scene.add(this.axesHelper), this.addAxisLabels();
  }
  addAxisLabels() {
  }
  setVisible(e) {
...
class vx {
  constructor() {
    ...
    this.container = document.createElement("div"), this.container.style.position = "absolute", this.container.style.bottom = "20px", this.container.style.left = "20px", this.container.style.backgroundColor = "rgba(0, 0, 0, 0.7)", this.container.style.color = "white", this.container.style.padding = "10px", this.container.style.borderRadius = "5px", this.container.style.fontFamily = "Arial, sans-serif", this.container.style.fontSize = "12px", this.container.style.width = "250px", this.container.style.boxShadow = "0 0 10px rgba(0, 0, 0, 0.5)", document.body.appendChild(this.container), this.addInfoItem("fileName", "\uD30C\uC77C\uBA85: "), this.addInfoItem("vertices", "\uC815\uC810 \uC218: "), this.addInfoItem("triangles", "\uC0BC\uAC01\uD615 \uC218: "), this.addInfoItem("materials", "\uC7AC\uC9C8 \uC218: "), this.addInfoItem("dimensions", "\uCE58\uC218: "), this.container.style.display = "none";
  }
  addInfoItem(e, t) {
  ...
  updateModelInfo(e, t) {
    ...
    e.traverse((c) => {
      if (c instanceof bt) {
        ...
        Array.isArray(c.material) ? c.material.forEach((u) => a.add(u)) : c.material && a.add(c.material);
      }
    }), r = a.size;
    const o = new tn().setFromObject(e), l = new R();
    o.getSize(l), this.infoItems.fileName.textContent = t, this.infoItems.vertices.textContent = n.toLocaleString(), this.infoItems.triangles.textContent = i.toLocaleString(), this.infoItems.materials.textContent = r.toString(), this.infoItems.dimensions.textContent = `X: ${l.x.toFixed(2)}, Y: ${l.y.toFixed(2)}, Z: ${l.z.toFixed(2)}`, this.container.style.display = "block";
  }
  hide() {
...
class Mx {
  constructor() {
    ...
    this.sceneManager = new g_(), document.body.appendChild(this.sceneManager.getDomElement()), this.controlsManager = new L_(this.sceneManager.getCamera(), this.sceneManager.getDomElement()), this.loadingIndicator = new px(), this.messageHandler = new mx(this.loadModel.bind(this), this.unloadModel.bind(this)), this.viewCube = new gx(this.sceneManager.getCamera()), this.standardViewButtons = new _x(this.sceneManager.getCamera()), this.gridAndAxes = new xx(this.sceneManager.getScene()), this.modelInfoPanel = new vx(), this.stats = new cs(), document.body.appendChild(this.stats.dom), this.gui = new _o(), this.setupGUI(), this.animate();
  }
  setupGUI() {
  ...
  loadModel(e, t) {
    ...
    this.loadingIndicator.show(), this.unloadModel(t);
    const n = { onLoad: (i) => {
      i.name = "currentModel", i.userData.type = "mainModel", this.models.set(t, i.uuid), this.sceneManager.getScene().add(i);
      const r = new tn().setFromObject(i), a = r.getCenter(new R()), o = r.getSize(new R());
      i.position.sub(a);
      const l = Math.max(o.x, o.y, o.z);
      this.sceneManager.setViewportSize(l * 2.5), this.controlsManager.setTarget(0, 0, 0);
      const c = e.split("/").pop() || "Unknown";
      this.modelInfoPanel.updateModelInfo(i, c), this.loadingIndicator.hide(), this.messageHandler.sendModelLoadedMessage(true);
    }, onProgress: (i) => {
      this.loadingIndicator.updateProgress(i);
    }, onError: (i) => {
      console.error("\uBAA8\uB378 \uB85C\uB4DC \uC911 \uC624\uB958 \uBC1C\uC0DD:", i), this.loadingIndicator.showError("\uBAA8\uB378 \uB85C\uB4DC \uC2E4\uD328"), this.messageHandler.sendModelLoadedMessage(false, i instanceof Error ? i.message : String(i));
    } };
    fx.loadModel(e, n);
  }
  unloadModel(e) {
    ...
    if (t) {
      ...
      n && (n.traverse((i) => {
        i instanceof bt && (i.geometry && i.geometry.dispose(), Array.isArray(i.material) ? i.material.forEach((r) => r.dispose()) : i.material && i.material.dispose());
      }), this.sceneManager.getScene().remove(n)), this.models.delete(e), this.messageHandler.sendModelUnloadedMessage();
    }
  }
  animate() {
    requestAnimationFrame(this.animate.bind(this)), this.controlsManager.update(), this.viewCube.update(), this.sceneManager.render(), this.stats.update();
  }
}
