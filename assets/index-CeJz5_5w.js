...
*/
const oa = "174", Ci = { ROTATE: 0, DOLLY: 1, PAN: 2 }, wi = { ROTATE: 0, PAN: 1, DOLLY_PAN: 2, DOLLY_ROTATE: 3 }, lh = 0, Oa = 1, ch = 2, fc = 1, hh = 2, Sn = 3, wn = 0, Nt = 1, ln = 2, kn = 0, Pi = 1, Ba = 2, za = 3, ka = 4, uh = 5, ei = 100, dh = 101, fh = 102, ph = 103, mh = 104, gh = 200, _h = 201, xh = 202, vh = 203, po = 204, mo = 205, Mh = 206, yh = 207, Sh = 208, Eh = 209, bh = 210, Th = 211, Ah = 212, wh = 213, Rh = 214, go = 0, _o = 1, xo = 2, Ui = 3, vo = 4, Mo = 5, yo = 6, So = 7, aa = 0, Ch = 1, Ph = 2, Hn = 0, Lh = 1, Ih = 2, Dh = 3, Uh = 4, Nh = 5, Fh = 6, Oh = 7, Ha = "attached", Bh = "detached", pc = 300, Ni = 301, Fi = 302, Eo = 303, bo = 304, Sr = 306, Oi = 1e3, Bn = 1001, gr = 1002, Lt = 1003, mc = 1004, cs = 1005, zt = 1006, cr = 1007, bn = 1008, Rn = 1009, gc = 1010, _c = 1011, ms = 1012, la = 1013, ii = 1014, tn = 1015, bs = 1016, ca = 1017, ha = 1018, Bi = 1020, xc = 35902, vc = 1021, Mc = 1022, Yt = 1023, yc = 1024, Sc = 1025, Li = 1026, zi = 1027, ua = 1028, da = 1029, Ec = 1030, fa = 1031, pa = 1033, hr = 33776, ur = 33777, dr = 33778, fr = 33779, To = 35840, Ao = 35841, wo = 35842, Ro = 35843, Co = 36196, Po = 37492, Lo = 37496, Io = 37808, Do = 37809, Uo = 37810, No = 37811, Fo = 37812, Oo = 37813, Bo = 37814, zo = 37815, ko = 37816, Ho = 37817, Vo = 37818, Go = 37819, Wo = 37820, Xo = 37821, pr = 36492, Yo = 36494, jo = 36495, bc = 36283, qo = 36284, $o = 36285, Ko = 36286, gs = 2300, _s = 2301, Rr = 2302, Va = 2400, Ga = 2401, Wa = 2402, zh = 2500, kh = 0, Tc = 1, Zo = 2, Hh = 3200, Vh = 3201, ma = 0, Gh = 1, On = "", yt = "srgb", It = "srgb-linear", _r = "linear", Qe = "srgb", li = 7680, Xa = 519, Wh = 512, Xh = 513, Yh = 514, Ac = 515, jh = 516, qh = 517, $h = 518, Kh = 519, Jo = 35044, Ya = "300 es", Tn = 2e3, xr = 2001;
class ri {
...
let ja = 1234567;
const us = Math.PI / 180, ki = 180 / Math.PI;
function nn() {
...
const wc = { DEG2RAD: us, RAD2DEG: ki, generateUUID: nn, clamp: Ne, euclideanModulo: ga, mapLinear: Zh, inverseLerp: Jh, lerp: ds, damp: Qh, pingpong: eu, smoothstep: tu, smootherstep: nu, randInt: iu, randFloat: su, randFloatSpread: ru, seededRandom: ou, degToRad: au, radToDeg: lu, isPowerOfTwo: cu, ceilPowerOfTwo: hu, floorPowerOfTwo: uu, setQuaternionFromProperEuler: du, normalize: Ze, denormalize: en };
class xe {
  constructor(e = 0, t = 0) {
...
function _u() {
  const s = { enabled: true, workingColorSpace: It, spaces: {}, convert: function(i, r, o) {
    ...
    return i === On ? _r : this.spaces[i].transfer;
  ...
  return s.define({ [It]: { primaries: e, whitePoint: n, transfer: _r, toXYZ: $a, fromXYZ: Ka, luminanceCoefficients: t, workingColorSpaceConfig: { unpackColorSpace: yt }, outputColorSpaceConfig: { drawingBufferColorSpace: yt } }, [yt]: { primaries: e, whitePoint: n, transfer: Qe, toXYZ: $a, fromXYZ: Ka, luminanceCoefficients: t, outputColorSpaceConfig: { drawingBufferColorSpace: yt } } }), s;
}
const Ve = _u();
function An(s) {
...
class xu {
  static getDataURL(e) {
    ...
    if (e instanceof HTMLCanvasElement) t = e;
      ...
      ci === void 0 && (ci = xs("canvas")), ci.width = e.width, ci.height = e.height;
...
class _a {
  constructor(e = null) {
    this.isSource = true, Object.defineProperty(this, "id", { value: vu++ }), this.uuid = nn(), this.data = e, this.dataReady = true, this.version = 0;
  }
  set needsUpdate(e) {
    e === true && this.version++;
  }
...
let Mu = 0;
class _t extends ri {
  constructor(e = _t.DEFAULT_IMAGE, t = _t.DEFAULT_MAPPING, n = Bn, i = Bn, r = zt, o = bn, a = Yt, l = Rn, c = _t.DEFAULT_ANISOTROPY, h = On) {
    super(), this.isTexture = true, Object.defineProperty(this, "id", { value: Mu++ }), this.uuid = nn(), this.name = "", this.source = new _a(e), this.mipmaps = [], this.mapping = t, this.channel = 0, this.wrapS = n, this.wrapT = i, this.magFilter = r, this.minFilter = o, this.anisotropy = c, this.format = a, this.internalFormat = null, this.type = l, this.offset = new xe(0, 0), this.repeat = new xe(1, 1), this.center = new xe(0, 0), this.rotation = 0, this.matrixAutoUpdate = true, this.matrix = new Le(), this.generateMipmaps = true, this.premultiplyAlpha = false, this.flipY = true, this.unpackAlignment = 4, this.colorSpace = h, this.userData = {}, this.version = 0, this.onUpdate = null, this.renderTarget = null, this.isRenderTargetTexture = false, this.pmremVersion = 0;
  }
  get image() {
...
class je {
  ...
  setAxisAngleFromRotationMatrix(e) {
    ...
    if (Math.abs(h - d) < 0.01 && Math.abs(u - _) < 0.01 && Math.abs(g - m) < 0.01) {
      ...
      t = Math.PI;
      const b = (c + 1) / 2, M = (p + 1) / 2, L = (f + 1) / 2, w = (h + d) / 4, A = (u + _) / 4, U = (g + m) / 4;
      return b > M && b > L ? b < 0.01 ? (n = 0, i = 0.707106781, r = 0.707106781) : (n = Math.sqrt(b), i = w / n, r = A / n) : M > L ? M < 0.01 ? (n = 0.707106781, i = 0, r = 0.707106781) : (i = Math.sqrt(M), n = w / i, r = U / i) : L < 0.01 ? (n = 0.707106781, i = 0.707106781, r = 0) : (r = Math.sqrt(L), n = A / r, i = U / r), this.set(n, i, r, t), this;
    }
...
class rn {
  ...
  expandByObject(e, t = false) {
    ...
    if (n !== void 0) {
      ...
      if (t === true && r !== void 0 && e.isInstancedMesh !== true) for (let o = 0, a = r.count; o < a; o++) e.isMesh === true ? e.getVertexPosition(o, Zt) : Zt.fromBufferAttribute(r, o), Zt.applyMatrix4(e.matrixWorld), this.expandByPoint(Zt);
  ...
  intersectsTriangle(e) {
    ...
    this.getCenter(Zi), Ds.subVectors(this.max, Zi), hi.subVectors(e.a, Zi), ui.subVectors(e.b, Zi), di.subVectors(e.c, Zi), Cn.subVectors(ui, hi), Pn.subVectors(di, ui), Xn.subVectors(hi, di);
    let t = [0, -Cn.z, Cn.y, 0, -Pn.z, Pn.y, 0, -Xn.z, Xn.y, Cn.z, 0, -Cn.x, Pn.z, 0, -Pn.x, Xn.z, 0, -Xn.x, -Cn.y, Cn.x, 0, -Pn.y, Pn.x, 0, -Xn.y, Xn.x, 0];
    return !Ir(t, hi, ui, di, Ds) || (t = [1, 0, 0, 0, 1, 0, 0, 0, 1], !Ir(t, hi, ui, di, Ds)) ? false : (Us.crossVectors(Cn, Pn), t = [Us.x, Us.y, Us.z], Ir(t, hi, ui, di, Ds));
  }
  clampPoint(e, t) {
...
const gn = [new R(), new R(), new R(), new R(), new R(), new R(), new R(), new R()], Zt = new R(), Is = new rn(), hi = new R(), ui = new R(), di = new R(), Cn = new R(), Pn = new R(), Xn = new R(), Zi = new R(), Ds = new R(), Us = new R(), Yn = new R();
...
const Eu = new rn(), Ji = new R(), Dr = new R();
class dn {
  ...
  union(e) {
    return e.isEmpty() ? this : this.isEmpty() ? (this.copy(e), this) : (this.center.equals(e.center) === true ? this.radius = Math.max(this.radius, e.radius) : (Dr.subVectors(e.center, this.center).setLength(e.radius), this.expandByPoint(Ji.copy(e.center).add(Dr)), this.expandByPoint(Ji.copy(e.center).sub(Dr))), this);
  }
  equals(e) {
...
const _n = new R(), Ur = new R(), Ns = new R(), Ln = new R(), Nr = new R(), Fs = new R(), Fr = new R();
class Yi {
  ...
  distanceSqToSegment(e, t, n, i) {
    Ur.copy(e).add(t).multiplyScalar(0.5), Ns.copy(t).sub(e).normalize(), Ln.copy(this.origin).sub(Ur);
    const r = e.distanceTo(t) * 0.5, o = -this.direction.dot(Ns), a = Ln.dot(this.direction), l = -Ln.dot(Ns), c = Ln.lengthSq(), h = Math.abs(1 - o * o);
    let u, d, p, g;
    ...
    return n && n.copy(this.origin).addScaledVector(this.direction, u), i && i.copy(Ur).addScaledVector(Ns, d), p;
  }
  intersectSphere(e, t) {
  ...
  intersectTriangle(e, t, n, i, r) {
    Nr.subVectors(t, e), Fs.subVectors(n, e), Fr.crossVectors(Nr, Fs);
    ...
    const l = a * this.direction.dot(Fs.crossVectors(Ln, Fs));
    if (l < 0) return null;
...
class Pe {
  ...
  lookAt(e, t, n) {
    ...
    return Ot.subVectors(e, t), Ot.lengthSq() === 0 && (Ot.z = 1), Ot.normalize(), In.crossVectors(n, Ot), In.lengthSq() === 0 && (Math.abs(n.z) === 1 ? Ot.x += 1e-4 : Ot.z += 1e-4, Ot.normalize(), In.crossVectors(n, Ot)), In.normalize(), Os.crossVectors(Ot, In), i[0] = In.x, i[4] = Os.x, i[8] = Ot.x, i[1] = In.y, i[5] = Os.y, i[9] = Ot.y, i[2] = In.z, i[6] = Os.z, i[10] = Ot.z, this;
  }
  multiply(e) {
    return this.multiplyMatrices(this, e);
  }
  ...
  multiplyMatrices(e, t) {
    const n = e.elements, i = t.elements, r = this.elements, o = n[0], a = n[4], l = n[8], c = n[12], h = n[1], u = n[5], d = n[9], p = n[13], g = n[2], _ = n[6], m = n[10], f = n[14], E = n[3], b = n[7], M = n[11], L = n[15], w = i[0], A = i[4], U = i[8], S = i[12], y = i[1], P = i[5], G = i[9], k = i[13], Y = i[2], $ = i[6], V = i[10], K = i[14], z = i[3], se = i[7], he = i[11], Me = i[15];
    return r[0] = o * w + a * y + l * Y + c * z, r[4] = o * A + a * P + l * $ + c * se, r[8] = o * U + a * G + l * V + c * he, r[12] = o * S + a * k + l * K + c * Me, r[1] = h * w + u * y + d * Y + p * z, r[5] = h * A + u * P + d * $ + p * se, r[9] = h * U + u * G + d * V + p * he, r[13] = h * S + u * k + d * K + p * Me, r[2] = g * w + _ * y + m * Y + f * z, r[6] = g * A + _ * P + m * $ + f * se, r[10] = g * U + _ * G + m * V + f * he, r[14] = g * S + _ * k + m * K + f * Me, r[3] = E * w + b * y + M * Y + L * z, r[7] = E * A + b * P + M * $ + L * se, r[11] = E * U + b * G + M * V + L * he, r[15] = E * S + b * k + M * K + L * Me, this;
  }
  multiplyScalar(e) {
    const t = this.elements;
  ...
  decompose(e, t, n) {
    ...
    return Jt.elements[0] *= c, Jt.elements[1] *= c, Jt.elements[2] *= c, Jt.elements[4] *= h, Jt.elements[5] *= h, Jt.elements[6] *= h, Jt.elements[8] *= u, Jt.elements[9] *= u, Jt.elements[10] *= u, t.setFromRotationMatrix(Jt), n.x = r, n.y = o, n.z = a, this;
  }
  makePerspective(e, t, n, i, r, o, a = Tn) {
    ...
    else if (a === xr) p = -o / (o - r), g = -o * r / (o - r);
...
const fi = new R(), Jt = new Pe(), bu = new R(0, 0, 0), Tu = new R(1, 1, 1), In = new R(), Os = new R(), Ot = new R(), Ja = new Pe(), Qa = new un();
class sn {
...
let Au = 0;
const el = new R(), pi = new un(), xn = new Pe(), Bs = new R(), Qi = new R(), wu = new R(), Ru = new un(), tl = new R(1, 0, 0), nl = new R(0, 1, 0), il = new R(0, 0, 1), sl = { type: "added" }, Cu = { type: "removed" }, mi = { type: "childadded", child: null }, Or = { type: "childremoved", child: null };
class rt extends ri {
  constructor() {
    super(), this.isObject3D = true, Object.defineProperty(this, "id", { value: Au++ }), this.uuid = nn(), this.name = "", this.type = "Object3D", this.parent = null, this.children = [], this.up = rt.DEFAULT_UP.clone();
    const e = new R(), t = new sn(), n = new un(), i = new R(1, 1, 1);
    function r() {
  ...
  lookAt(e, t, n) {
    ...
    const i = this.parent;
    this.updateWorldMatrix(true, false), Qi.setFromMatrixPosition(this.matrixWorld), this.isCamera || this.isLight ? xn.lookAt(Qi, Bs, this.up) : xn.lookAt(Bs, Qi, this.up), this.quaternion.setFromRotationMatrix(xn), i && (xn.extractRotation(i.matrixWorld), pi.setFromRotationMatrix(xn), this.quaternion.premultiply(pi.invert()));
  }
  add(e) {
  ...
  remove(e) {
    ...
    return t !== -1 && (e.parent = null, this.children.splice(t, 1), e.dispatchEvent(Cu), Or.child = e, this.dispatchEvent(Or), Or.child = null), this;
  }
  removeFromParent() {
    const e = this.parent;
  ...
  attach(e) {
    return this.updateWorldMatrix(true, false), xn.copy(this.matrixWorld).invert(), e.parent !== null && (e.parent.updateWorldMatrix(true, false), xn.multiply(e.parent.matrixWorld)), e.applyMatrix4(xn), e.removeFromParent(), e.parent = this, this.children.push(e), e.updateWorldMatrix(false, true), e.dispatchEvent(sl), mi.child = e, this.dispatchEvent(mi), mi.child = null, this;
  }
  getObjectById(e) {
  ...
  getWorldQuaternion(e) {
    return this.updateWorldMatrix(true, false), this.matrixWorld.decompose(Qi, e, wu), e;
  }
  getWorldScale(e) {
    return this.updateWorldMatrix(true, false), this.matrixWorld.decompose(Qi, Ru, e), e;
  }
  getWorldDirection(e) {
...
const Qt = new R(), vn = new R(), Br = new R(), Mn = new R(), gi = new R(), _i = new R(), rl = new R(), zr = new R(), kr = new R(), Hr = new R(), Vr = new je(), Gr = new je(), Wr = new je();
class Xt {
  ...
  static getBarycoord(e, t, n, i, r) {
    Qt.subVectors(i, t), vn.subVectors(n, t), Br.subVectors(e, t);
    const o = Qt.dot(Qt), a = Qt.dot(vn), l = Qt.dot(Br), c = vn.dot(vn), h = vn.dot(Br), u = o * c - a * a;
  ...
  static isFrontFacing(e, t, n, i) {
    return Qt.subVectors(n, t), vn.subVectors(e, t), Qt.cross(vn).dot(i) < 0;
  }
  set(e, t, n) {
  ...
  getArea() {
    return Qt.subVectors(this.c, this.b), vn.subVectors(this.a, this.b), Qt.cross(vn).length() * 0.5;
  }
  getMidpoint(e) {
...
class ve {
  ...
  lerpHSL(e, t) {
    ...
    const n = ds(Dn.h, zs.h, t), i = ds(Dn.s, zs.s, t), r = ds(Dn.l, zs.l, t);
...
class qt extends ri {
  constructor() {
    super(), this.isMaterial = true, Object.defineProperty(this, "id", { value: Pu++ }), this.uuid = nn(), this.name = "", this.type = "Material", this.blending = Pi, this.side = wn, this.vertexColors = false, this.opacity = 1, this.transparent = false, this.alphaHash = false, this.blendSrc = po, this.blendDst = mo, this.blendEquation = ei, this.blendSrcAlpha = null, this.blendDstAlpha = null, this.blendEquationAlpha = null, this.blendColor = new ve(0, 0, 0), this.blendAlpha = 0, this.depthFunc = Ui, this.depthTest = true, this.depthWrite = true, this.stencilWriteMask = 255, this.stencilFunc = Xa, this.stencilRef = 0, this.stencilFuncMask = 255, this.stencilFail = li, this.stencilZFail = li, this.stencilZPass = li, this.stencilWrite = false, this.clippingPlanes = null, this.clipIntersection = false, this.clipShadows = false, this.shadowSide = null, this.colorWrite = true, this.precision = null, this.polygonOffset = false, this.polygonOffsetFactor = 0, this.polygonOffsetUnits = 0, this.dithering = false, this.alphaToCoverage = false, this.premultipliedAlpha = false, this.forceSinglePass = false, this.visible = true, this.toneMapped = true, this.userData = {}, this.version = 0, this._alphaTest = 0;
  }
  get alphaTest() {
...
const mt = new R(), ks = new xe();
let Lu = 0;
class ht {
  constructor(e, t, n = false) {
    if (Array.isArray(e)) throw new TypeError("THREE.BufferAttribute: array should be a Typed Array.");
    this.isBufferAttribute = true, Object.defineProperty(this, "id", { value: Lu++ }), this.name = "", this.array = e, this.itemSize = t, this.count = e !== void 0 ? e.length / t : 0, this.normalized = n, this.usage = Jo, this.updateRanges = [], this.gpuType = tn, this.version = 0;
  }
  onUploadCallback() {
  }
  set needsUpdate(e) {
...
let Iu = 0;
const Gt = new Pe(), Yr = new rt(), xi = new R(), Bt = new rn(), es = new rn(), Mt = new R();
class ft extends ri {
  constructor() {
    super(), this.isBufferGeometry = true, Object.defineProperty(this, "id", { value: Iu++ }), this.uuid = nn(), this.name = "", this.type = "BufferGeometry", this.index = null, this.indirect = null, this.attributes = {}, this.morphAttributes = {}, this.morphTargetsRelative = false, this.groups = [], this.boundingBox = null, this.boundingSphere = null, this.drawRange = { start: 0, count: 1 / 0 }, this.userData = {};
  }
  getIndex() {
    return this.index;
  }
  setIndex(e) {
    return Array.isArray(e) ? this.index = new (Rc(e) ? Ic : Lc)(e, 1) : this.index = e, this;
  }
  setIndirect(e) {
  ...
  computeBoundingSphere() {
    ...
    if (e) {
      ...
      if (Bt.setFromBufferAttribute(e), t) for (let r = 0, o = t.length; r < o; r++) {
        const a = t[r];
        es.setFromBufferAttribute(a), this.morphTargetsRelative ? (Mt.addVectors(Bt.min, es.min), Bt.expandByPoint(Mt), Mt.addVectors(Bt.max, es.max), Bt.expandByPoint(Mt)) : (Bt.expandByPoint(es.min), Bt.expandByPoint(es.max));
      }
      Bt.getCenter(n);
      let i = 0;
      ...
      if (t) for (let r = 0, o = t.length; r < o; r++) {
        ...
        for (let c = 0, h = a.count; c < h; c++) Mt.fromBufferAttribute(a, c), l && (xi.fromBufferAttribute(e, c), Mt.add(xi)), i = Math.max(i, n.distanceToSquared(Mt));
      }
  ...
  computeTangents() {
    ...
    this.hasAttribute("tangent") === false && this.setAttribute("tangent", new ht(new Float32Array(4 * n.count), 4));
    ...
    function f(U, S, y) {
      ...
      isFinite(P) && (_.copy(h).multiplyScalar(g.y).addScaledVector(u, -p.y).multiplyScalar(P), m.copy(u).multiplyScalar(p.x).addScaledVector(h, -g.x).multiplyScalar(P), a[U].add(_), a[S].add(_), a[y].add(_), l[U].add(m), l[S].add(m), l[y].add(m));
    }
    let E = this.groups;
    E.length === 0 && (E = [{ start: 0, count: e.count }]);
    for (let U = 0, S = E.length; U < S; ++U) {
      const y = E[U], P = y.start, G = y.count;
      for (let k = P, Y = P + G; k < Y; k += 3) f(e.getX(k + 0), e.getX(k + 1), e.getX(k + 2));
    }
    ...
    function A(U) {
      ...
      o.setXYZW(U, b.x, b.y, b.z, P);
    }
    for (let U = 0, S = E.length; U < S; ++U) {
      const y = E[U], P = y.start, G = y.count;
      for (let k = P, Y = P + G; k < Y; k += 3) A(e.getX(k + 0)), A(e.getX(k + 1)), A(e.getX(k + 2));
    }
  }
...
const ol = new Pe(), jn = new Yi(), Hs = new dn(), al = new R(), Vs = new R(), Gs = new R(), Ws = new R(), jr = new R(), Xs = new R(), ll = new R(), Ys = new R();
class at extends rt {
  ...
  getVertexPosition(e, t) {
    ...
    if (r && a) {
      ...
      for (let l = 0, c = r.length; l < c; l++) {
        const h = a[l], u = r[l];
        h !== 0 && (jr.fromBufferAttribute(u, e), o ? Xs.addScaledVector(jr, h) : Xs.addScaledVector(jr.sub(t), h));
      }
      t.add(Xs);
    }
    return t;
  ...
  raycast(e, t) {
    ...
    i !== void 0 && (n.boundingSphere === null && n.computeBoundingSphere(), Hs.copy(n.boundingSphere), Hs.applyMatrix4(r), jn.copy(e.ray).recast(e.near), !(Hs.containsPoint(jn.origin) === false && (jn.intersectSphere(Hs, al) === null || jn.origin.distanceToSquared(al) > (e.far - e.near) ** 2)) && (ol.copy(r).invert(), jn.copy(e.ray).applyMatrix4(ol), !(n.boundingBox !== null && jn.intersectsBox(n.boundingBox) === false) && this._computeIntersections(e, t, jn)));
  }
  _computeIntersections(e, t, n) {
    ...
    if (a !== null) if (Array.isArray(o)) for (let g = 0, _ = d.length; g < _; g++) {
      ...
      for (let M = E, L = b; M < L; M += 3) {
        const w = a.getX(M), A = a.getX(M + 1), U = a.getX(M + 2);
        i = js(this, f, e, n, c, h, u, w, A, U), i && (i.faceIndex = Math.floor(M / 3), i.face.materialIndex = m.materialIndex, t.push(i));
      }
    }
    else {
      ...
      for (let m = g, f = _; m < f; m += 3) {
        ...
        i = js(this, o, e, n, c, h, u, E, b, M), i && (i.faceIndex = Math.floor(m / 3), t.push(i));
      }
    }
...
function js(s, e, t, n, i, r, o, a, l, c) {
  ...
  const h = Du(s, e, t, n, Vs, Gs, Ws, ll);
  if (h) {
    const u = new R();
    Xt.getBarycoord(ll, Vs, Gs, Ws, u), i && (h.uv = Xt.getInterpolatedAttribute(i, a, l, c, u, new xe())), r && (h.uv1 = Xt.getInterpolatedAttribute(r, a, l, c, u, new xe())), o && (h.normal = Xt.getInterpolatedAttribute(o, a, l, c, u, new R()), h.normal.dot(n.direction) > 0 && h.normal.multiplyScalar(-1));
    const d = { a, b: l, c, normal: new R(), materialIndex: 0 };
    Xt.getNormal(Vs, Gs, Ws, d.normal), h.face = d, h.barycoord = u;
  }
  return h;
}
class Ts extends ft {
  constructor(e = 1, t = 1, n = 1, i = 1, r = 1, o = 1) {
    ...
    function g(_, m, f, E, b, M, L, w, A, U, S) {
      const y = M / A, P = L / U, G = M / 2, k = L / 2, Y = w / 2, $ = A + 1, V = U + 1;
      let K = 0, z = 0;
      const se = new R();
      for (let he = 0; he < V; he++) {
        ...
        for (let Fe = 0; Fe < $; Fe++) {
          const tt = Fe * y - G;
          se[_] = tt * E, se[m] = Me * b, se[f] = Y, c.push(se.x, se.y, se.z), se[_] = 0, se[m] = 0, se[f] = w > 0 ? 1 : -1, h.push(se.x, se.y, se.z), u.push(Fe / A), u.push(1 - he / U), K += 1;
        }
      }
      for (let he = 0; he < U; he++) for (let Me = 0; Me < A; Me++) {
...
class Vn extends qt {
  constructor(e) {
    super(), this.isShaderMaterial = true, this.type = "ShaderMaterial", this.defines = {}, this.uniforms = {}, this.uniformsGroups = [], this.vertexShader = Fu, this.fragmentShader = Ou, this.linewidth = 1, this.wireframe = false, this.wireframeLinewidth = 1, this.fog = false, this.lights = false, this.clipping = false, this.forceSinglePass = true, this.extensions = { clipCullDistance: false, multiDraw: false }, this.defaultAttributeValues = { color: [1, 1, 1], uv: [0, 0], uv1: [0, 0] }, this.index0AttributeName = void 0, this.uniformsNeedUpdate = false, this.glslVersion = null, e !== void 0 && this.setValues(e);
  }
  copy(e) {
...
class wt extends va {
  ...
  getEffectiveFOV() {
    return ki * 2 * Math.atan(Math.tan(us * 0.5 * this.fov) / this.zoom);
  }
  getFilmWidth() {
  ...
  updateProjectionMatrix() {
    const e = this.near;
    let t = e * Math.tan(us * 0.5 * this.fov) / this.zoom, n = 2 * t, i = this.aspect * n, r = -0.5 * i;
    const o = this.view;
...
class Bu extends rt {
  ...
  updateCoordinateSystem() {
    ...
    else if (e === xr) n.up.set(0, -1, 0), n.lookAt(-1, 0, 0), i.up.set(0, -1, 0), i.lookAt(1, 0, 0), r.up.set(0, 0, 1), r.lookAt(0, 1, 0), o.up.set(0, 0, -1), o.lookAt(0, -1, 0), a.up.set(0, -1, 0), a.lookAt(0, 0, 1), l.up.set(0, -1, 0), l.lookAt(0, 0, -1);
...
class zu extends si {
  constructor(e = 1, t = {}) {
    ...
    this.texture = new Uc(i, t.mapping, t.wrapS, t.wrapT, t.magFilter, t.minFilter, t.format, t.type, t.anisotropy, t.colorSpace), this.texture.isRenderTargetTexture = true, this.texture.generateMipmaps = t.generateMipmaps !== void 0 ? t.generateMipmaps : false, this.texture.minFilter = t.minFilter !== void 0 ? t.minFilter : zt;
  }
  fromEquirectangularTexture(e, t) {
    ...
    const n = { uniforms: { tEquirect: { value: null } }, vertexShader: `
			...
			` }, i = new Ts(5, 5, 5), r = new Vn({ name: "CubemapFromEquirect", uniforms: Hi(n.uniforms), vertexShader: n.vertexShader, fragmentShader: n.fragmentShader, side: Nt, blending: kn });
    r.uniforms.tEquirect.value = t;
    const o = new at(i, r), a = t.minFilter;
    return t.minFilter === bn && (t.minFilter = zt), new Bu(1, 10, this).update(e, o), t.minFilter = a, o.geometry.dispose(), o.material.dispose(), this;
  }
  clear(e, t, n, i) {
...
class qr {
  ...
  update(e, t, n) {
    ...
    if (e && t.session.visibilityState !== "visible-blurred") {
      ...
      a !== null && (i = t.getPose(e.targetRaySpace, n), i === null && r !== null && (i = r), i !== null && (a.matrix.fromArray(i.transform.matrix), a.matrix.decompose(a.position, a.rotation, a.scale), a.matrixWorldNeedsUpdate = true, i.linearVelocity ? (a.hasLinearVelocity = true, a.linearVelocity.copy(i.linearVelocity)) : a.hasLinearVelocity = false, i.angularVelocity ? (a.hasAngularVelocity = true, a.angularVelocity.copy(i.angularVelocity)) : a.hasAngularVelocity = false, this.dispatchEvent(ku)));
    }
...
class Fc {
  constructor(e, t) {
    this.isInterleavedBuffer = true, this.array = e, this.stride = t, this.count = e !== void 0 ? e.length / t : 0, this.usage = Jo, this.updateRanges = [], this.version = 0, this.uuid = nn();
  }
  onUploadCallback() {
  }
  set needsUpdate(e) {
...
class vs {
  ...
  clone(e) {
    ...
    } else return e.interleavedBuffers === void 0 && (e.interleavedBuffers = {}), e.interleavedBuffers[this.data.uuid] === void 0 && (e.interleavedBuffers[this.data.uuid] = this.data.clone(e)), new vs(e.interleavedBuffers[this.data.uuid], this.itemSize, this.offset, this.normalized);
  }
  toJSON(e) {
    if (e === void 0) {
...
let yi;
const ts = new R(), Si = new R(), Ei = new R(), bi = new xe(), ns = new xe(), Bc = new Pe(), qs = new R(), is = new R(), $s = new R(), ul = new xe(), $r = new xe(), dl = new xe();
class Hu extends rt {
  constructor(e = new Oc()) {
    if (super(), this.isSprite = true, this.type = "Sprite", yi === void 0) {
      ...
      yi.setIndex([0, 1, 2, 0, 2, 3]), yi.setAttribute("position", new vs(n, 3, 0, false)), yi.setAttribute("uv", new vs(n, 2, 3, false));
    }
    this.geometry = yi, this.material = e, this.center = new xe(0.5, 0.5);
  }
  raycast(e, t) {
    e.camera === null && console.error('THREE.Sprite: "Raycaster.camera" needs to be set in order to raycast against sprites.'), Si.setFromMatrixScale(this.matrixWorld), Bc.copy(e.camera.matrixWorld), this.modelViewMatrix.multiplyMatrices(e.camera.matrixWorldInverse, this.matrixWorld), Ei.setFromMatrixPosition(this.modelViewMatrix), e.camera.isPerspectiveCamera && this.material.sizeAttenuation === false && Si.multiplyScalar(-Ei.z);
    const n = this.material.rotation;
    let i, r;
    n !== 0 && (r = Math.cos(n), i = Math.sin(n));
    const o = this.center;
    Ks(qs.set(-0.5, -0.5, 0), Ei, o, Si, i, r), Ks(is.set(0.5, -0.5, 0), Ei, o, Si, i, r), Ks($s.set(0.5, 0.5, 0), Ei, o, Si, i, r), ul.set(0, 0), $r.set(1, 0), dl.set(1, 1);
    let a = e.ray.intersectTriangle(qs, is, $s, false, ts);
    if (a === null && (Ks(is.set(-0.5, 0.5, 0), Ei, o, Si, i, r), $r.set(0, 1), a = e.ray.intersectTriangle(qs, $s, is, false, ts), a === null)) return;
    const l = e.ray.origin.distanceTo(ts);
    l < e.near || l > e.far || t.push({ distance: l, point: ts.clone(), uv: Xt.getInterpolation(ts, qs, is, $s, ul, $r, dl, new xe()), face: null, object: this });
  }
  copy(e, t) {
...
function Ks(s, e, t, n, i, r) {
  bi.subVectors(s, t).addScalar(0.5).multiply(n), i !== void 0 ? (ns.x = r * bi.x - i * bi.y, ns.y = i * bi.x + r * bi.y) : ns.copy(bi), s.copy(e), s.x += ns.x, s.y += ns.y, s.applyMatrix4(Bc);
}
const fl = new R(), pl = new je(), ml = new je(), Vu = new R(), gl = new Pe(), Zs = new R(), Kr = new dn(), _l = new Pe(), Zr = new Yi();
class Gu extends at {
  constructor(e, t) {
  ...
  computeBoundingBox() {
    ...
    for (let n = 0; n < t.count; n++) this.getVertexPosition(n, Zs), this.boundingBox.expandByPoint(Zs);
  }
  computeBoundingSphere() {
    const e = this.geometry;
    this.boundingSphere === null && (this.boundingSphere = new dn()), this.boundingSphere.makeEmpty();
    const t = e.getAttribute("position");
    for (let n = 0; n < t.count; n++) this.getVertexPosition(n, Zs), this.boundingSphere.expandByPoint(Zs);
  }
  copy(e, t) {
  ...
  updateMatrixWorld(e) {
    super.updateMatrixWorld(e), this.bindMode === Ha ? this.bindMatrixInverse.copy(this.matrixWorld).invert() : this.bindMode === Bh ? this.bindMatrixInverse.copy(this.bindMatrix).invert() : console.warn("THREE.SkinnedMesh: Unrecognized bindMode: " + this.bindMode);
  }
  applyBoneTransform(e, t) {
    ...
    for (let r = 0; r < 4; r++) {
      ...
      if (o !== 0) {
        ...
        gl.multiplyMatrices(n.bones[a].matrixWorld, n.boneInverses[a]), t.addScaledVector(Vu.copy(fl).applyMatrix4(gl), o);
      }
    }
...
class Ma {
  ...
  update() {
    ...
    for (let r = 0, o = e.length; r < o; r++) {
      const a = e[r] ? e[r].matrixWorld : Wu;
...
const Ti = new Pe(), vl = new Pe(), Js = [], Ml = new rn(), Xu = new Pe(), ss = new at(), rs = new dn();
class Yu extends at {
  constructor(e, t, n) {
  ...
  computeBoundingBox() {
    ...
    for (let n = 0; n < t; n++) this.getMatrixAt(n, Ti), Ml.copy(e.boundingBox).applyMatrix4(Ti), this.boundingBox.union(Ml);
  }
  computeBoundingSphere() {
    const e = this.geometry, t = this.count;
    ...
    for (let n = 0; n < t; n++) this.getMatrixAt(n, Ti), rs.copy(e.boundingSphere).applyMatrix4(Ti), this.boundingSphere.union(rs);
  }
  copy(e, t) {
  ...
  raycast(e, t) {
    ...
    if (ss.geometry = this.geometry, ss.material = this.material, ss.material !== void 0 && (this.boundingSphere === null && this.computeBoundingSphere(), rs.copy(this.boundingSphere), rs.applyMatrix4(n), e.ray.intersectsSphere(rs) !== false)) for (let r = 0; r < i; r++) {
      this.getMatrixAt(r, Ti), vl.multiplyMatrices(n, Ti), ss.matrixWorld = vl, ss.raycast(e, Js);
  ...
  setMorphAt(e, t) {
    ...
    this.morphTexture === null && (this.morphTexture = new kc(new Float32Array(i * this.count), i, this.count, ua, tn));
...
const Jr = new R(), ju = new R(), qu = new Le();
let Fn = class {
  ...
  setFromCoplanarPoints(e, t, n) {
    const i = Jr.subVectors(n, t).cross(ju.subVectors(e, t)).normalize();
  ...
  applyMatrix4(e, t) {
    const n = t || qu.getNormalMatrix(e), i = this.coplanarPoint(Jr).applyMatrix4(e), r = this.normal.applyMatrix3(n).normalize();
...
class ya {
  ...
  setFromProjectionMatrix(e, t = Tn) {
    ...
    else if (t === xr) n[5].setComponents(a, u, _, b).normalize();
...
const vr = new R(), Mr = new R(), yl = new Pe(), os = new Yi(), er = new dn(), Qr = new R(), Sl = new R();
class Ms extends rt {
  ...
  computeLineDistances() {
    ...
    if (e.index === null) {
      ...
      for (let i = 1, r = t.count; i < r; i++) vr.fromBufferAttribute(t, i - 1), Mr.fromBufferAttribute(t, i), n[i] = n[i - 1], n[i] += vr.distanceTo(Mr);
  ...
  raycast(e, t) {
    ...
    if (n.boundingSphere === null && n.computeBoundingSphere(), er.copy(n.boundingSphere), er.applyMatrix4(i), er.radius += r, e.ray.intersectsSphere(er) === false) return;
    yl.copy(i).invert(), os.copy(e.ray).applyMatrix4(yl);
    ...
    if (h !== null) {
      ...
      for (let _ = p, m = g - 1; _ < m; _ += c) {
        const f = h.getX(_), E = h.getX(_ + 1), b = tr(this, e, os, l, f, E, _);
        b && t.push(b);
      }
      if (this.isLineLoop) {
        const _ = h.getX(g - 1), m = h.getX(p), f = tr(this, e, os, l, _, m, g - 1);
        f && t.push(f);
      }
    } else {
      const p = Math.max(0, o.start), g = Math.min(d.count, o.start + o.count);
      for (let _ = p, m = g - 1; _ < m; _ += c) {
        const f = tr(this, e, os, l, _, _ + 1, _);
        f && t.push(f);
      }
      if (this.isLineLoop) {
        const _ = tr(this, e, os, l, g - 1, p, g - 1);
        _ && t.push(_);
      }
    }
  }
...
function tr(s, e, t, n, i, r, o) {
  ...
  if (vr.fromBufferAttribute(a, i), Mr.fromBufferAttribute(a, r), t.distanceSqToSegment(vr, Mr, Qr, Sl) > n) return;
...
const Tl = new Pe(), ea = new Yi(), nr = new dn(), ir = new R();
class Ku extends rt {
  ...
  raycast(e, t) {
    ...
    if (n.boundingSphere === null && n.computeBoundingSphere(), nr.copy(n.boundingSphere), nr.applyMatrix4(i), nr.radius += r, e.ray.intersectsSphere(nr) === false) return;
    ...
    if (c !== null) {
      ...
      for (let g = d, _ = p; g < _; g++) {
        const m = c.getX(g);
        ir.fromBufferAttribute(u, m), Al(ir, m, l, i, e, t, this);
      }
    } else {
      const d = Math.max(0, o.start), p = Math.min(u.count, o.start + o.count);
      for (let g = d, _ = p; g < _; g++) ir.fromBufferAttribute(u, g), Al(ir, g, l, i, e, t, this);
    }
  }
  updateMorphTargets() {
    const t = this.geometry.morphAttributes, n = Object.keys(t);
...
class Vc extends _t {
  constructor(e, t, n, i, r, o, a, l, c, h = Li) {
    if (h !== Li && h !== zi) throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");
    n === void 0 && h === Li && (n = ii), n === void 0 && h === zi && (n = Bi), super(null, i, r, o, a, l, h, n, c), this.isDepthTexture = true, this.image = { width: e, height: t }, this.magFilter = a !== void 0 ? a : Lt, this.minFilter = l !== void 0 ? l : Lt, this.flipY = false, this.generateMipmaps = false, this.compareFunction = null;
  }
  copy(e) {
...
class Ju extends qt {
  constructor(e) {
    super(), this.isMeshPhongMaterial = true, this.type = "MeshPhongMaterial", this.color = new ve(16777215), this.specular = new ve(1118481), this.shininess = 30, this.map = null, this.lightMap = null, this.lightMapIntensity = 1, this.aoMap = null, this.aoMapIntensity = 1, this.emissive = new ve(0), this.emissiveIntensity = 1, this.emissiveMap = null, this.bumpMap = null, this.bumpScale = 1, this.normalMap = null, this.normalMapType = ma, this.normalScale = new xe(1, 1), this.displacementMap = null, this.displacementScale = 1, this.displacementBias = 0, this.specularMap = null, this.alphaMap = null, this.envMap = null, this.envMapRotation = new sn(), this.combine = aa, this.reflectivity = 1, this.refractionRatio = 0.98, this.wireframe = false, this.wireframeLinewidth = 1, this.wireframeLinecap = "round", this.wireframeLinejoin = "round", this.flatShading = false, this.fog = true, this.setValues(e);
  }
  copy(e) {
...
class Qu extends qt {
  constructor(e) {
    super(), this.isMeshDepthMaterial = true, this.type = "MeshDepthMaterial", this.depthPacking = Hh, this.map = null, this.alphaMap = null, this.displacementMap = null, this.displacementScale = 1, this.displacementBias = 0, this.wireframe = false, this.wireframeLinewidth = 1, this.setValues(e);
  }
  copy(e) {
...
class pn {
  ...
  validate() {
    ...
    if (i !== void 0 && td(i)) for (let a = 0, l = i.length; a !== l; ++a) {
      const c = i[a];
      if (isNaN(c)) {
...
pn.prototype.DefaultInterpolation = _s;
class ji extends pn {
  constructor(e, t, n) {
    super(e, t, n);
  }
...
ji.prototype.DefaultInterpolation = gs;
...
qi.prototype.DefaultInterpolation = gs;
...
class ad {
  ...
  static parse(e) {
    ...
    for (let o = 0, a = n.length; o !== a; ++o) t.push(cd(n[o]).scale(i));
  ...
  static CreateFromMorphTargetSequence(e, t, n, i) {
    ...
    for (let a = 0; a < r; a++) {
      ...
      const h = nd(l);
      l = wl(l, 1, h), c = wl(c, 1, h), !i && l[0] === 0 && (l.push(r), c.push(c[0])), o.push(new Vi(".morphTargetInfluences[" + t[a].name + "]", l, c).scale(1 / n));
    }
...
const zn = { enabled: false, files: {}, add: function(s, e) {
...
class oi {
  constructor(e) {
    this.manager = e !== void 0 ? e : ud, this.crossOrigin = "anonymous", this.withCredentials = false, this.path = "", this.resourcePath = "", this.requestHeader = {};
  }
  load() {
  }
  loadAsync(e, t) {
...
class Ea extends oi {
  ...
  load(e, t, n, i) {
    ...
    fetch(o).then((c) => {
      ...
      } else throw new dd(`fetch for "${c.url}" responded with ${c.status}: ${c.statusText}`, c);
    }).then((c) => {
      switch (l) {
        case "arraybuffer":
...
class fd extends oi {
  ...
  load(e, t, n, i) {
    ...
    const a = xs("img");
    function l() {
      h(), zn.add(e, this), t && t(this), r.manager.itemEnd(e);
    }
    function c(u) {
...
class pd extends oi {
  ...
  load(e, t, n, i) {
    const r = new _t(), o = new fd(this.manager);
...
class ba {
  constructor(e) {
    this.camera = e, this.intensity = 1, this.bias = 0, this.normalBias = 0, this.radius = 1, this.blurSamples = 8, this.mapSize = new xe(512, 512), this.map = null, this.mapPass = null, this.matrix = new Pe(), this.autoUpdate = true, this.needsUpdate = false, this._frustum = new ya(), this._frameExtents = new xe(1, 1), this._viewportCount = 1, this._viewports = [new je(0, 0, 1, 1)];
  }
  getViewportCount() {
...
class md extends ba {
  ...
  updateMatrices(e) {
    const t = this.camera, n = ki * 2 * e.angle * this.focus, i = this.mapSize.width / this.mapSize.height, r = e.distance || t.far;
...
class gd extends Rs {
  constructor(e, t, n = 0, i = Math.PI / 3, r = 0, o = 2) {
    super(e, t), this.isSpotLight = true, this.type = "SpotLight", this.position.copy(rt.DEFAULT_UP), this.updateMatrix(), this.target = new rt(), this.distance = n, this.angle = i, this.penumbra = r, this.decay = o, this.map = null, this.shadow = new md();
  }
  get power() {
...
const Pl = new Pe(), as = new R(), to = new R();
class _d extends ba {
  constructor() {
    super(new wt(90, 1, 0.5, 500)), this.isPointLightShadow = true, this._frameExtents = new xe(4, 2), this._viewportCount = 6, this._viewports = [new je(2, 1, 1, 1), new je(0, 1, 1, 1), new je(3, 1, 1, 1), new je(1, 1, 1, 1), new je(3, 0, 1, 1), new je(1, 0, 1, 1)], this._cubeDirections = [new R(1, 0, 0), new R(-1, 0, 0), new R(0, 0, 1), new R(0, 0, -1), new R(0, 1, 0), new R(0, -1, 0)], this._cubeUps = [new R(0, 1, 0), new R(0, 1, 0), new R(0, 1, 0), new R(0, 1, 0), new R(0, 0, 1), new R(0, 0, -1)];
  }
  updateMatrices(e, t = 0) {
    const n = this.camera, i = this.matrix, r = e.distance || n.far;
    r !== n.far && (n.far = r, n.updateProjectionMatrix()), as.setFromMatrixPosition(e.matrixWorld), n.position.copy(as), to.copy(n.position), to.add(this._cubeDirections[t]), n.up.copy(this._cubeUps[t]), n.lookAt(to), n.updateMatrixWorld(), i.makeTranslation(-as.x, -as.y, -as.z), Pl.multiplyMatrices(n.projectionMatrix, n.matrixWorldInverse), this._frustum.setFromProjectionMatrix(Pl);
  }
}
class xd extends Rs {
...
class yr extends Rs {
  constructor(e, t) {
    super(e, t), this.isDirectionalLight = true, this.type = "DirectionalLight", this.position.copy(rt.DEFAULT_UP), this.updateMatrix(), this.target = new rt(), this.shadow = new vd();
  }
  dispose() {
    this.shadow.dispose();
  }
...
class Ld {
  ...
  intersectObject(e, t = true, n = []) {
    return ta(e, this, n, t), n.sort(Il), n;
  }
...
class Id extends Sa {
  constructor(e = 10, t = 10, n = 4473924, i = 8947848) {
    ...
    const u = new As({ vertexColors: true, toneMapped: false });
...
class Yc extends Sa {
  constructor(e = 1) {
    ...
    const r = new As({ vertexColors: true, toneMapped: false });
...
function _m(s, e, t, n, i, r, o) {
  ...
  function m(b, M) {
    const L = g(M);
    L && (L.isCubeTexture || L.mapping === Sr) ? (h === void 0 && (h = new at(new Ts(1, 1, 1), new Vn({ name: "BackgroundCubeMaterial", uniforms: Hi(on.backgroundCube.uniforms), vertexShader: on.backgroundCube.vertexShader, fragmentShader: on.backgroundCube.fragmentShader, side: Nt, depthTest: false, depthWrite: false, fog: false })), h.geometry.deleteAttribute("normal"), h.geometry.deleteAttribute("uv"), h.onBeforeRender = function(w, A, U) {
      this.matrixWorld.copyPosition(U.matrixWorld);
    }, Object.defineProperty(h.material, "envMap", { get: function() {
      return this.uniforms.envMap.value;
    } }), i.update(h)), $n.copy(M.backgroundRotation), $n.x *= -1, $n.y *= -1, $n.z *= -1, L.isCubeTexture && L.isRenderTargetTexture === false && ($n.y *= -1, $n.z *= -1), h.material.uniforms.envMap.value = L, h.material.uniforms.flipEnvMap.value = L.isCubeTexture && L.isRenderTargetTexture === false ? -1 : 1, h.material.uniforms.backgroundBlurriness.value = M.backgroundBlurriness, h.material.uniforms.backgroundIntensity.value = M.backgroundIntensity, h.material.uniforms.backgroundRotation.value.setFromMatrix4(gm.makeRotationFromEuler($n)), h.material.toneMapped = Ve.getTransfer(L.colorSpace) !== Qe, (u !== L || d !== L.version || p !== s.toneMapping) && (h.material.needsUpdate = true, u = L, d = L.version, p = s.toneMapping), h.layers.enableAll(), b.unshift(h, h.geometry, h.material, 0, 0, null)) : L && L.isTexture && (c === void 0 && (c = new at(new Er(2, 2), new Vn({ name: "BackgroundMaterial", uniforms: Hi(on.background.uniforms), vertexShader: on.background.vertexShader, fragmentShader: on.background.fragmentShader, side: wn, depthTest: false, depthWrite: false, fog: false })), c.geometry.deleteAttribute("normal"), Object.defineProperty(c.material, "map", { get: function() {
  ...
  function f(b, M) {
    b.getRGB(rr, Dc(s)), n.buffers.color.setClear(rr.r, rr.g, rr.b, M, o);
  }
  function E() {
...
function xm(s, e) {
  ...
  let r = i, o = false;
  function a(y, P, G, k, Y) {
    let $ = false;
    const V = u(k, G, P);
    r !== V && (r = V, c(r.object)), $ = p(y, k, G, Y), $ && g(y, k, G, Y), Y !== null && e.update(Y, s.ELEMENT_ARRAY_BUFFER), ($ || o) && (o = false, M(y, P, G, k), Y !== null && s.bindBuffer(s.ELEMENT_ARRAY_BUFFER, e.get(Y).buffer));
  }
  function l() {
  ...
  function d(y) {
    const P = [], G = [], k = [];
    for (let Y = 0; Y < t; Y++) P[Y] = 0, G[Y] = 0, k[Y] = 0;
  ...
  function p(y, P, G, k) {
    const Y = r.attributes, $ = P.attributes;
    let V = 0;
  ...
  function g(y, P, G, k) {
    ...
    for (const z in K) if (K[z].location >= 0) {
      ...
      const Me = {};
      Me.attribute = he, he && he.data && (Me.data = he.data), Y[z] = Me, V++;
    }
    r.attributes = Y, r.attributesNum = V, r.index = k;
  }
  function _() {
  ...
  function f(y, P) {
    const G = r.newAttributes, k = r.enabledAttributes, Y = r.attributeDivisors;
    G[y] = 1, k[y] === 0 && (s.enableVertexAttribArray(y), k[y] = 1), Y[y] !== P && (s.vertexAttribDivisor(y, P), Y[y] = P);
  }
  function E() {
    const y = r.newAttributes, P = r.enabledAttributes;
    for (let G = 0, k = P.length; G < k; G++) P[G] !== y[G] && (s.disableVertexAttribArray(G), P[G] = 0);
  }
  function b(y, P, G, k, Y, $, V) {
    V === true ? s.vertexAttribIPointer(y, P, G, Y, $) : s.vertexAttribPointer(y, P, G, k, Y, $);
  }
  function M(y, P, G, k) {
    _();
    const Y = k.attributes, $ = G.getAttributes(), V = P.defaultAttributeValues;
    for (const K in $) {
      const z = $[K];
      if (z.location >= 0) {
        let se = Y[K];
        if (se === void 0 && (K === "instanceMatrix" && y.instanceMatrix && (se = y.instanceMatrix), K === "instanceColor" && y.instanceColor && (se = y.instanceColor)), se !== void 0) {
          ...
          if (se.isInterleavedBufferAttribute) {
            ...
            for (let Ae = 0; Ae < z.locationSize; Ae++) b(z.location + Ae, Me / z.locationSize, X, he, be * ee, (Ye + Me / z.locationSize * Ae) * ee, me);
          } else {
  ...
  return { setup: a, reset: U, resetDefaultState: S, dispose: L, releaseStatesOfGeometry: w, releaseStatesOfProgram: A, initAttributes: _, enableAttribute: m, disableUnusedAttributes: E };
}
function vm(s, e, t) {
  let n;
  function i(c) {
...
function Mm(s, e, t, n) {
  ...
  function a(A) {
    const U = A === bs && (e.has("EXT_color_buffer_half_float") || e.has("EXT_color_buffer_float"));
    return !(A !== Rn && n.convert(A) !== s.getParameter(s.IMPLEMENTATION_COLOR_READ_TYPE) && A !== tn && !U);
  }
  function l(A) {
    if (A === "highp") {
...
function Sm(s) {
  ...
  function t(o, a) {
    return a === Eo ? o.mapping = Ni : a === bo && (o.mapping = Fi), o;
  }
  function n(o) {
    if (o && o.isTexture) {
      const a = o.mapping;
...
const Ri = 4, Nl = [0.125, 0.215, 0.35, 0.446, 0.526, 0.582], ti = 20, no = new Cs(), Fl = new ve();
let io = null, so = 0, ro = 0, oo = false;
const Qn = (1 + Math.sqrt(5)) / 2, Ai = 1 / Qn, Ol = [new R(-Qn, Ai, 0), new R(Qn, Ai, 0), new R(-Ai, 0, Qn), new R(Ai, 0, Qn), new R(0, Qn, -Ai), new R(0, Qn, Ai), new R(-1, 1, -1), new R(1, 1, -1), new R(-1, 1, 1), new R(1, 1, 1)], Em = new R();
class Bl {
  constructor(e) {
  ...
  _cleanup(e) {
    this._renderer.setRenderTarget(io, so, ro), this._renderer.xr.enabled = oo, e.scissorTest = false, or(e, 0, 0, e.width, e.height);
  }
  _fromTexture(e, t) {
    e.mapping === Ni || e.mapping === Fi ? this._setSize(e.image.length === 0 ? 16 : e.image[0].width || e.image[0].image.width) : this._setSize(e.image.width / 4), io = this._renderer.getRenderTarget(), so = this._renderer.getActiveCubeFace(), ro = this._renderer.getActiveMipmapLevel(), oo = this._renderer.xr.enabled, this._renderer.xr.enabled = false;
    const n = t || this._allocateTargets();
    return this._textureToCubeUV(e, n), this._applyPMREM(n), this._cleanup(n), n;
  }
  _allocateTargets() {
    const e = 3 * Math.max(this._cubeSize, 112), t = 4 * this._cubeSize, n = { magFilter: zt, minFilter: zt, generateMipmaps: false, type: bs, format: Yt, colorSpace: It, depthBuffer: false }, i = zl(e, t, n);
  ...
  _sceneToCubeUV(e, t, n, i, r) {
    ...
    u.getClearColor(Fl), u.toneMapping = Hn, u.autoClear = false;
    const g = new cn({ name: "PMREM.Background", side: Nt, depthWrite: false, depthTest: false }), _ = new at(new Ts(), g);
    let m = false;
    ...
    for (let E = 0; E < 6; E++) {
      ...
      or(i, b * M, E > 2 ? M : 0, M, M), u.setRenderTarget(i), m && u.render(_, l), u.render(e, l);
    }
  ...
  _textureToCubeUV(e, t) {
    ...
    const r = i ? this._cubemapMaterial : this._equirectMaterial, o = new at(this._lodPlanes[0], r), a = r.uniforms;
    a.envMap.value = e;
    const l = this._cubeSize;
    or(t, 0, 0, 3 * l, 2 * l), n.setRenderTarget(t), n.render(o, no);
  }
  _applyPMREM(e) {
  ...
  _halfBlur(e, t, n, i, r, o, a) {
    ...
    const h = 3, u = new at(this._lodPlanes[i], c), d = c.uniforms, p = this._sizeLods[n] - 1, g = isFinite(r) ? Math.PI / (2 * p) : 2 * Math.PI / (2 * ti - 1), _ = r / g, m = isFinite(r) ? 1 + Math.floor(h * _) : ti;
    m > ti && console.warn(`sigmaRadians, ${r}, is too large and will clip, as it requested ${m} samples when the maximum is set to ${ti}`);
    const f = [];
    let E = 0;
    for (let A = 0; A < ti; ++A) {
      const U = A / _, S = Math.exp(-U * U / 2);
    ...
    const M = this._sizeLods[i], L = 3 * M * (i > b - Ri ? i - b + Ri : 0), w = 4 * (this._cubeSize - M);
    or(t, L, w, 3 * M, 2 * M), l.setRenderTarget(t), l.render(u, no);
  }
}
function bm(s) {
  const e = [], t = [], n = [];
  let i = s;
  const r = s - Ri + 1 + Nl.length;
  for (let o = 0; o < r; o++) {
    const a = Math.pow(2, i);
    t.push(a);
    let l = 1 / a;
    o > s - Ri ? l = Nl[o - s + Ri - 1] : o === 0 && (l = 0), n.push(l);
    ...
    for (let w = 0; w < p; w++) {
      const A = w % 3 * 2 / 3 - 1, U = w > 2 ? 0 : -1, S = [A, U, 0, A + 2 / 3, U, 0, A + 2 / 3, U + 1, 0, A, U, 0, A + 2 / 3, U + 1, 0, A, U + 1, 0];
      E.set(S, _ * g * w), b.set(d, m * g * w);
      const y = [w, w, w, w, w, w];
      M.set(y, f * g * w);
    }
    const L = new ft();
    L.setAttribute("position", new ht(E, _)), L.setAttribute("uv", new ht(b, m)), L.setAttribute("faceIndex", new ht(M, f)), e.push(L), i > Ri && i--;
  }
...
function Tm(s, e, t) {
  const n = new Float32Array(ti), i = new R(0, 1, 0);
  return new Vn({ name: "SphericalGaussianBlur", defines: { n: ti, CUBEUV_TEXEL_WIDTH: 1 / e, CUBEUV_TEXEL_HEIGHT: 1 / t, CUBEUV_MAX_MIP: `${s}.0` }, uniforms: { envMap: { value: null }, samples: { value: 1 }, weights: { value: n }, latitudinal: { value: false }, dTheta: { value: 0 }, mipInt: { value: 0 }, poleAxis: { value: i } }, vertexShader: wa(), fragmentShader: `
...
function kl() {
  return new Vn({ name: "EquirectangularToCubeUV", uniforms: { envMap: { value: null } }, vertexShader: wa(), fragmentShader: `
...
function Hl() {
  return new Vn({ name: "CubemapToCubeUV", uniforms: { envMap: { value: null }, flipEnvMap: { value: -1 } }, vertexShader: wa(), fragmentShader: `
...
function Am(s) {
  ...
  function n(a) {
    if (a && a.isTexture) {
      const l = a.mapping, c = l === Eo || l === bo, h = l === Ni || l === Fi;
      if (c || h) {
        let u = e.get(a);
...
function Lm(s, e, t) {
  ...
  function r(o, a, l) {
    ...
    if (d === void 0 || d.count !== u) {
      let y = function() {
        U.dispose(), n.delete(a), a.removeEventListener("dispose", y);
      };
      var p = y;
      ...
      const A = new Float32Array(L * w * 4 * u), U = new Cc(A, L, w, u);
      U.type = tn, U.needsUpdate = true;
      const S = M * 4;
      for (let P = 0; P < u; P++) {
        const G = f[P], k = E[P], Y = b[P], $ = L * w * 4 * P;
        for (let V = 0; V < G.count; V++) {
          const K = V * S;
          g === true && (i.fromBufferAttribute(G, V), A[$ + K + 0] = i.x, A[$ + K + 1] = i.y, A[$ + K + 2] = i.z, A[$ + K + 3] = 0), _ === true && (i.fromBufferAttribute(k, V), A[$ + K + 4] = i.x, A[$ + K + 5] = i.y, A[$ + K + 6] = i.z, A[$ + K + 7] = 0), m === true && (i.fromBufferAttribute(Y, V), A[$ + K + 8] = i.x, A[$ + K + 9] = i.y, A[$ + K + 10] = i.z, A[$ + K + 11] = Y.itemSize === 4 ? i.w : 1);
        }
      }
      d = { count: u, texture: U, size: new xe(L, w) }, n.set(a, d), a.addEventListener("dispose", y);
    }
...
const qc = new _t(), Vl = new Vc(1, 1), $c = new Cc(), Kc = new Su(), Zc = new Uc(), Gl = [], Wl = [], Xl = new Float32Array(16), Yl = new Float32Array(9), jl = new Float32Array(4);
function $i(s, e, t) {
  const n = s[0];
  if (n <= 0 || n > 0) return s;
  const i = e * t;
...
function Om(s, e) {
  ...
  if (n === void 0) {
    ...
    if (xt(t, n)) return;
    jl.set(n), s.uniformMatrix2fv(this.addr, false, jl), vt(t, n);
  }
}
function Bm(s, e) {
  const t = this.cache, n = e.elements;
  if (n === void 0) {
    ...
    if (xt(t, n)) return;
    Yl.set(n), s.uniformMatrix3fv(this.addr, false, Yl), vt(t, n);
  }
}
function zm(s, e) {
  const t = this.cache, n = e.elements;
...
function qm(s, e, t) {
  ...
  let r;
  this.type === s.SAMPLER_2D_SHADOW ? (Vl.compareFunction = Ac, r = Vl) : r = qc, t.setTexture2D(e || r, i);
}
function $m(s, e, t) {
  const n = this.cache, i = t.allocateTextureUnit();
  n[0] !== i && (s.uniform1i(this.addr, i), n[0] = i), t.setTexture3D(e || Kc, i);
}
function Km(s, e, t) {
  const n = this.cache, i = t.allocateTextureUnit();
  n[0] !== i && (s.uniform1i(this.addr, i), n[0] = i), t.setTextureCube(e || Zc, i);
}
function Zm(s, e, t) {
  const n = this.cache, i = t.allocateTextureUnit();
  n[0] !== i && (s.uniform1i(this.addr, i), n[0] = i), t.setTexture2DArray(e || $c, i);
}
function Jm(s) {
  switch (s) {
    case 5126:
...
function pg(s, e, t) {
  ...
  for (let o = 0; o !== i; ++o) t.setTexture2D(e[o] || qc, r[o]);
}
function mg(s, e, t) {
  const n = this.cache, i = e.length, r = Tr(t, i);
  xt(n, r) || (s.uniform1iv(this.addr, r), vt(n, r));
  for (let o = 0; o !== i; ++o) t.setTexture3D(e[o] || Kc, r[o]);
}
function gg(s, e, t) {
  const n = this.cache, i = e.length, r = Tr(t, i);
  xt(n, r) || (s.uniform1iv(this.addr, r), vt(n, r));
  for (let o = 0; o !== i; ++o) t.setTextureCube(e[o] || Zc, r[o]);
}
function _g(s, e, t) {
  const n = this.cache, i = e.length, r = Tr(t, i);
  xt(n, r) || (s.uniform1iv(this.addr, r), vt(n, r));
  for (let o = 0; o !== i; ++o) t.setTexture2DArray(e[o] || $c, r[o]);
}
function xg(s) {
  switch (s) {
    case 5126:
...
const ar = new R();
function Cg() {
  Ve.getLuminanceCoefficients(ar);
...
function Bg(s) {
  ...
  return s.shadowMapType === fc ? e = "SHADOWMAP_TYPE_PCF" : s.shadowMapType === hh ? e = "SHADOWMAP_TYPE_PCF_SOFT" : s.shadowMapType === Sn && (e = "SHADOWMAP_TYPE_VSM"), e;
}
function zg(s) {
...
` + f);
  ...
  function A(P) {
    if (s.debug.checkShaderErrors) {
      const G = i.getProgramInfoLog(_).trim(), k = i.getShaderInfoLog(L).trim(), Y = i.getShaderInfoLog(w).trim();
      let $ = true, V = true;
...
` + z);
      ...
      else G !== "" ? console.warn("THREE.WebGLProgram: Program Info Log:", G) : (k === "" || Y === "") && (V = false);
      V && (P.diagnostics = { runnable: $, programLog: G, vertexShader: { log: k, prefix: m }, fragmentShader: { log: Y, prefix: f } });
    }
    i.deleteShader(L), i.deleteShader(w), U = new mr(i, _), S = Ig(i, _);
  }
  let U;
...
function jg(s, e, t, n, i, r, o) {
  ...
  function m(S, y, P, G, k) {
    const Y = G.fog, $ = k.geometry, V = S.isMeshStandardMaterial ? G.environment : null, K = (S.isMeshStandardMaterial ? t : e).get(S.envMap || V), z = K && K.mapping === Sr ? K.image.height : null, se = g[S.type];
    ...
    const re = s.getRenderTarget(), be = s.state.buffers.depth.getReversed(), Ye = k.isInstancedMesh === true, Ae = k.isBatchedMesh === true, ut = !!S.map, ot = !!S.matcap, Be = !!K, C = !!S.aoMap, kt = !!S.lightMap, ze = !!S.bumpMap, ke = !!S.normalMap, ye = !!S.displacementMap, it = !!S.emissiveMap, _e = !!S.metalnessMap, T = !!S.roughnessMap, x = S.anisotropy > 0, F = S.clearcoat > 0, j = S.dispersion > 0, Z = S.iridescence > 0, W = S.sheen > 0, ge = S.transmission > 0, oe = x && !!S.anisotropyMap, ue = F && !!S.clearcoatMap, Ge = F && !!S.clearcoatNormalMap, Q = F && !!S.clearcoatRoughnessMap, de = Z && !!S.iridescenceMap, Te = Z && !!S.iridescenceThicknessMap, we = W && !!S.sheenColorMap, fe = W && !!S.sheenRoughnessMap, He = !!S.specularMap, De = !!S.specularColorMap, nt = !!S.specularIntensityMap, I = ge && !!S.transmissionMap, ne = ge && !!S.thicknessMap, H = !!S.gradientMap, q = !!S.alphaMap, le = S.alphaTest > 0, ae = !!S.alphaHash, Ie = !!S.extensions;
    let lt = Hn;
    S.toneMapped && (re === null || re.isXRRenderTarget === true) && (lt = s.toneMapping);
    const bt = { shaderID: se, shaderType: S.type, shaderName: S.name, vertexShader: tt, fragmentShader: X, defines: S.defines, customVertexShaderID: ee, customFragmentShaderID: me, isRawShaderMaterial: S.isRawShaderMaterial === true, glslVersion: S.glslVersion, precision: p, batching: Ae, batchingColor: Ae && k._colorsTexture !== null, instancing: Ye, instancingColor: Ye && k.instanceColor !== null, instancingMorph: Ye && k.morphTexture !== null, supportsVertexTextures: d, outputColorSpace: re === null ? s.outputColorSpace : re.isXRRenderTarget === true ? re.texture.colorSpace : It, alphaToCoverage: !!S.alphaToCoverage, map: ut, matcap: ot, envMap: Be, envMapMode: Be && K.mapping, envMapCubeUVHeight: z, aoMap: C, lightMap: kt, bumpMap: ze, normalMap: ke, displacementMap: d && ye, emissiveMap: it, normalMapObjectSpace: ke && S.normalMapType === Gh, normalMapTangentSpace: ke && S.normalMapType === ma, metalnessMap: _e, roughnessMap: T, anisotropy: x, anisotropyMap: oe, clearcoat: F, clearcoatMap: ue, clearcoatNormalMap: Ge, clearcoatRoughnessMap: Q, dispersion: j, iridescence: Z, iridescenceMap: de, iridescenceThicknessMap: Te, sheen: W, sheenColorMap: we, sheenRoughnessMap: fe, specularMap: He, specularColorMap: De, specularIntensityMap: nt, transmission: ge, transmissionMap: I, thicknessMap: ne, gradientMap: H, opaque: S.transparent === false && S.blending === Pi && S.alphaToCoverage === false, alphaMap: q, alphaTest: le, alphaHash: ae, combine: S.combine, mapUv: ut && _(S.map.channel), aoMapUv: C && _(S.aoMap.channel), lightMapUv: kt && _(S.lightMap.channel), bumpMapUv: ze && _(S.bumpMap.channel), normalMapUv: ke && _(S.normalMap.channel), displacementMapUv: ye && _(S.displacementMap.channel), emissiveMapUv: it && _(S.emissiveMap.channel), metalnessMapUv: _e && _(S.metalnessMap.channel), roughnessMapUv: T && _(S.roughnessMap.channel), anisotropyMapUv: oe && _(S.anisotropyMap.channel), clearcoatMapUv: ue && _(S.clearcoatMap.channel), clearcoatNormalMapUv: Ge && _(S.clearcoatNormalMap.channel), clearcoatRoughnessMapUv: Q && _(S.clearcoatRoughnessMap.channel), iridescenceMapUv: de && _(S.iridescenceMap.channel), iridescenceThicknessMapUv: Te && _(S.iridescenceThicknessMap.channel), sheenColorMapUv: we && _(S.sheenColorMap.channel), sheenRoughnessMapUv: fe && _(S.sheenRoughnessMap.channel), specularMapUv: He && _(S.specularMap.channel), specularColorMapUv: De && _(S.specularColorMap.channel), specularIntensityMapUv: nt && _(S.specularIntensityMap.channel), transmissionMapUv: I && _(S.transmissionMap.channel), thicknessMapUv: ne && _(S.thicknessMap.channel), alphaMapUv: q && _(S.alphaMap.channel), vertexTangents: !!$.attributes.tangent && (ke || x), vertexColors: S.vertexColors, vertexAlphas: S.vertexColors === true && !!$.attributes.color && $.attributes.color.itemSize === 4, pointsUvs: k.isPoints === true && !!$.attributes.uv && (ut || q), fog: !!Y, useFog: S.fog === true, fogExp2: !!Y && Y.isFogExp2, flatShading: S.flatShading === true, sizeAttenuation: S.sizeAttenuation === true, logarithmicDepthBuffer: u, reverseDepthBuffer: be, skinning: k.isSkinnedMesh === true, morphTargets: $.morphAttributes.position !== void 0, morphNormals: $.morphAttributes.normal !== void 0, morphColors: $.morphAttributes.color !== void 0, morphTargetsCount: Me, morphTextureStride: Fe, numDirLights: y.directional.length, numPointLights: y.point.length, numSpotLights: y.spot.length, numSpotLightMaps: y.spotLightMap.length, numRectAreaLights: y.rectArea.length, numHemiLights: y.hemi.length, numDirLightShadows: y.directionalShadowMap.length, numPointLightShadows: y.pointShadowMap.length, numSpotLightShadows: y.spotShadowMap.length, numSpotLightShadowsWithMaps: y.numSpotLightShadowsWithMaps, numLightProbes: y.numLightProbes, numClippingPlanes: o.numPlanes, numClipIntersection: o.numIntersection, dithering: S.dithering, shadowMapEnabled: s.shadowMap.enabled && P.length > 0, shadowMapType: s.shadowMap.type, toneMapping: lt, decodeVideoTexture: ut && S.map.isVideoTexture === true && Ve.getTransfer(S.map.colorSpace) === Qe, decodeVideoTextureEmissive: it && S.emissiveMap.isVideoTexture === true && Ve.getTransfer(S.emissiveMap.colorSpace) === Qe, premultipliedAlpha: S.premultipliedAlpha, doubleSided: S.side === ln, flipSided: S.side === Nt, useDepthPacking: S.depthPacking >= 0, depthPacking: S.depthPacking || 0, index0AttributeName: S.index0AttributeName, extensionClipCullDistance: Ie && S.extensions.clipCullDistance === true && n.has("WEBGL_clip_cull_distance"), extensionMultiDraw: (Ie && S.extensions.multiDraw === true || Ae) && n.has("WEBGL_multi_draw"), rendererExtensionParallelShaderCompile: n.has("KHR_parallel_shader_compile"), customProgramCacheKey: S.customProgramCacheKey() };
  ...
  return { getParameters: m, getProgramCacheKey: f, getUniforms: M, acquireProgram: L, releaseProgram: w, releaseShaderCache: A, programs: h, dispose: U };
}
function qg() {
...
function t_(s) {
  ...
  function a(c) {
    ...
    for (let S = 0, y = c.length; S < y; S++) {
      const P = c[S], G = P.color, k = P.intensity, Y = P.distance, $ = P.shadow && P.shadow.map ? P.shadow.map.texture : null;
      if (P.isAmbientLight) h += G.r * k, u += G.g * k, d += G.b * k;
        ...
        const V = e.get(P);
        V.position.setFromMatrixPosition(P.matrixWorld), V.color.copy(G).multiplyScalar(k), V.distance = Y, V.coneCos = Math.cos(P.angle), V.penumbraCos = Math.cos(P.angle * (1 - P.penumbra)), V.decay = P.decay, n.spot[_] = V;
        const K = P.shadow;
    ...
    const U = n.hash;
    (U.directionalLength !== p || U.pointLength !== g || U.spotLength !== _ || U.rectAreaLength !== m || U.hemiLength !== f || U.numDirectionalShadows !== E || U.numPointShadows !== b || U.numSpotShadows !== M || U.numSpotMaps !== L || U.numLightProbes !== A) && (n.directional.length = p, n.spot.length = _, n.rectArea.length = m, n.point.length = g, n.hemi.length = f, n.directionalShadow.length = E, n.directionalShadowMap.length = E, n.pointShadow.length = b, n.pointShadowMap.length = b, n.spotShadow.length = M, n.spotShadowMap.length = M, n.directionalShadowMatrix.length = E, n.pointShadowMatrix.length = b, n.spotLightMatrix.length = M + L - w, n.spotLightMap.length = L, n.numSpotLightShadowsWithMaps = w, n.numLightProbes = A, U.directionalLength = p, U.pointLength = g, U.spotLength = _, U.rectAreaLength = m, U.hemiLength = f, U.numDirectionalShadows = E, U.numPointShadows = b, U.numSpotShadows = M, U.numSpotMaps = L, U.numLightProbes = A, n.version = Qg++);
  }
  function l(c, h) {
...
function r_(s, e, t) {
  let n = new ya();
  const i = new xe(), r = new xe(), o = new je(), a = new Qu({ depthPacking: Vh }), l = new ed(), c = {}, h = t.maxTextureSize, u = { [wn]: Nt, [Nt]: wn, [ln]: ln }, d = new Vn({ defines: { VSM_SAMPLES: 8 }, uniforms: { shadow_pass: { value: null }, resolution: { value: new xe() }, radius: { value: 4 } }, vertexShader: i_, fragmentShader: s_ }), p = d.clone();
  ...
  this.render = function(w, A, U) {
    ...
    G.setBlending(kn), G.buffers.color.setClear(1, 1, 1, 1), G.buffers.depth.setTest(true), G.setScissorTest(false);
    const k = f !== Sn && this.type === Sn, Y = f === Sn && this.type !== Sn;
    for (let $ = 0, V = w.length; $ < V; $++) {
      ...
      if (i.multiply(se), r.copy(z.mapSize), (i.x > h || i.y > h) && (i.x > h && (r.x = Math.floor(h / se.x), i.x = r.x * se.x, z.mapSize.x = r.x), i.y > h && (r.y = Math.floor(h / se.y), i.y = r.y * se.y, z.mapSize.y = r.y)), z.map === null || k === true || Y === true) {
        const Me = this.type !== Sn ? { minFilter: Lt, magFilter: Lt } : {};
        z.map !== null && z.map.dispose(), z.map = new si(i.x, i.y, Me), z.map.texture.name = K.name + ".shadowMap", z.camera.updateProjectionMatrix();
      }
      s.setRenderTarget(z.map), s.clear();
      const he = z.getViewportCount();
      for (let Me = 0; Me < he; Me++) {
        const Fe = z.getViewport(Me);
        o.set(r.x * Fe.x, r.y * Fe.y, r.x * Fe.z, r.y * Fe.w), G.viewport(o), z.updateMatrices(K, Me), n = z.getFrustum(), M(A, U, z.camera, K, this.type);
      }
      z.isPointLightShadow !== true && this.type === Sn && E(z, U), z.needsUpdate = false;
    }
    f = this.type, m.needsUpdate = false, s.setRenderTarget(S, y, P);
  };
  function E(w, A) {
    const U = e.update(_);
    d.defines.VSM_SAMPLES !== w.blurSamples && (d.defines.VSM_SAMPLES = w.blurSamples, p.defines.VSM_SAMPLES = w.blurSamples, d.needsUpdate = true, p.needsUpdate = true), w.mapPass === null && (w.mapPass = new si(i.x, i.y)), d.uniforms.shadow_pass.value = w.map.texture, d.uniforms.resolution.value = w.mapSize, d.uniforms.radius.value = w.radius, s.setRenderTarget(w.mapPass), s.clear(), s.renderBufferDirect(A, null, U, d, _, null), p.uniforms.shadow_pass.value = w.mapPass.texture, p.uniforms.resolution.value = w.mapSize, p.uniforms.radius.value = w.radius, s.setRenderTarget(w.map), s.clear(), s.renderBufferDirect(A, null, U, p, _, null);
  }
  function b(w, A, U, S) {
    let y = null;
    const P = U.isPointLight === true ? w.customDistanceMaterial : w.customDepthMaterial;
    if (P !== void 0) y = P;
    else if (y = U.isPointLight === true ? l : a, s.localClippingEnabled && A.clipShadows === true && Array.isArray(A.clippingPlanes) && A.clippingPlanes.length !== 0 || A.displacementMap && A.displacementScale !== 0 || A.alphaMap && A.alphaTest > 0 || A.map && A.alphaTest > 0) {
      const G = y.uuid, k = A.uuid;
      let Y = c[G];
      Y === void 0 && (Y = {}, c[G] = Y);
      let $ = Y[k];
      $ === void 0 && ($ = y.clone(), Y[k] = $, A.addEventListener("dispose", L)), y = $;
    }
  ...
  function M(w, A, U, S, y) {
    ...
    if (w.layers.test(A.layers) && (w.isMesh || w.isLine || w.isPoints) && (w.castShadow || w.receiveShadow && y === Sn) && (!w.frustumCulled || n.intersectsObject(w))) {
      ...
      const k = e.update(w), Y = w.material;
      if (Array.isArray(Y)) {
        const $ = k.groups;
        for (let V = 0, K = $.length; V < K; V++) {
          const z = $[V], se = Y[z.materialIndex];
          if (se && se.visible) {
            const he = b(w, se, S, y);
            w.onBeforeShadow(s, w, A, U, k, he, z), s.renderBufferDirect(U, null, k, he, w, z), w.onAfterShadow(s, w, A, U, k, he, z);
          }
        }
      } else if (Y.visible) {
        const $ = b(w, Y, S, y);
        w.onBeforeShadow(s, w, A, U, k, $, null), s.renderBufferDirect(U, null, k, $, w, null), w.onAfterShadow(s, w, A, U, k, $, null);
      }
    }
    const G = w.children;
    for (let k = 0, Y = G.length; k < Y; k++) M(G[k], A, U, S, y);
  }
  function L(w) {
...
const o_ = { [go]: _o, [xo]: yo, [vo]: So, [Ui]: Mo, [_o]: go, [yo]: xo, [So]: vo, [Mo]: Ui };
function a_(s, e) {
  function t() {
    let I = false;
    const ne = new je();
    ...
    return { setMask: function(le) {
      H !== le && !I && (s.colorMask(le, le, le, le), H = le);
    }, setLocked: function(le) {
      I = le;
    }, setClear: function(le, ae, Ie, lt, bt) {
      bt === true && (le *= lt, ae *= lt, Ie *= lt), ne.set(le, ae, Ie, lt), q.equals(ne) === false && (s.clearColor(le, ae, Ie, lt), q.copy(ne));
    }, reset: function() {
      I = false, H = null, q.set(-1, 0, 0, 0);
    } };
  }
  function n() {
    let I = false, ne = false, H = null, q = null, le = null;
    return { setReversed: function(ae) {
      ...
      I = false, H = null, q = null, le = null, ne = false;
    } };
  }
  function i() {
    let I = false, ne = null, H = null, q = null, le = null, ae = null, Ie = null, lt = null, bt = null;
    return { setTest: function(Ke) {
      I || (Ke ? re(s.STENCIL_TEST) : be(s.STENCIL_TEST));
    }, setMask: function(Ke) {
      ne !== Ke && !I && (s.stencilMask(Ke), ne = Ke);
    }, setFunc: function(Ke, $t, mn) {
      (H !== Ke || q !== $t || le !== mn) && (s.stencilFunc(Ke, $t, mn), H = Ke, q = $t, le = mn);
    }, setOp: function(Ke, $t, mn) {
      (ae !== Ke || Ie !== $t || lt !== mn) && (s.stencilOp(Ke, $t, mn), ae = Ke, Ie = $t, lt = mn);
    }, setLocked: function(Ke) {
      I = Ke;
    }, setClear: function(Ke) {
      bt !== Ke && (s.clearStencil(Ke), bt = Ke);
    }, reset: function() {
      I = false, ne = null, H = null, q = null, le = null, ae = null, Ie = null, lt = null, bt = null;
    } };
  }
  const r = new t(), o = new n(), a = new i(), l = /* @__PURE__ */ new WeakMap(), c = /* @__PURE__ */ new WeakMap();
  let h = {}, u = {}, d = /* @__PURE__ */ new WeakMap(), p = [], g = null, _ = false, m = null, f = null, E = null, b = null, M = null, L = null, w = null, A = new ve(0, 0, 0), U = 0, S = false, y = null, P = null, G = null, k = null, Y = null;
  ...
  let se = null, he = {};
  const Me = s.getParameter(s.SCISSOR_BOX), Fe = s.getParameter(s.VIEWPORT), tt = new je().fromArray(Me), X = new je().fromArray(Fe);
  function ee(I, ne, H, q) {
  ...
  function Ye(I, ne) {
    return u[I] !== ne ? (s.bindFramebuffer(I, ne), u[I] = ne, I === s.DRAW_FRAMEBUFFER && (u[s.FRAMEBUFFER] = ne), I === s.FRAMEBUFFER && (u[s.DRAW_FRAMEBUFFER] = ne), true) : false;
  }
  function Ae(I, ne) {
    let H = p, q = false;
    if (I) {
  ...
  const ot = { [ei]: s.FUNC_ADD, [dh]: s.FUNC_SUBTRACT, [fh]: s.FUNC_REVERSE_SUBTRACT };
  ot[ph] = s.MIN, ot[mh] = s.MAX;
  const Be = { [gh]: s.ZERO, [_h]: s.ONE, [xh]: s.SRC_COLOR, [po]: s.SRC_ALPHA, [bh]: s.SRC_ALPHA_SATURATE, [Sh]: s.DST_COLOR, [Mh]: s.DST_ALPHA, [vh]: s.ONE_MINUS_SRC_COLOR, [mo]: s.ONE_MINUS_SRC_ALPHA, [Eh]: s.ONE_MINUS_DST_COLOR, [yh]: s.ONE_MINUS_DST_ALPHA, [Th]: s.CONSTANT_COLOR, [Ah]: s.ONE_MINUS_CONSTANT_COLOR, [wh]: s.CONSTANT_ALPHA, [Rh]: s.ONE_MINUS_CONSTANT_ALPHA };
  function C(I, ne, H, q, le, ae, Ie, lt, bt, Ke) {
    if (I === kn) {
      _ === true && (be(s.BLEND), _ = false);
      return;
    }
    if (_ === false && (re(s.BLEND), _ = true), I !== uh) {
      if (I !== m || Ke !== S) {
        if ((f !== ei || M !== ei) && (s.blendEquation(s.FUNC_ADD), f = ei, M = ei), Ke) switch (I) {
          case Pi:
        ...
        E = null, b = null, L = null, w = null, A.set(0, 0, 0), U = 0, m = I, S = Ke;
      }
      return;
    }
    le = le || ne, ae = ae || H, Ie = Ie || q, (ne !== f || le !== M) && (s.blendEquationSeparate(ot[ne], ot[le]), f = ne, M = le), (H !== E || q !== b || ae !== L || Ie !== w) && (s.blendFuncSeparate(Be[H], Be[q], Be[ae], Be[Ie]), E = H, b = q, L = ae, w = Ie), (lt.equals(A) === false || bt !== U) && (s.blendColor(lt.r, lt.g, lt.b, bt), A.copy(lt), U = bt), m = I, S = false;
  }
  function kt(I, ne) {
    I.side === ln ? be(s.CULL_FACE) : re(s.CULL_FACE);
    let H = I.side === Nt;
    ne && (H = !H), ze(H), I.blending === Pi && I.transparent === false ? C(kn) : C(I.blending, I.blendEquation, I.blendSrc, I.blendDst, I.blendEquationAlpha, I.blendSrcAlpha, I.blendDstAlpha, I.blendColor, I.blendAlpha, I.premultipliedAlpha), o.setFunc(I.depthFunc), o.setTest(I.depthTest), o.setMask(I.depthWrite), r.setMask(I.colorWrite);
    const q = I.stencilWrite;
    a.setTest(q), q && (a.setMask(I.stencilWriteMask), a.setFunc(I.stencilFunc, I.stencilRef, I.stencilFuncMask), a.setOp(I.stencilFail, I.stencilZFail, I.stencilZPass)), it(I.polygonOffset, I.polygonOffsetFactor, I.polygonOffsetUnits), I.alphaToCoverage === true ? re(s.SAMPLE_ALPHA_TO_COVERAGE) : be(s.SAMPLE_ALPHA_TO_COVERAGE);
  }
  function ze(I) {
    y !== I && (I ? s.frontFace(s.CW) : s.frontFace(s.CCW), y = I);
  }
  function ke(I) {
    I !== lh ? (re(s.CULL_FACE), I !== P && (I === Oa ? s.cullFace(s.BACK) : I === ch ? s.cullFace(s.FRONT) : s.cullFace(s.FRONT_AND_BACK))) : be(s.CULL_FACE), P = I;
  }
  function ye(I) {
    I !== G && (V && s.lineWidth(I), G = I);
  }
  function it(I, ne, H) {
    I ? (re(s.POLYGON_OFFSET_FILL), (k !== ne || Y !== H) && (s.polygonOffset(ne, H), k = ne, Y = H)) : be(s.POLYGON_OFFSET_FILL);
  }
  function _e(I) {
    I ? re(s.SCISSOR_TEST) : be(s.SCISSOR_TEST);
  }
  function T(I) {
    I === void 0 && (I = s.TEXTURE0 + $ - 1), se !== I && (s.activeTexture(I), se = I);
  }
  function x(I, ne, H) {
    H === void 0 && (se === null ? H = s.TEXTURE0 + $ - 1 : H = se);
    let q = he[H];
    q === void 0 && (q = { type: void 0, texture: void 0 }, he[H] = q), (q.type !== I || q.texture !== ne) && (se !== H && (s.activeTexture(H), se = H), s.bindTexture(I, ne || me[I]), q.type = I, q.texture = ne);
  }
  function F() {
    const I = he[se];
  ...
  function we(I) {
    tt.equals(I) === false && (s.scissor(I.x, I.y, I.z, I.w), tt.copy(I));
  }
  function fe(I) {
  ...
  function He(I, ne) {
    ...
    let q = H.get(I);
    q === void 0 && (q = s.getUniformBlockIndex(ne, I.name), H.set(I, q));
  }
  function De(I, ne) {
    const q = c.get(ne).get(I);
    l.get(ne) !== q && (s.uniformBlockBinding(ne, q, I.__bindingPointIndex), l.set(ne, q));
  }
  function nt() {
    s.disable(s.BLEND), s.disable(s.CULL_FACE), s.disable(s.DEPTH_TEST), s.disable(s.POLYGON_OFFSET_FILL), s.disable(s.SCISSOR_TEST), s.disable(s.STENCIL_TEST), s.disable(s.SAMPLE_ALPHA_TO_COVERAGE), s.blendEquation(s.FUNC_ADD), s.blendFunc(s.ONE, s.ZERO), s.blendFuncSeparate(s.ONE, s.ZERO, s.ONE, s.ZERO), s.blendColor(0, 0, 0, 0), s.colorMask(true, true, true, true), s.clearColor(0, 0, 0, 0), s.depthMask(true), s.depthFunc(s.LESS), o.setReversed(false), s.clearDepth(1), s.stencilMask(4294967295), s.stencilFunc(s.ALWAYS, 0, 4294967295), s.stencilOp(s.KEEP, s.KEEP, s.KEEP), s.clearStencil(0), s.cullFace(s.BACK), s.frontFace(s.CCW), s.polygonOffset(0, 0), s.activeTexture(s.TEXTURE0), s.bindFramebuffer(s.FRAMEBUFFER, null), s.bindFramebuffer(s.DRAW_FRAMEBUFFER, null), s.bindFramebuffer(s.READ_FRAMEBUFFER, null), s.useProgram(null), s.lineWidth(1), s.scissor(0, 0, s.canvas.width, s.canvas.height), s.viewport(0, 0, s.canvas.width, s.canvas.height), h = {}, se = null, he = {}, u = {}, d = /* @__PURE__ */ new WeakMap(), p = [], g = null, _ = false, m = null, f = null, E = null, b = null, M = null, L = null, w = null, A = new ve(0, 0, 0), U = 0, S = false, y = null, P = null, G = null, k = null, Y = null, tt.set(0, 0, s.canvas.width, s.canvas.height), X.set(0, 0, s.canvas.width, s.canvas.height), r.reset(), o.reset(), a.reset();
  }
  return { buffers: { color: r, depth: o, stencil: a }, enable: re, disable: be, bindFramebuffer: Ye, drawBuffers: Ae, useProgram: ut, setBlending: C, setMaterial: kt, setFlipSided: ze, setCullFace: ke, setLineWidth: ye, setPolygonOffset: it, setScissorTest: _e, activeTexture: T, bindTexture: x, unbindTexture: F, compressedTexImage2D: j, compressedTexImage3D: Z, texImage2D: de, texImage3D: Te, updateUBOMapping: He, uniformBlockBinding: De, texStorage2D: Ge, texStorage3D: Q, texSubImage2D: W, texSubImage3D: ge, compressedTexSubImage2D: oe, compressedTexSubImage3D: ue, scissor: we, viewport: fe, reset: nt };
}
function l_(s, e, t, n, i, r, o) {
  ...
  function _(T, x, F) {
    ...
    if ((Z.width > F || Z.height > F) && (j = F / Math.max(Z.width, Z.height)), j < 1) if (typeof HTMLImageElement < "u" && T instanceof HTMLImageElement || typeof HTMLCanvasElement < "u" && T instanceof HTMLCanvasElement || typeof ImageBitmap < "u" && T instanceof ImageBitmap || typeof VideoFrame < "u" && T instanceof VideoFrame) {
      const W = Math.floor(j * Z.width), ge = Math.floor(j * Z.height);
      u === void 0 && (u = g(W, ge));
      const oe = x ? g(W, ge) : u;
  ...
  function b(T, x, F, j, Z = false) {
    ...
    if (x === s.RED && (F === s.FLOAT && (W = s.R32F), F === s.HALF_FLOAT && (W = s.R16F), F === s.UNSIGNED_BYTE && (W = s.R8)), x === s.RED_INTEGER && (F === s.UNSIGNED_BYTE && (W = s.R8UI), F === s.UNSIGNED_SHORT && (W = s.R16UI), F === s.UNSIGNED_INT && (W = s.R32UI), F === s.BYTE && (W = s.R8I), F === s.SHORT && (W = s.R16I), F === s.INT && (W = s.R32I)), x === s.RG && (F === s.FLOAT && (W = s.RG32F), F === s.HALF_FLOAT && (W = s.RG16F), F === s.UNSIGNED_BYTE && (W = s.RG8)), x === s.RG_INTEGER && (F === s.UNSIGNED_BYTE && (W = s.RG8UI), F === s.UNSIGNED_SHORT && (W = s.RG16UI), F === s.UNSIGNED_INT && (W = s.RG32UI), F === s.BYTE && (W = s.RG8I), F === s.SHORT && (W = s.RG16I), F === s.INT && (W = s.RG32I)), x === s.RGB_INTEGER && (F === s.UNSIGNED_BYTE && (W = s.RGB8UI), F === s.UNSIGNED_SHORT && (W = s.RGB16UI), F === s.UNSIGNED_INT && (W = s.RGB32UI), F === s.BYTE && (W = s.RGB8I), F === s.SHORT && (W = s.RGB16I), F === s.INT && (W = s.RGB32I)), x === s.RGBA_INTEGER && (F === s.UNSIGNED_BYTE && (W = s.RGBA8UI), F === s.UNSIGNED_SHORT && (W = s.RGBA16UI), F === s.UNSIGNED_INT && (W = s.RGBA32UI), F === s.BYTE && (W = s.RGBA8I), F === s.SHORT && (W = s.RGBA16I), F === s.INT && (W = s.RGBA32I)), x === s.RGB && F === s.UNSIGNED_INT_5_9_9_9_REV && (W = s.RGB9_E5), x === s.RGBA) {
      const ge = Z ? _r : Ve.getTransfer(j);
  ...
  function M(T, x) {
    let F;
    return T ? x === null || x === ii || x === Bi ? F = s.DEPTH24_STENCIL8 : x === tn ? F = s.DEPTH32F_STENCIL8 : x === ms && (F = s.DEPTH24_STENCIL8, console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")) : x === null || x === ii || x === Bi ? F = s.DEPTH_COMPONENT24 : x === tn ? F = s.DEPTH_COMPONENT32F : x === ms && (F = s.DEPTH_COMPONENT16), F;
  }
  function L(T, x) {
    return m(T) === true || T.isFramebufferTexture && T.minFilter !== Lt && T.minFilter !== zt ? Math.log2(Math.max(x.width, x.height)) + 1 : T.mipmaps !== void 0 && T.mipmaps.length > 0 ? T.mipmaps.length : T.isCompressedTexture && Array.isArray(T.image) ? x.mipmaps.length : 1;
  }
  function w(T) {
    const x = T.target;
  ...
  function U(T) {
    ...
    const F = T.source, j = d.get(F);
    if (j) {
      const Z = j[x.__cacheKey];
      Z.usedTimes--, Z.usedTimes === 0 && S(T), Object.keys(j).length === 0 && d.delete(F);
    }
    n.remove(T);
  }
  function S(T) {
  ...
  function y(T) {
    ...
    if (T.depthTexture && (T.depthTexture.dispose(), n.remove(T.depthTexture)), T.isWebGLCubeRenderTarget) for (let j = 0; j < 6; j++) {
      if (Array.isArray(x.__webglFramebuffer[j])) for (let Z = 0; Z < x.__webglFramebuffer[j].length; Z++) s.deleteFramebuffer(x.__webglFramebuffer[j][Z]);
    ...
    for (let j = 0, Z = F.length; j < Z; j++) {
      const W = n.get(F[j]);
      W.__webglTexture && (s.deleteTexture(W.__webglTexture), o.memory.textures--), n.remove(F[j]);
    }
    n.remove(T);
  }
  let P = 0;
  ...
  const se = { [Oi]: s.REPEAT, [Bn]: s.CLAMP_TO_EDGE, [gr]: s.MIRRORED_REPEAT }, he = { [Lt]: s.NEAREST, [mc]: s.NEAREST_MIPMAP_NEAREST, [cs]: s.NEAREST_MIPMAP_LINEAR, [zt]: s.LINEAR, [cr]: s.LINEAR_MIPMAP_NEAREST, [bn]: s.LINEAR_MIPMAP_LINEAR }, Me = { [Wh]: s.NEVER, [Kh]: s.ALWAYS, [Xh]: s.LESS, [Ac]: s.LEQUAL, [Yh]: s.EQUAL, [$h]: s.GEQUAL, [jh]: s.GREATER, [qh]: s.NOTEQUAL };
  function Fe(T, x) {
    if (x.type === tn && e.has("OES_texture_float_linear") === false && (x.magFilter === zt || x.magFilter === cr || x.magFilter === cs || x.magFilter === bn || x.minFilter === zt || x.minFilter === cr || x.minFilter === cs || x.minFilter === bn) && console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."), s.texParameteri(T, s.TEXTURE_WRAP_S, se[x.wrapS]), s.texParameteri(T, s.TEXTURE_WRAP_T, se[x.wrapT]), (T === s.TEXTURE_3D || T === s.TEXTURE_2D_ARRAY) && s.texParameteri(T, s.TEXTURE_WRAP_R, se[x.wrapR]), s.texParameteri(T, s.TEXTURE_MAG_FILTER, he[x.magFilter]), s.texParameteri(T, s.TEXTURE_MIN_FILTER, he[x.minFilter]), x.compareFunction && (s.texParameteri(T, s.TEXTURE_COMPARE_MODE, s.COMPARE_REF_TO_TEXTURE), s.texParameteri(T, s.TEXTURE_COMPARE_FUNC, Me[x.compareFunction])), e.has("EXT_texture_filter_anisotropic") === true) {
      if (x.magFilter === Lt || x.minFilter !== cs && x.minFilter !== bn || x.type === tn && e.has("OES_texture_float_linear") === false) return;
  ...
  function X(T, x, F) {
    ...
    t.bindTexture(j, T.__webglTexture, s.TEXTURE0 + F);
    const ge = n.get(W);
    if (W.version !== ge.__version || Z === true) {
      ...
      Fe(j, x);
      let fe;
      const He = x.mipmaps, De = x.isVideoTexture !== true, nt = ge.__version === void 0 || Z === true, I = W.dataReady, ne = L(x, Q);
      if (x.isDepthTexture) we = M(x.format === zi, x.type), nt && (De ? t.texStorage2D(s.TEXTURE_2D, 1, we, Q.width, Q.height) : t.texImage2D(s.TEXTURE_2D, 0, we, Q.width, Q.height, 0, de, Te, null));
      else if (x.isDataTexture) if (He.length > 0) {
        De && nt && t.texStorage2D(s.TEXTURE_2D, ne, we, He[0].width, He[0].height);
        for (let H = 0, q = He.length; H < q; H++) fe = He[H], De ? I && t.texSubImage2D(s.TEXTURE_2D, H, 0, 0, fe.width, fe.height, de, Te, fe.data) : t.texImage2D(s.TEXTURE_2D, H, we, fe.width, fe.height, 0, de, Te, fe.data);
        x.generateMipmaps = false;
      } else De ? (nt && t.texStorage2D(s.TEXTURE_2D, ne, we, Q.width, Q.height), I && t.texSubImage2D(s.TEXTURE_2D, 0, 0, 0, Q.width, Q.height, de, Te, Q.data)) : t.texImage2D(s.TEXTURE_2D, 0, we, Q.width, Q.height, 0, de, Te, Q.data);
      else if (x.isCompressedTexture) if (x.isCompressedArrayTexture) {
        De && nt && t.texStorage3D(s.TEXTURE_2D_ARRAY, ne, we, He[0].width, He[0].height, Q.depth);
        ...
        else De ? I && t.texSubImage3D(s.TEXTURE_2D_ARRAY, H, 0, 0, 0, fe.width, fe.height, Q.depth, de, Te, fe.data) : t.texImage3D(s.TEXTURE_2D_ARRAY, H, we, fe.width, fe.height, Q.depth, 0, de, Te, fe.data);
      } else {
        De && nt && t.texStorage2D(s.TEXTURE_2D, ne, we, He[0].width, He[0].height);
        for (let H = 0, q = He.length; H < q; H++) fe = He[H], x.format !== Yt ? de !== null ? De ? I && t.compressedTexSubImage2D(s.TEXTURE_2D, H, 0, 0, fe.width, fe.height, de, fe.data) : t.compressedTexImage2D(s.TEXTURE_2D, H, we, fe.width, fe.height, 0, fe.data) : console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()") : De ? I && t.texSubImage2D(s.TEXTURE_2D, H, 0, 0, fe.width, fe.height, de, Te, fe.data) : t.texImage2D(s.TEXTURE_2D, H, we, fe.width, fe.height, 0, de, Te, fe.data);
      }
      else if (x.isDataArrayTexture) if (De) {
        if (nt && t.texStorage3D(s.TEXTURE_2D_ARRAY, ne, we, Q.width, Q.height, Q.depth), I) if (x.layerUpdates.size > 0) {
      ...
      else if (x.isData3DTexture) De ? (nt && t.texStorage3D(s.TEXTURE_3D, ne, we, Q.width, Q.height, Q.depth), I && t.texSubImage3D(s.TEXTURE_3D, 0, 0, 0, 0, Q.width, Q.height, Q.depth, de, Te, Q.data)) : t.texImage3D(s.TEXTURE_3D, 0, we, Q.width, Q.height, Q.depth, 0, de, Te, Q.data);
      else if (x.isFramebufferTexture) {
        if (nt) if (De) t.texStorage2D(s.TEXTURE_2D, ne, we, Q.width, Q.height);
        else {
        ...
        for (let H = 0, q = He.length; H < q; H++) fe = He[H], De ? I && t.texSubImage2D(s.TEXTURE_2D, H, 0, 0, de, Te, fe) : t.texImage2D(s.TEXTURE_2D, H, we, de, Te, fe);
        x.generateMipmaps = false;
      } else if (De) {
        if (nt) {
          const H = _e(Q);
        ...
        I && t.texSubImage2D(s.TEXTURE_2D, 0, 0, 0, de, Te, Q);
      } else t.texImage2D(s.TEXTURE_2D, 0, we, de, Te, Q);
      m(x) && f(j), ge.__version = W.version, x.onUpdate && x.onUpdate(x);
    }
    T.__version = x.version;
  }
  function ee(T, x, F) {
    if (x.image.length !== 6) return;
    const j = tt(T, x), Z = x.source;
    t.bindTexture(s.TEXTURE_CUBE_MAP, T.__webglTexture, s.TEXTURE0 + F);
    const W = n.get(Z);
    if (Z.version !== W.__version || j === true) {
      t.activeTexture(s.TEXTURE0 + F);
      ...
      if (Ge) {
        ...
        for (let q = 0; q < 6; q++) if (Q) {
          De ? I && t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X + q, 0, 0, 0, de[q].width, de[q].height, we, fe, de[q].data) : t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X + q, 0, He, de[q].width, de[q].height, 0, we, fe, de[q].data);
          for (let le = 0; le < H.length; le++) {
            const Ie = H[le].image[q].image;
            De ? I && t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X + q, le + 1, 0, 0, Ie.width, Ie.height, we, fe, Ie.data) : t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X + q, le + 1, He, Ie.width, Ie.height, 0, we, fe, Ie.data);
          }
        } else {
          De ? I && t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X + q, 0, 0, 0, we, fe, de[q]) : t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X + q, 0, He, we, fe, de[q]);
          for (let le = 0; le < H.length; le++) {
            const ae = H[le];
            De ? I && t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X + q, le + 1, 0, 0, we, fe, ae.image[q]) : t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X + q, le + 1, He, we, fe, ae.image[q]);
          }
        }
      }
  ...
  function me(T, x, F, j, Z, W) {
    ...
    t.bindFramebuffer(s.FRAMEBUFFER, T), ke(x) ? a.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER, j, Z, Q.__webglTexture, 0, ze(x)) : (Z === s.TEXTURE_2D || Z >= s.TEXTURE_CUBE_MAP_POSITIVE_X && Z <= s.TEXTURE_CUBE_MAP_NEGATIVE_Z) && s.framebufferTexture2D(s.FRAMEBUFFER, j, Z, Q.__webglTexture, W), t.bindFramebuffer(s.FRAMEBUFFER, null);
  }
  function re(T, x, F) {
    if (s.bindRenderbuffer(s.RENDERBUFFER, T), x.depthBuffer) {
      const j = x.depthTexture, Z = j && j.isDepthTexture ? j.type : null, W = M(x.stencilBuffer, Z), ge = x.stencilBuffer ? s.DEPTH_STENCIL_ATTACHMENT : s.DEPTH_ATTACHMENT, oe = ze(x);
      ...
      for (let Z = 0; Z < j.length; Z++) {
        const W = j[Z], ge = r.convert(W.format, W.colorSpace), oe = r.convert(W.type), ue = b(W.internalFormat, ge, oe, W.colorSpace), Ge = ze(x);
  ...
  function be(T, x) {
    ...
    const Z = j.__webglTexture, W = ze(x);
    if (x.depthTexture.format === Li) ke(x) ? a.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER, s.DEPTH_ATTACHMENT, s.TEXTURE_2D, Z, 0, W) : s.framebufferTexture2D(s.FRAMEBUFFER, s.DEPTH_ATTACHMENT, s.TEXTURE_2D, Z, 0);
    else if (x.depthTexture.format === zi) ke(x) ? a.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER, s.DEPTH_STENCIL_ATTACHMENT, s.TEXTURE_2D, Z, 0, W) : s.framebufferTexture2D(s.FRAMEBUFFER, s.DEPTH_STENCIL_ATTACHMENT, s.TEXTURE_2D, Z, 0);
  ...
  function Ye(T) {
    ...
    if (x.__boundDepthTexture !== T.depthTexture) {
      ...
      if (x.__depthDisposeCallback && x.__depthDisposeCallback(), j) {
        const Z = () => {
          delete x.__boundDepthTexture, delete x.__depthDisposeCallback, j.removeEventListener("dispose", Z);
        };
        j.addEventListener("dispose", Z), x.__depthDisposeCallback = Z;
      }
    ...
    if (T.depthTexture && !x.__autoAllocateDepthBuffer) {
      ...
      x.__webglDepthbuffer = [];
      for (let j = 0; j < 6; j++) if (t.bindFramebuffer(s.FRAMEBUFFER, x.__webglFramebuffer[j]), x.__webglDepthbuffer[j] === void 0) x.__webglDepthbuffer[j] = s.createRenderbuffer(), re(x.__webglDepthbuffer[j], T, false);
      else {
        const Z = T.stencilBuffer ? s.DEPTH_STENCIL_ATTACHMENT : s.DEPTH_ATTACHMENT, W = x.__webglDepthbuffer[j];
      ...
      const j = T.stencilBuffer ? s.DEPTH_STENCIL_ATTACHMENT : s.DEPTH_ATTACHMENT, Z = x.__webglDepthbuffer;
  ...
  function Ae(T, x, F) {
    const j = n.get(T);
    x !== void 0 && me(j.__webglFramebuffer, T, T.texture, s.COLOR_ATTACHMENT0, s.TEXTURE_2D, 0), F !== void 0 && Ye(T);
  }
  function ut(T) {
    const x = T.texture, F = n.get(T), j = n.get(x);
    T.addEventListener("dispose", A);
    const Z = T.textures, W = T.isWebGLCubeRenderTarget === true, ge = Z.length > 1;
    if (ge || (j.__webglTexture === void 0 && (j.__webglTexture = s.createTexture()), j.__version = x.version, o.memory.textures++), W) {
    ...
    if (W) {
      ...
      let oe = s.TEXTURE_2D;
      if ((T.isWebGL3DRenderTarget || T.isWebGLArrayRenderTarget) && (oe = T.isWebGL3DRenderTarget ? s.TEXTURE_3D : s.TEXTURE_2D_ARRAY), t.bindTexture(oe, j.__webglTexture), Fe(oe, x), x.mipmaps && x.mipmaps.length > 0) for (let ue = 0; ue < x.mipmaps.length; ue++) me(F.__webglFramebuffer[ue], T, x, s.COLOR_ATTACHMENT0, oe, ue);
  ...
  function kt(T) {
    if (T.samples > 0) {
      if (ke(T) === false) {
        const x = T.textures, F = T.width, j = T.height;
        ...
        for (let ue = 0; ue < x.length; ue++) {
          ...
          s.blitFramebuffer(0, 0, F, j, 0, 0, F, j, Z, s.NEAREST), l === true && (Be.length = 0, C.length = 0, Be.push(s.COLOR_ATTACHMENT0 + ue), T.depthBuffer && T.resolveDepthBuffer === false && (Be.push(W), C.push(W), s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER, C)), s.invalidateFramebuffer(s.READ_FRAMEBUFFER, Be));
        }
  ...
  function it(T, x) {
    ...
    return T.isCompressedTexture === true || T.isVideoTexture === true || F !== It && F !== On && (Ve.getTransfer(F) === Qe ? (j !== Yt || Z !== Rn) && console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType.") : console.error("THREE.WebGLTextures: Unsupported texture color space:", F)), x;
  }
  function _e(T) {
...
function c_(s, e) {
  function t(n, i = On) {
    ...
    if (n === ms) return s.UNSIGNED_SHORT;
    ...
    if (n === Li) return s.DEPTH_COMPONENT;
    ...
    if (n === hr || n === ur || n === dr || n === fr) if (o === Qe) if (r = e.get("WEBGL_compressed_texture_s3tc_srgb"), r !== null) {
    ...
    if (n === Io || n === Do || n === Uo || n === No || n === Fo || n === Oo || n === Bo || n === zo || n === ko || n === Ho || n === Vo || n === Go || n === Wo || n === Xo) if (r = e.get("WEBGL_compressed_texture_astc"), r !== null) {
      if (n === Io) return o === Qe ? r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR : r.COMPRESSED_RGBA_ASTC_4x4_KHR;
    ...
    if (n === pr || n === Yo || n === jo) if (r = e.get("EXT_texture_compression_bptc"), r !== null) {
      if (n === pr) return o === Qe ? r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT : r.COMPRESSED_RGBA_BPTC_UNORM_EXT;
...
class d_ {
  ...
  getMesh(e) {
    if (this.texture !== null && this.mesh === null) {
      const t = e.cameras[0].viewport, n = new Vn({ vertexShader: h_, fragmentShader: u_, uniforms: { depthColor: { value: this.texture }, depthWidth: { value: t.z }, depthHeight: { value: t.w } } });
      this.mesh = new at(new Er(20, 20), n);
    }
    return this.mesh;
  }
  reset() {
...
class f_ extends ri {
  constructor(e, t) {
    ...
    function Y() {
      i.removeEventListener("select", k), i.removeEventListener("selectstart", k), i.removeEventListener("selectend", k), i.removeEventListener("squeeze", k), i.removeEventListener("squeezestart", k), i.removeEventListener("squeezeend", k), i.removeEventListener("end", Y), i.removeEventListener("inputsourceschange", $);
    ...
    function $(X) {
      ...
      for (let ee = 0; ee < X.added.length; ee++) {
        ...
        let re = M.indexOf(me);
        if (re === -1) {
          for (let Ye = 0; Ye < b.length; Ye++) if (Ye >= M.length) {
            M.push(me), re = Ye;
            break;
          } else if (M[Ye] === null) {
            M[Ye] = me, re = Ye;
    ...
    function z(X, ee, me) {
      ...
      const re = V.distanceTo(K), be = ee.projectionMatrix.elements, Ye = me.projectionMatrix.elements, Ae = be[14] / (be[10] - 1), ut = be[14] / (be[10] + 1), ot = (be[9] + 1) / be[5], Be = (be[9] - 1) / be[5], C = (be[8] - 1) / be[0], kt = (Ye[8] + 1) / Ye[0], ze = Ae * C, ke = Ae * kt, ye = re / (-C + kt), it = ye * -C;
      if (ee.matrixWorld.decompose(X.position, X.quaternion, X.scale), X.translateX(it), X.translateZ(ye), X.matrixWorld.compose(X.position, X.quaternion, X.scale), X.matrixWorldInverse.copy(X.matrixWorld).invert(), be[10] === -1) X.projectionMatrix.copy(ee.projectionMatrix), X.projectionMatrixInverse.copy(ee.projectionMatrixInverse);
      else {
        const _e = Ae + ye, T = ut + ye, x = ze - it, F = ke + (re - it), j = ot * ut / T * _e, Z = Be * ut / T * _e;
        X.projectionMatrix.makePerspective(x, F, j, Z, _e, T), X.projectionMatrixInverse.copy(X.projectionMatrix).invert();
      }
    }
    function se(X, ee) {
    ...
    this.updateCamera = function(X) {
      ...
      _.texture !== null && (_.depthNear > 0 && (ee = _.depthNear), _.depthFar > 0 && (me = _.depthFar)), y.near = U.near = A.near = ee, y.far = U.far = A.far = me, (P !== y.near || G !== y.far) && (i.updateRenderState({ depthNear: y.near, depthFar: y.far }), P = y.near, G = y.far), A.layers.mask = X.layers.mask | 2, U.layers.mask = X.layers.mask | 4, y.layers.mask = A.layers.mask | U.layers.mask;
      const re = X.parent, be = y.cameras;
      se(y, re);
      for (let Ye = 0; Ye < be.length; Ye++) se(be[Ye], re);
      be.length === 2 ? z(y, A, U) : y.projectionMatrix.copy(A.projectionMatrix), he(X, y, re);
    };
    function he(X, ee, me) {
      me === null ? X.matrix.copy(ee.matrixWorld) : (X.matrix.copy(me.matrixWorld), X.matrix.invert(), X.matrix.multiply(ee.matrixWorld)), X.matrix.decompose(X.position, X.quaternion, X.scale), X.updateMatrixWorld(true), X.projectionMatrix.copy(ee.projectionMatrix), X.projectionMatrixInverse.copy(ee.projectionMatrixInverse), X.isPerspectiveCamera && (X.fov = ki * 2 * Math.atan(1 / X.projectionMatrix.elements[5]), X.zoom = 1);
    }
    ...
    function Fe(X, ee) {
      if (h = ee.getViewerPose(c || o), g = ee, h !== null) {
        ...
        for (let Ae = 0; Ae < me.length; Ae++) {
          const ut = me[Ae];
          let ot = null;
          if (p !== null) ot = p.getViewport(ut);
          else {
            const C = u.getViewSubImage(d, ut);
            ot = C.viewport, Ae === 0 && (e.setRenderTargetTextures(E, C.colorTexture, d.ignoreDepthValues ? void 0 : C.depthStencilTexture), e.setRenderTarget(E));
          }
          let Be = S[Ae];
...
function m_(s, e) {
  ...
  function r(m, f) {
    ...
    b && (m.envMap.value = b, Kn.copy(M), Kn.x *= -1, Kn.y *= -1, Kn.z *= -1, b.isCubeTexture && b.isRenderTargetTexture === false && (Kn.y *= -1, Kn.z *= -1), m.envMapRotation.value.setFromMatrix4(p_.makeRotationFromEuler(Kn)), m.flipEnvMap.value = b.isCubeTexture && b.isRenderTargetTexture === false ? -1 : 1, m.reflectivity.value = f.reflectivity, m.ior.value = f.ior, m.refractionRatio.value = f.refractionRatio), f.lightMap && (m.lightMap.value = f.lightMap, m.lightMapIntensity.value = f.lightMapIntensity, t(f.lightMap, m.lightMapTransform)), f.aoMap && (m.aoMap.value = f.aoMap, m.aoMapIntensity.value = f.aoMapIntensity, t(f.aoMap, m.aoMapTransform));
  }
  function o(m, f) {
    ...
    for (let w = 0, A = M.length; w < A; w++) {
      ...
      for (let S = 0, y = U.length; S < y; S++) {
        ...
        if (p(P, w, S, L) === true) {
          ...
          for (let $ = 0; $ < k.length; $++) {
            const V = k[$], K = _(V);
            typeof V == "number" || typeof V == "boolean" ? (P.__data[0] = V, s.bufferSubData(s.UNIFORM_BUFFER, G + Y, P.__data)) : V.isMatrix3 ? (P.__data[0] = V.elements[0], P.__data[1] = V.elements[1], P.__data[2] = V.elements[2], P.__data[3] = 0, P.__data[4] = V.elements[3], P.__data[5] = V.elements[4], P.__data[6] = V.elements[5], P.__data[7] = 0, P.__data[8] = V.elements[6], P.__data[9] = V.elements[7], P.__data[10] = V.elements[8], P.__data[11] = 0) : (V.toArray(P.__data, Y), Y += K.storage / Float32Array.BYTES_PER_ELEMENT);
          }
    ...
    for (let A = 0, U = b.length; A < U; A++) {
      ...
      for (let y = 0, P = S.length; y < P; y++) {
        ...
        for (let Y = 0, $ = k.length; Y < $; Y++) {
          const V = k[Y], K = _(V), z = M % L, se = z % K.boundary, he = z + se;
...
class Jc {
  constructor(e = {}) {
    const { canvas: t = fu(), context: n = null, depth: i = true, stencil: r = false, alpha: o = false, antialias: a = false, premultipliedAlpha: l = true, preserveDrawingBuffer: c = false, powerPreference: h = "default", failIfMajorPerformanceCaveat: u = false, reverseDepthBuffer: d = false } = e;
    ...
    let m = null, f = null;
    const E = [], b = [];
    this.domElement = t, this.debug = { checkShaderErrors: true, onShaderError: null }, this.autoClear = true, this.autoClearColor = true, this.autoClearDepth = true, this.autoClearStencil = true, this.sortObjects = true, this.clippingPlanes = [], this.localClippingEnabled = false, this._outputColorSpace = yt, this.toneMapping = Hn, this.toneMappingExposure = 1;
    const M = this;
    let L = false, w = 0, A = 0, U = null, S = -1, y = null;
    const P = new je(), G = new je();
    let k = null;
    const Y = new ve(0);
    let $ = 0, V = t.width, K = t.height, z = 1, se = null, he = null;
    const Me = new je(0, 0, V, K), Fe = new je(0, 0, V, K);
    let tt = false;
    const X = new ya();
    let ee = false, me = false;
    this.transmissionResolutionScale = 1;
    const re = new Pe(), be = new Pe(), Ye = new R(), Ae = new je(), ut = { background: null, fog: null, environment: null, overrideMaterial: null, isScene: true };
    let ot = false;
    function Be() {
      return U === null ? z : 1;
    }
    ...
    try {
      ...
      if ("setAttribute" in t && t.setAttribute("data-engine", `three.js r${oa}`), t.addEventListener("webglcontextlost", q, false), t.addEventListener("webglcontextrestored", le, false), t.addEventListener("webglcontextcreationerror", ae, false), C === null) {
        const D = "webgl2";
        if (C = kt(D, v), C === null) throw kt(D) ? new Error("Error creating WebGL context with your selected attributes.") : new Error("Error creating WebGL context.");
      }
    } catch (v) {
      throw console.error("THREE.WebGLRenderer: " + v.message), v;
    }
    let ze, ke, ye, it, _e, T, x, F, j, Z, W, ge, oe, ue, Ge, Q, de, Te, we, fe, He, De, nt, I;
    function ne() {
      ze = new wm(C), ze.init(), De = new c_(C, ze), ke = new Mm(C, ze, e, De), ye = new a_(C, ze), ke.reverseDepthBuffer && d && ye.buffers.depth.setReversed(true), it = new Pm(C), _e = new qg(), T = new l_(C, ze, ye, _e, ke, De, it), x = new Sm(M), F = new Am(M), j = new Nd(C), nt = new xm(C, j), Z = new Rm(C, j, it, nt), W = new Im(C, Z, j, it), we = new Lm(C, ke, T), Q = new ym(_e), ge = new jg(M, x, F, ze, ke, nt, Q), oe = new m_(M, _e), ue = new Kg(), Ge = new n_(ze), Te = new _m(M, x, F, ye, W, p, l), de = new r_(M, W, ke), I = new g_(C, it, ke, ye), fe = new vm(C, ze, it), He = new Cm(C, ze, it), it.programs = ge.programs, M.capabilities = ke, M.extensions = ze, M.properties = _e, M.renderLists = ue, M.shadowMap = de, M.state = ye, M.info = it;
    }
    ne();
    const H = new f_(M, C);
    this.xr = H, this.getContext = function() {
      ...
      V = v, K = D, t.width = Math.floor(v * z), t.height = Math.floor(D * z), O === true && (t.style.width = v + "px", t.style.height = D + "px"), this.setViewport(0, 0, v, D);
    }, this.getDrawingBufferSize = function(v) {
      return v.set(V * z, K * z).floor();
    }, this.setDrawingBufferSize = function(v, D, O) {
      V = v, K = D, z = O, t.width = Math.floor(v * O), t.height = Math.floor(D * O), this.setViewport(0, 0, v, D);
    }, this.getCurrentViewport = function(v) {
      return v.copy(P);
    }, this.getViewport = function(v) {
      return v.copy(Me);
    }, this.setViewport = function(v, D, O, B) {
      v.isVector4 ? Me.set(v.x, v.y, v.z, v.w) : Me.set(v, D, O, B), ye.viewport(P.copy(Me).multiplyScalar(z).round());
    }, this.getScissor = function(v) {
      return v.copy(Fe);
    }, this.setScissor = function(v, D, O, B) {
      v.isVector4 ? Fe.set(v.x, v.y, v.z, v.w) : Fe.set(v, D, O, B), ye.scissor(G.copy(Fe).multiplyScalar(z).round());
      ...
      if (v) {
        ...
        if (N) {
          const J = U.texture.type, ie = J === Rn || J === ii || J === ms || J === Bi || J === ca || J === ha, ce = Te.getClearColor(), pe = Te.getClearAlpha(), Re = ce.r, Ce = ce.g, Se = ce.b;
      ...
      t.removeEventListener("webglcontextlost", q, false), t.removeEventListener("webglcontextrestored", le, false), t.removeEventListener("webglcontextcreationerror", ae, false), Te.dispose(), ue.dispose(), Ge.dispose(), _e.dispose(), x.dispose(), F.dispose(), W.dispose(), nt.dispose(), I.dispose(), ge.dispose(), H.dispose(), H.removeEventListener("sessionstart", Pa), H.removeEventListener("sessionend", La), Gn.stop();
    };
    function q(v) {
    ...
    function Ie(v) {
      const D = v.target;
      D.removeEventListener("dispose", Ie), lt(D);
    }
    function lt(v) {
      bt(v), _e.remove(v);
    }
    ...
    this.renderBufferDirect = function(v, D, O, B, N, J) {
      D === null && (D = ut);
      const ie = N.isMesh && N.matrixWorld.determinant() < 0, ce = nh(v, D, O, B, N);
      ye.setMaterial(B, ie);
      let pe = O.index, Re = 1;
      if (B.wireframe === true) {
      ...
      let ct, Xe = fe;
      if (pe !== null && (ct = j.get(pe), Xe = He, Xe.setIndex(ct)), N.isMesh) B.wireframe === true ? (ye.setLineWidth(B.wireframeLinewidth * Be()), Xe.setMode(C.LINES)) : Xe.setMode(C.TRIANGLES);
      else if (N.isLine) {
        let Ee = B.linewidth;
      ...
      if (N.isBatchedMesh) if (N._multiDrawInstances !== null) Jn("THREE.WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."), Xe.renderMultiDrawInstances(N._multiDrawStarts, N._multiDrawCounts, N._multiDrawCount, N._multiDrawInstances);
      else if (ze.get("WEBGL_multi_draw")) Xe.renderMultiDraw(N._multiDrawStarts, N._multiDrawCounts, N._multiDrawCount);
      else {
        const Ee = N._multiDrawStarts, Et = N._multiDrawCounts, $e = N._multiDrawCount, Kt = pe ? j.get(pe).bytesPerElement : 1, ai = _e.get(B).currentProgram.getUniforms();
        for (let Ft = 0; Ft < $e; Ft++) ai.setValue(C, "_gl_DrawID", Ft), Xe.render(Ee[Ft] / Kt, Et[Ft]);
      }
    ...
    function Ke(v, D, O) {
      v.transparent === true && v.side === ln && v.forceSinglePass === false ? (v.side = Nt, v.needsUpdate = true, Ls(v, D, O), v.side = wn, v.needsUpdate = true, Ls(v, D, O), v.side = ln) : Ls(v, D, O);
    }
    this.compile = function(v, D, O = null) {
      O === null && (O = v), f = Ge.get(O), f.init(D), b.push(f), O.traverseVisible(function(N) {
    ...
    const Gn = new jc();
    Gn.setAnimationLoop(mn), typeof self < "u" && Gn.setContext(self), this.setAnimationLoop = function(v) {
      $t = v, H.setAnimationLoop(v), v === null ? Gn.stop() : Gn.start();
    }, H.addEventListener("sessionstart", Pa), H.addEventListener("sessionend", La), this.render = function(v, D) {
      if (D !== void 0 && D.isCamera !== true) {
        console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");
        return;
      }
      if (L === true) return;
      if (v.matrixWorldAutoUpdate === true && v.updateMatrixWorld(), D.parent === null && D.matrixWorldAutoUpdate === true && D.updateMatrixWorld(), H.enabled === true && H.isPresenting === true && (H.cameraAutoUpdate === true && H.updateCamera(D), D = H.getCamera()), v.isScene === true && v.onBeforeRender(M, v, D, U), f = Ge.get(v, b.length), f.init(D), b.push(f), be.multiplyMatrices(D.projectionMatrix, D.matrixWorldInverse), X.setFromProjectionMatrix(be), me = this.localClippingEnabled, ee = Q.init(this.clippingPlanes, me), m = ue.get(v, E.length), m.init(), E.push(m), H.enabled === true && H.isPresenting === true) {
        const J = M.xr.getDepthSensingMesh();
        J !== null && Ar(J, D, -1 / 0, M.sortObjects);
      }
      Ar(v, D, 0, M.sortObjects), m.finish(), M.sortObjects === true && m.sort(se, he), ot = H.enabled === false || H.isPresenting === false || H.hasDepthSensing() === false, ot && Te.addToRenderList(m, v), this.info.render.frame++, ee === true && Q.beginShadows();
      const O = f.state.shadowsArray;
      de.render(O, v, D), ee === true && Q.endShadows(), this.info.autoReset === true && this.info.reset();
      ...
      if (f.setupLights(), D.isArrayCamera) {
        ...
        for (let ie = 0, ce = J.length; ie < ce; ie++) {
          const pe = J[ie];
          Ia(m, v, pe, pe.viewport);
        }
      } else N.length > 0 && Da(B, N, v, D), ot && Te.render(v), Ia(m, v, D);
      U !== null && A === 0 && (T.updateMultisampleRenderTarget(U), T.updateRenderTargetMipmap(U)), v.isScene === true && v.onAfterRender(M, v, D), nt.resetDefaultState(), S = -1, y = null, b.pop(), b.length > 0 ? (f = b[b.length - 1], ee === true && Q.setGlobalState(M.clippingPlanes, f.state.camera)) : f = null, E.pop(), E.length > 0 ? m = E[E.length - 1] : m = null;
    };
    function Ar(v, D, O, B) {
      ...
      const J = v.children;
      for (let ie = 0, ce = J.length; ie < ce; ie++) Ar(J[ie], D, O, B);
    }
    function Ia(v, D, O, B) {
      const N = v.opaque, J = v.transmissive, ie = v.transparent;
      f.setupLightsView(O), ee === true && Q.setGlobalState(M.clippingPlanes, O), B && ye.viewport(P.copy(B)), N.length > 0 && Ps(N, D, O), J.length > 0 && Ps(J, D, O), ie.length > 0 && Ps(ie, D, O), ye.buffers.depth.setTest(true), ye.buffers.depth.setMask(true), ye.buffers.color.setMask(true), ye.setPolygonOffset(false);
    }
    function Da(v, D, O, B) {
      if ((O.isScene === true ? O.overrideMaterial : null) !== null) return;
      f.state.transmissionRenderTarget[B.id] === void 0 && (f.state.transmissionRenderTarget[B.id] = new si(1, 1, { generateMipmaps: true, type: ze.has("EXT_color_buffer_half_float") || ze.has("EXT_color_buffer_float") ? bs : Rn, minFilter: bn, samples: 4, stencilBuffer: r, resolveDepthBuffer: false, resolveStencilBuffer: false, colorSpace: Ve.workingColorSpace }));
      ...
      M.setRenderTarget(J), M.getClearColor(Y), $ = M.getClearAlpha(), $ < 1 && M.setClearColor(16777215, 0.5), M.clear(), ot && Te.render(O);
      const pe = M.toneMapping;
      M.toneMapping = Hn;
      const Re = B.viewport;
      if (B.viewport !== void 0 && (B.viewport = void 0), f.setupLightsView(B), ee === true && Q.setGlobalState(M.clippingPlanes, B), Ps(v, O, B), T.updateMultisampleRenderTarget(J), T.updateRenderTargetMipmap(J), ze.has("WEBGL_multisampled_render_to_texture") === false) {
        let Ce = false;
        for (let Se = 0, We = D.length; Se < We; Se++) {
          const qe = D[Se], pt = qe.object, ct = qe.geometry, Xe = qe.material, Ee = qe.group;
          if (Xe.side === ln && pt.layers.test(B.layers)) {
            const Et = Xe.side;
            Xe.side = Nt, Xe.needsUpdate = true, Ua(pt, O, B, ct, Xe, Ee), Xe.side = Et, Xe.needsUpdate = true, Ce = true;
          }
        }
        Ce === true && (T.updateMultisampleRenderTarget(J), T.updateRenderTargetMipmap(J));
      }
      M.setRenderTarget(ce), M.setClearColor(Y, $), Re !== void 0 && (B.viewport = Re), M.toneMapping = pe;
    }
    function Ps(v, D, O) {
      ...
      for (let N = 0, J = v.length; N < J; N++) {
        ...
        ce.layers.test(O.layers) && Ua(ce, D, O, pe, Re, Ce);
      }
    }
    function Ua(v, D, O, B, N, J) {
      v.onBeforeRender(M, D, O, B, N, J), v.modelViewMatrix.multiplyMatrices(O.matrixWorldInverse, v.matrixWorld), v.normalMatrix.getNormalMatrix(v.modelViewMatrix), N.onBeforeRender(M, D, O, B, v, J), N.transparent === true && N.side === ln && N.forceSinglePass === false ? (N.side = Nt, N.needsUpdate = true, M.renderBufferDirect(O, D, B, N, v, J), N.side = wn, N.needsUpdate = true, M.renderBufferDirect(O, D, B, N, v, J), N.side = ln) : M.renderBufferDirect(O, D, B, N, v, J), v.onAfterRender(M, D, O, B, N, J);
    }
    function Ls(v, D, O) {
      D.isScene !== true && (D = ut);
      const B = _e.get(v), N = f.state.lights, J = f.state.shadowsArray, ie = N.state.version, ce = ge.getParameters(v, N.state, J, D, O), pe = ge.getProgramCacheKey(ce);
      let Re = B.programs;
      B.environment = v.isMeshStandardMaterial ? D.environment : null, B.fog = D.fog, B.envMap = (v.isMeshStandardMaterial ? F : x).get(v.envMap || B.environment), B.envMapRotation = B.environment !== null && v.envMap === null ? D.environmentRotation : v.envMapRotation, Re === void 0 && (v.addEventListener("dispose", Ie), Re = /* @__PURE__ */ new Map(), B.programs = Re);
      let Ce = Re.get(pe);
      if (Ce !== void 0) {
    ...
    function nh(v, D, O, B, N) {
      D.isScene !== true && (D = ut), T.resetTextureUnits();
      const J = D.fog, ie = B.isMeshStandardMaterial ? D.environment : null, ce = U === null ? M.outputColorSpace : U.isXRRenderTarget === true ? U.texture.colorSpace : It, pe = (B.isMeshStandardMaterial ? F : x).get(B.envMap || ie), Re = B.vertexColors === true && !!O.attributes.color && O.attributes.color.itemSize === 4, Ce = !!O.attributes.tangent && (!!B.normalMap || B.anisotropy > 0), Se = !!O.morphAttributes.position, We = !!O.morphAttributes.normal, qe = !!O.morphAttributes.color;
      let pt = Hn;
      B.toneMapped && (U === null || U.isXRRenderTarget === true) && (pt = M.toneMapping);
      const ct = O.morphAttributes.position || O.morphAttributes.normal || O.morphAttributes.color, Xe = ct !== void 0 ? ct.length : 0, Ee = _e.get(B), Et = f.state.lights;
      ...
      let Kt = Ee.currentProgram;
      $e === true && (Kt = Ls(B, D, N));
      let ai = false, Ft = false, Ki = false;
      const st = Kt.getUniforms(), Ht = Ee.uniforms;
      if (ye.useProgram(Kt.program) && (ai = true, Ft = true, Ki = true), B.id !== S && (S = B.id, Ft = true), ai || y !== v) {
        ye.buffers.depth.getReversed() ? (re.copy(v.projectionMatrix), mu(re), gu(re), st.setValue(C, "projectionMatrix", re)) : st.setValue(C, "projectionMatrix", v.projectionMatrix), st.setValue(C, "viewMatrix", v.matrixWorldInverse);
        const Dt = st.map.cameraPosition;
        Dt !== void 0 && Dt.setValue(C, Ye.setFromMatrixPosition(v.matrixWorld)), ke.logarithmicDepthBuffer && st.setValue(C, "logDepthBufFC", 2 / (Math.log(v.far + 1) / Math.LN2)), (B.isMeshPhongMaterial || B.isMeshToonMaterial || B.isMeshLambertMaterial || B.isMeshBasicMaterial || B.isMeshStandardMaterial || B.isShaderMaterial) && st.setValue(C, "isOrthographic", v.isOrthographicCamera === true), y !== v && (y = v, Ft = true, Ki = true);
      }
      if (N.isSkinnedMesh) {
        st.setOptional(C, N, "bindMatrix"), st.setOptional(C, N, "bindMatrixInverse");
        const Rt = N.skeleton;
        Rt && (Rt.boneTexture === null && Rt.computeBoneTexture(), st.setValue(C, "boneTexture", Rt.boneTexture, T));
      }
      N.isBatchedMesh && (st.setOptional(C, N, "batchingTexture"), st.setValue(C, "batchingTexture", N._matricesTexture, T), st.setOptional(C, N, "batchingIdTexture"), st.setValue(C, "batchingIdTexture", N._indirectTexture, T), st.setOptional(C, N, "batchingColorTexture"), N._colorsTexture !== null && st.setValue(C, "batchingColorTexture", N._colorsTexture, T));
      const Vt = O.morphAttributes;
      if ((Vt.position !== void 0 || Vt.normal !== void 0 || Vt.color !== void 0) && we.update(N, O, Kt), (Ft || Ee.receiveShadow !== N.receiveShadow) && (Ee.receiveShadow = N.receiveShadow, st.setValue(C, "receiveShadow", N.receiveShadow)), B.isMeshGouraudMaterial && B.envMap !== null && (Ht.envMap.value = pe, Ht.flipEnvMap.value = pe.isCubeTexture && pe.isRenderTargetTexture === false ? -1 : 1), B.isMeshStandardMaterial && B.envMap === null && D.environment !== null && (Ht.envMapIntensity.value = D.environmentIntensity), Ft && (st.setValue(C, "toneMappingExposure", M.toneMappingExposure), Ee.needsLights && ih(Ht, Ki), J && B.fog === true && oe.refreshFogUniforms(Ht, J), oe.refreshMaterialUniforms(Ht, B, z, K, f.state.transmissionRenderTarget[v.id]), mr.upload(C, Na(Ee), Ht, T)), B.isShaderMaterial && B.uniformsNeedUpdate === true && (mr.upload(C, Na(Ee), Ht, T), B.uniformsNeedUpdate = false), B.isSpriteMaterial && st.setValue(C, "center", N.center), st.setValue(C, "modelViewMatrix", N.modelViewMatrix), st.setValue(C, "normalMatrix", N.normalMatrix), st.setValue(C, "modelMatrix", N.matrixWorld), B.isShaderMaterial || B.isRawShaderMaterial) {
        const Rt = B.uniformsGroups;
        for (let Dt = 0, wr = Rt.length; Dt < wr; Dt++) {
          const Wn = Rt[Dt];
          I.update(Wn, Kt), I.bind(Wn, Kt);
        }
      }
      return Kt;
    }
    ...
    this.setRenderTarget = function(v, D = 0, O = 0) {
      ...
      if (v) {
        ...
        v.isWebGLCubeRenderTarget ? (Array.isArray(Ce[D]) ? N = Ce[D][O] : N = Ce[D], J = true) : v.samples > 0 && T.useMultisampledRTT(v) === false ? N = _e.get(v).__webglMultisampledFramebuffer : Array.isArray(Ce) ? N = Ce[O] : N = Ce, P.copy(v.viewport), G.copy(v.scissor), k = v.scissorTest;
      } else P.copy(Me).multiplyScalar(z).floor(), G.copy(Fe).multiplyScalar(z).floor(), k = tt;
      if (O !== 0 && (N = rh), ye.bindFramebuffer(C.FRAMEBUFFER, N) && B && ye.drawBuffers(v, N), ye.viewport(P), ye.scissor(G), ye.setScissorTest(k), J) {
        ...
        const pe = _e.get(v.texture), Re = D;
      ...
      S = -1;
    }, this.readRenderTargetPixels = function(v, D, O, B, N, J, ie) {
      ...
      if (v.isWebGLCubeRenderTarget && ie !== void 0 && (ce = ce[ie]), ce) {
        ...
        try {
          ...
          D >= 0 && D <= v.width - B && O >= 0 && O <= v.height - N && C.readPixels(D, O, B, N, De.convert(Re), De.convert(Ce), J);
        } finally {
          const pe = U !== null ? _e.get(U).__webglFramebuffer : null;
          ye.bindFramebuffer(C.FRAMEBUFFER, pe);
        }
      }
    }, this.readRenderTargetPixelsAsync = async function(v, D, O, B, N, J, ie) {
      ...
      if (v.isWebGLCubeRenderTarget && ie !== void 0 && (ce = ce[ie]), ce) {
        ...
        if (D >= 0 && D <= v.width - B && O >= 0 && O <= v.height - N) {
          ...
          C.bindBuffer(C.PIXEL_PACK_BUFFER, Se), C.bufferData(C.PIXEL_PACK_BUFFER, J.byteLength, C.STREAM_READ), C.readPixels(D, O, B, N, De.convert(Re), De.convert(Ce), 0);
          const We = U !== null ? _e.get(U).__webglFramebuffer : null;
          ye.bindFramebuffer(C.FRAMEBUFFER, We);
          const qe = C.fenceSync(C.SYNC_GPU_COMMANDS_COMPLETE, 0);
          return C.flush(), await pu(C, qe, 4), C.bindBuffer(C.PIXEL_PACK_BUFFER, Se), C.getBufferSubData(C.PIXEL_PACK_BUFFER, 0, J), C.deleteBuffer(Se), C.deleteSync(qe), J;
        } else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.");
      }
    }, this.copyFramebufferToTexture = function(v, D = null, O = 0) {
      v.isTexture !== true && (Jn("WebGLRenderer: copyFramebufferToTexture function signature has changed."), D = arguments[0] || null, v = arguments[1]);
      const B = Math.pow(2, -O), N = Math.floor(v.image.width * B), J = Math.floor(v.image.height * B), ie = D !== null ? D.x : 0, ce = D !== null ? D.y : 0;
      T.setTexture2D(v, 0), C.copyTexSubImage2D(C.TEXTURE_2D, O, 0, 0, ie, ce, N, J), ye.unbindTexture();
    };
    const oh = C.createFramebuffer(), ah = C.createFramebuffer();
    this.copyTextureToTexture = function(v, D, O = null, B = null, N = 0, J = null) {
      v.isTexture !== true && (Jn("WebGLRenderer: copyTextureToTexture function signature has changed."), B = arguments[0] || null, v = arguments[1], D = arguments[2], J = arguments[3] || 0, O = null), J === null && (N !== 0 ? (Jn("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."), J = N, N = 0) : J = 0);
      ...
      if (O !== null) ie = O.max.x - O.min.x, ce = O.max.y - O.min.y, pe = O.isBox3 ? O.max.z - O.min.z : 1, Re = O.min.x, Ce = O.min.y, Se = O.isBox3 ? O.min.z : 0;
        ...
        ie = Math.floor(ct.width * Vt), ce = Math.floor(ct.height * Vt), v.isDataArrayTexture ? pe = ct.depth : v.isData3DTexture ? pe = Math.floor(ct.depth * Vt) : pe = 1, Re = 0, Ce = 0, Se = 0;
      }
      B !== null ? (We = B.x, qe = B.y, pt = B.z) : (We = 0, qe = 0, pt = 0);
      const Xe = De.convert(D.format), Ee = De.convert(D.type);
      let Et;
      D.isData3DTexture ? (T.setTexture3D(D, 0), Et = C.TEXTURE_3D) : D.isDataArrayTexture || D.isCompressedArrayTexture ? (T.setTexture2DArray(D, 0), Et = C.TEXTURE_2D_ARRAY) : (T.setTexture2D(D, 0), Et = C.TEXTURE_2D), C.pixelStorei(C.UNPACK_FLIP_Y_WEBGL, D.flipY), C.pixelStorei(C.UNPACK_PREMULTIPLY_ALPHA_WEBGL, D.premultiplyAlpha), C.pixelStorei(C.UNPACK_ALIGNMENT, D.unpackAlignment);
      const $e = C.getParameter(C.UNPACK_ROW_LENGTH), Kt = C.getParameter(C.UNPACK_IMAGE_HEIGHT), ai = C.getParameter(C.UNPACK_SKIP_PIXELS), Ft = C.getParameter(C.UNPACK_SKIP_ROWS), Ki = C.getParameter(C.UNPACK_SKIP_IMAGES);
      C.pixelStorei(C.UNPACK_ROW_LENGTH, ct.width), C.pixelStorei(C.UNPACK_IMAGE_HEIGHT, ct.height), C.pixelStorei(C.UNPACK_SKIP_PIXELS, Re), C.pixelStorei(C.UNPACK_SKIP_ROWS, Ce), C.pixelStorei(C.UNPACK_SKIP_IMAGES, Se);
      const st = v.isDataArrayTexture || v.isData3DTexture, Ht = D.isDataArrayTexture || D.isData3DTexture;
      if (v.isDepthTexture) {
        const Vt = _e.get(v), Rt = _e.get(D), Dt = _e.get(Vt.__renderTarget), wr = _e.get(Rt.__renderTarget);
        ye.bindFramebuffer(C.READ_FRAMEBUFFER, Dt.__webglFramebuffer), ye.bindFramebuffer(C.DRAW_FRAMEBUFFER, wr.__webglFramebuffer);
        for (let Wn = 0; Wn < pe; Wn++) st && (C.framebufferTextureLayer(C.READ_FRAMEBUFFER, C.COLOR_ATTACHMENT0, _e.get(v).__webglTexture, N, Se + Wn), C.framebufferTextureLayer(C.DRAW_FRAMEBUFFER, C.COLOR_ATTACHMENT0, _e.get(D).__webglTexture, J, pt + Wn)), C.blitFramebuffer(Re, Ce, ie, ce, We, qe, ie, ce, C.DEPTH_BUFFER_BIT, C.NEAREST);
        ...
        const Vt = _e.get(v), Rt = _e.get(D);
        ye.bindFramebuffer(C.READ_FRAMEBUFFER, oh), ye.bindFramebuffer(C.DRAW_FRAMEBUFFER, ah);
        for (let Dt = 0; Dt < pe; Dt++) st ? C.framebufferTextureLayer(C.READ_FRAMEBUFFER, C.COLOR_ATTACHMENT0, Vt.__webglTexture, N, Se + Dt) : C.framebufferTexture2D(C.READ_FRAMEBUFFER, C.COLOR_ATTACHMENT0, C.TEXTURE_2D, Vt.__webglTexture, N), Ht ? C.framebufferTextureLayer(C.DRAW_FRAMEBUFFER, C.COLOR_ATTACHMENT0, Rt.__webglTexture, J, pt + Dt) : C.framebufferTexture2D(C.DRAW_FRAMEBUFFER, C.COLOR_ATTACHMENT0, C.TEXTURE_2D, Rt.__webglTexture, J), N !== 0 ? C.blitFramebuffer(Re, Ce, ie, ce, We, qe, ie, ce, C.COLOR_BUFFER_BIT, C.NEAREST) : Ht ? C.copyTexSubImage3D(Et, J, We, qe, pt + Dt, Re, Ce, ie, ce) : C.copyTexSubImage2D(Et, J, We, qe, Re, Ce, ie, ce);
        ye.bindFramebuffer(C.READ_FRAMEBUFFER, null), ye.bindFramebuffer(C.DRAW_FRAMEBUFFER, null);
      } else Ht ? v.isDataTexture || v.isData3DTexture ? C.texSubImage3D(Et, J, We, qe, pt, ie, ce, pe, Xe, Ee, ct.data) : D.isCompressedArrayTexture ? C.compressedTexSubImage3D(Et, J, We, qe, pt, ie, ce, pe, Xe, ct.data) : C.texSubImage3D(Et, J, We, qe, pt, ie, ce, pe, Xe, Ee, ct) : v.isDataTexture ? C.texSubImage2D(C.TEXTURE_2D, J, We, qe, ie, ce, Xe, Ee, ct.data) : v.isCompressedTexture ? C.compressedTexSubImage2D(C.TEXTURE_2D, J, We, qe, ct.width, ct.height, Xe, ct.data) : C.texSubImage2D(C.TEXTURE_2D, J, We, qe, ie, ce, Xe, Ee, ct);
      C.pixelStorei(C.UNPACK_ROW_LENGTH, $e), C.pixelStorei(C.UNPACK_IMAGE_HEIGHT, Kt), C.pixelStorei(C.UNPACK_SKIP_PIXELS, ai), C.pixelStorei(C.UNPACK_SKIP_ROWS, Ft), C.pixelStorei(C.UNPACK_SKIP_IMAGES, Ki), J === 0 && D.generateMipmaps && C.generateMipmap(Et), ye.unbindTexture();
      ...
      w = 0, A = 0, U = null, ye.reset(), nt.reset();
...
const x_ = { isPrimitive: true, match: (s) => typeof s == "string", fromHexString: ia, toHexString: ia }, Ss = { isPrimitive: true, match: (s) => typeof s == "number", fromHexString: (s) => parseInt(s.substring(1), 16), toHexString: (s) => "#" + s.toString(16).padStart(6, 0) }, v_ = { isPrimitive: false, match: Array.isArray, fromHexString(s, e, t = 1) {
  const n = Ss.fromHexString(s);
  e[0] = (n >> 16 & 255) / 255 * t, e[1] = (n >> 8 & 255) / 255 * t, e[2] = (255 & n) / 255 * t;
}, toHexString: ([s, e, t], n = 1) => Ss.toHexString(s * (n = 255 / n) << 16 ^ e * n << 8 ^ t * n << 0) }, M_ = { isPrimitive: false, match: (s) => Object(s) === s, fromHexString(s, e, t = 1) {
  const n = Ss.fromHexString(s);
  e.r = (n >> 16 & 255) / 255 * t, e.g = (n >> 8 & 255) / 255 * t, e.b = (255 & n) / 255 * t;
}, toHexString: ({ r: s, g: e, b: t }, n = 1) => Ss.toHexString(s * (n = 255 / n) << 16 ^ e * n << 8 ^ t * n << 0) }, y_ = [x_, Ss, v_, M_];
class S_ extends hn {
  constructor(e, t, n, i) {
    var r;
...
class A_ {
  constructor() {
    ...
    this.camera = new Cs(-this.viewportSize * n / 2, this.viewportSize * n / 2, this.viewportSize / 2, -this.viewportSize / 2, 0.1, 1e3), this.camera.position.set(10, 10, 10), this.camera.lookAt(0, 0, 0), this.renderer = new Jc({ antialias: true, preserveDrawingBuffer: true }), this.renderer.setSize(e, t), this.renderer.setPixelRatio(window.devicePixelRatio), this.renderer.shadowMap.enabled = true, this.setupLights(), window.addEventListener("resize", this.onWindowResize.bind(this));
  }
  setupLights() {
    const e = new Xc(16777215, 0.3);
    this.scene.add(e);
    const t = new yr(16777215, 0.7);
...
class R_ extends Dd {
  ...
  update(e = null) {
    ...
    if (gt.setFromSpherical(this._spherical), gt.applyQuaternion(this._quatInverse), t.copy(this.target).add(gt), this.object.lookAt(this.target), this.enableDamping === true ? (this._sphericalDelta.theta *= 1 - this.dampingFactor, this._sphericalDelta.phi *= 1 - this.dampingFactor, this._panOffset.multiplyScalar(1 - this.dampingFactor)) : (this._sphericalDelta.set(0, 0, 0), this._panOffset.set(0, 0, 0)), this.zoomToCursor && this._performCursorZoom) {
      ...
      o !== null && (this.screenSpacePanning ? this.target.set(0, 0, -1).transformDirection(this.object.matrix).multiplyScalar(o).add(this.object.position) : (lr.origin.copy(this.object.position), lr.direction.set(0, 0, -1).transformDirection(this.object.matrix), Math.abs(this.object.up.dot(lr.direction)) < w_ ? this.object.lookAt(this.target) : (ac.setFromNormalAndCoplanarPoint(this.object.up, this.target), lr.intersectPlane(ac, this.target))));
    } else if (this.object.isOrthographicCamera) {
...
function U_(s) {
  this.enabled === false || this.enableZoom === false || this.state !== et.NONE || (s.preventDefault(), this.dispatchEvent(Ca), this._handleMouseWheel(this._customWheelEvent(s)), this.dispatchEvent(Qc));
}
function N_(s) {
...
class H_ {
  constructor(e, t, n) {
    ...
    const i = new ys(0.05), r = new cn({ color: 16711680 });
    this.sphereInter = new at(i, r), this.sphereInter.visible = false, this.sceneManager.getScene().add(this.sphereInter), this.renderer.domElement.addEventListener("pointerdown", this.onPointerDown.bind(this));
  }
  ...
  onPointerDown(e) {
    ...
    if (a.length > 0) {
      ...
      if (c instanceof at && c.geometry instanceof ft) {
  ...
  addOrUpdateSelectionHelper(e, t) {
    ...
    if (!n) {
      const i = new ys(0.03), r = new cn({ color: 65280, depthTest: false });
      n = new at(i, r), n.renderOrder = 999, this.sceneManager.getScene().add(n), this.selectionHelpers.set(e, n);
    }
    n.position.copy(t);
  }
...
function lc(s, e) {
  if (e === kh) return console.warn("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Geometry already defined as triangles."), s;
  if (e === Zo || e === Tc) {
    let t = s.getIndex();
    if (t === null) {
...
class V_ extends oi {
  ...
  load(e, t, n, i) {
    ...
    if (this.resourcePath !== "") o = this.resourcePath;
      ...
      const c = fs.extractUrlBase(e);
      o = fs.resolveURL(c, this.path);
    } else o = fs.extractUrlBase(e);
    this.manager.itemStart(e);
    const a = function(c) {
  ...
  parse(e, t, n, i) {
    ...
    else if (e instanceof ArrayBuffer) if (l.decode(new Uint8Array(e, 0, 4)) === eh) {
      try {
...
class W_ {
  ...
  _loadLight(e) {
    ...
    switch (l.type) {
      case "directional":
        c = new yr(h), c.target.position.set(0, 0, -1), c.add(c.target);
        break;
      case "point":
  ...
  extendParams(e, t, n) {
    ...
    if (r) {
      if (Array.isArray(r.baseColorFactor)) {
        ...
        e.color.setRGB(o[0], o[1], o[2], It), e.opacity = o[3];
      }
...
class J_ {
  ...
  extendMaterialParams(e, t) {
    ...
    return t.attenuationColor = new ve().setRGB(a[0], a[1], a[2], It), Promise.all(r);
  }
}
class Q_ {
  constructor(e) {
...
class ex {
  ...
  extendMaterialParams(e, t) {
    ...
    return t.specularColor = new ve().setRGB(a[0], a[1], a[2], It), o.specularColorTexture !== void 0 && r.push(n.assignTexture(t, "specularColorMap", o.specularColorTexture, yt)), Promise.all(r);
  }
}
class tx {
  constructor(e) {
  ...
  createNodeMesh(e) {
    ...
    return a.length < 1 ? null : (a.push(this.parser.createNodeMesh(e)), Promise.all(a).then((c) => {
      ...
      for (const g of u) {
        ...
        rt.prototype.copy.call(b, g), this.parser.assignFinalMaterial(b), p.push(b);
      }
      return h.isGroup ? (h.clear(), h.add(...p), h) : p[0];
    }));
  }
}
const eh = "glTF", ls = 12, cc = { JSON: 1313821514, BIN: 5130562 };
class lx {
  constructor(e) {
    ...
    const i = this.header.length - ls, r = new DataView(e, ls);
    let o = 0;
    for (; o < i; ) {
      ...
      if (o += 4, l === cc.JSON) {
        const c = new Uint8Array(e, ls + o, a);
...
class th extends ws {
  ...
  interpolate_(e, t, n, i) {
    ...
    for (let M = 0; M !== a; M++) {
      const L = o[_ + M + a], w = o[_ + M + l] * h, A = o[g + M + a], U = o[g + M] * h;
      r[M] = E * L + b * w + m * A + f * U;
    }
    return r;
  }
...
const Wt = { POINTS: 0, LINES: 1, LINE_LOOP: 2, LINE_STRIP: 3, TRIANGLES: 4, TRIANGLE_STRIP: 5, TRIANGLE_FAN: 6 }, Di = { 5120: Int8Array, 5121: Uint8Array, 5122: Int16Array, 5123: Uint16Array, 5125: Uint32Array, 5126: Float32Array }, hc = { 9728: Lt, 9729: zt, 9984: mc, 9985: cr, 9986: cs, 9987: bn }, uc = { 33071: Bn, 33648: gr, 10497: Oi }, ho = { SCALAR: 1, VEC2: 2, VEC3: 3, VEC4: 4, MAT2: 4, MAT3: 9, MAT4: 16 }, sa = { POSITION: "position", NORMAL: "normal", TANGENT: "tangent", TEXCOORD_0: "uv", TEXCOORD_1: "uv1", TEXCOORD_2: "uv2", TEXCOORD_3: "uv3", COLOR_0: "color", WEIGHTS_0: "skinWeight", JOINTS_0: "skinIndex" }, Nn = { scale: "scale", translation: "position", rotation: "quaternion", weights: "morphTargetInfluences" }, px = { CUBICSPLINE: void 0, LINEAR: _s, STEP: gs }, uo = { OPAQUE: "OPAQUE", MASK: "MASK", BLEND: "BLEND" };
function mx(s) {
  return s.DefaultMaterial === void 0 && (s.DefaultMaterial = new br({ color: 16777215, emissive: 0, metalness: 1, roughness: 1, transparent: false, depthTest: true, side: wn })), s.DefaultMaterial;
}
function Zn(s, e, t) {
...
class yx {
  ...
  parse(e, t) {
    ...
    this.cache.removeAll(), this.nodeCache = {}, this._invokeAll(function(o) {
      ...
      return Zn(r, a, i), En(a, i), Promise.all(n._invokeAll(function(l) {
  ...
  loadAccessor(e) {
    ...
    if (i.bufferView === void 0 && i.sparse === void 0) {
      const o = ho[i.type], a = Di[i.componentType], l = i.normalized === true, c = new a(i.count * o);
    ...
    return i.bufferView !== void 0 ? r.push(this.getDependency("bufferView", i.bufferView)) : r.push(null), i.sparse !== void 0 && (r.push(this.getDependency("bufferView", i.sparse.indices.bufferView)), r.push(this.getDependency("bufferView", i.sparse.values.bufferView))), Promise.all(r).then(function(o) {
      const a = o[0], l = ho[i.type], c = Di[i.componentType], h = c.BYTES_PER_ELEMENT, u = h * l, d = i.byteOffset || 0, p = i.bufferView !== void 0 ? n.bufferViews[i.bufferView].byteStride : void 0, g = i.normalized === true;
      let _, m;
      if (p && p !== u) {
        const f = Math.floor(d / p), E = "InterleavedBuffer:" + i.bufferView + ":" + i.componentType + ":" + f + ":" + i.count;
        let b = t.cache.get(E);
        b || (_ = new c(a, f * p, i.count * p / h), b = new Fc(_, p / h), t.cache.add(E, b)), m = new vs(b, l, d % p / h, g);
      } else a === null ? _ = new c(i.count * l) : _ = new c(a, d, i.count * l), m = new ht(_, l, g);
      if (i.sparse !== void 0) {
        const f = ho.SCALAR, E = Di[i.sparse.indices.componentType], b = i.sparse.indices.byteOffset || 0, M = i.sparse.values.byteOffset || 0, L = new E(o[1], b, i.sparse.count * f), w = new c(o[2], M, i.sparse.count * l);
        a !== null && (m = new ht(m.array.slice(), m.itemSize, m.normalized)), m.normalized = false;
  ...
  loadTextureImage(e, t, n) {
    ...
    const c = this.loadImageSource(t, n).then(function(h) {
      ...
      return h.magFilter = hc[d.magFilter] || zt, h.minFilter = hc[d.minFilter] || bn, h.wrapS = uc[d.wrapS] || Oi, h.wrapT = uc[d.wrapT] || Oi, h.generateMipmaps = !h.isCompressedTexture && h.minFilter !== Lt && h.minFilter !== zt, i.associations.set(h, { textures: e }), h;
    }).catch(function() {
      return null;
    });
  ...
  loadImageSource(e, t) {
    ...
    const h = Promise.resolve(l).then(function(u) {
      return new Promise(function(d, p) {
        ...
        }), t.load(fs.resolveURL(u, r.path), g, void 0, p);
      });
    }).then(function(u) {
  ...
  assignFinalMaterial(e) {
    ...
    if (e.isPoints) {
      ...
      l || (l = new Hc(), qt.prototype.copy.call(l, n), l.color.copy(n.color), l.map = n.map, l.sizeAttenuation = false, this.cache.add(a, l)), n = l;
    } else if (e.isLine) {
      const a = "LineBasicMaterial:" + n.uuid;
      let l = this.cache.get(a);
      l || (l = new As(), qt.prototype.copy.call(l, n), l.color.copy(n.color), l.map = n.map, this.cache.add(a, l)), n = l;
    }
    if (i || r || o) {
  ...
  loadMaterial(e) {
    ...
    if (l[Oe.KHR_MATERIALS_UNLIT]) {
      ...
      if (a.color = new ve(1, 1, 1), a.opacity = 1, Array.isArray(u.baseColorFactor)) {
        ...
        a.color.setRGB(d[0], d[1], d[2], It), a.opacity = d[3];
      }
    ...
    if (r.occlusionTexture !== void 0 && o !== cn && (c.push(t.assignTexture(a, "aoMap", r.occlusionTexture)), r.occlusionTexture.strength !== void 0 && (a.aoMapIntensity = r.occlusionTexture.strength)), r.emissiveFactor !== void 0 && o !== cn) {
      ...
      a.emissive = new ve().setRGB(u[0], u[1], u[2], It);
    }
    return r.emissiveTexture !== void 0 && o !== cn && c.push(t.assignTexture(a, "emissiveMap", r.emissiveTexture, yt)), Promise.all(c).then(function() {
      const u = new o(a);
      return r.name && (u.name = r.name), En(u, r), t.associations.set(u, { materials: e }), r.extensions && Zn(i, u, r), u;
    });
  }
  createUniqueName(e) {
  ...
  loadMesh(e) {
    ...
    return a.push(t.loadGeometries(o)), Promise.all(a).then(function(l) {
      ...
      for (let p = 0, g = h.length; p < g; p++) {
        ...
        let f;
        const E = c[p];
        if (m.mode === Wt.TRIANGLES || m.mode === Wt.TRIANGLE_STRIP || m.mode === Wt.TRIANGLE_FAN || m.mode === void 0) f = r.isSkinnedMesh === true ? new Gu(_, E) : new at(_, E), f.isSkinnedMesh === true && f.normalizeSkinWeights(), m.mode === Wt.TRIANGLE_STRIP ? f.geometry = lc(f.geometry, Tc) : m.mode === Wt.TRIANGLE_FAN && (f.geometry = lc(f.geometry, Zo));
        else if (m.mode === Wt.LINES) f = new Sa(_, E);
        else if (m.mode === Wt.LINE_STRIP) f = new Ms(_, E);
        else if (m.mode === Wt.LINE_LOOP) f = new $u(_, E);
        else if (m.mode === Wt.POINTS) f = new Ku(_, E);
        else throw new Error("THREE.GLTFLoader: Primitive mode unsupported: " + m.mode);
        Object.keys(f.geometry.morphAttributes).length > 0 && _x(f, r), f.name = t.createUniqueName(r.name || "mesh_" + e), En(f, r), m.extensions && Zn(i, f, m), t.assignFinalMaterial(f), u.push(f);
      }
  ...
  loadCamera(e) {
    ...
    return n.type === "perspective" ? t = new wt(wc.radToDeg(i.yfov), i.aspectRatio || 1, i.znear || 1, i.zfar || 2e6) : n.type === "orthographic" && (t = new Cs(-i.xmag, i.xmag, i.ymag, -i.ymag, i.znear, i.zfar)), n.name && (t.name = this.createUniqueName(n.name)), En(t, n), Promise.resolve(t);
  }
  loadSkin(e) {
  ...
  loadAnimation(e) {
    ...
    return Promise.all([Promise.all(o), Promise.all(a), Promise.all(l), Promise.all(c), Promise.all(h)]).then(function(u) {
      ...
      for (let E = 0, b = d.length; E < b; E++) {
        const M = d[E], L = p[E], w = g[E], A = _[E], U = m[E];
        if (M === void 0) continue;
        M.updateMatrix && M.updateMatrix();
        const S = n._createAnimationTracks(M, L, w, A, U);
        if (S) for (let y = 0; y < S.length; y++) f.push(S[y]);
      }
      return new ad(r, void 0, f);
    });
  }
  createNodeMesh(e) {
  ...
  _loadNodeShallow(e) {
    ...
    return l && a.push(l), r.camera !== void 0 && a.push(i.getDependency("camera", r.camera).then(function(c) {
      ...
      let h;
      if (r.isBone === true ? h = new zc() : c.length > 1 ? h = new ni() : c.length === 1 ? h = c[0] : h = new rt(), h !== c[0]) for (let u = 0, d = c.length; u < d; u++) h.add(c[u]);
      if (r.name && (h.userData.name = r.name, h.name = o), En(h, r), r.extensions && Zn(n, h, r), r.matrix !== void 0) {
        const u = new Pe();
  ...
  loadScene(e) {
    ...
    n.name && (r.name = i.createUniqueName(n.name)), En(r, n), n.extensions && Zn(t, r, n);
    const o = n.nodes || [], a = [];
    ...
    return Promise.all(a).then(function(l) {
      ...
      const c = (h) => {
        ...
        for (const [d, p] of i.associations) (d instanceof qt || d instanceof _t) && u.set(d, p);
        return h.traverse((d) => {
  ...
  _createAnimationTracks(e, t, n, i, r) {
    ...
    const h = i.interpolation !== void 0 ? px[i.interpolation] : _s, u = this._getArrayFromAccessor(n);
  ...
  _createCubicSplineTrackInterpolant(e) {
    e.createInterpolant = function(n) {
      const i = this instanceof Gi ? fx : th;
...
function dc(s, e, t) {
  ...
  return Ve.workingColorSpace !== It && "COLOR_0" in n && console.warn(`THREE.GLTFLoader: Converting vertex colors from "srgb-linear" to "${Ve.workingColorSpace}" not supported.`), En(s, e), Sx(s, e, t), Promise.all(i).then(function() {
...
class Ex extends oi {
  ...
  parse(e) {
    ...
    function i(c) {
      ...
      const L = 84, w = 12 * 4 + 2, A = new ft(), U = new Float32Array(u * 3 * 3), S = new Float32Array(u * 3 * 3), y = new ve();
      for (let P = 0; P < u; P++) {
        const G = L + P * w, k = h.getFloat32(G, true), Y = h.getFloat32(G + 4, true), $ = h.getFloat32(G + 8, true);
        if (_) {
        ...
        for (let V = 1; V <= 3; V++) {
          ...
          U[z] = h.getFloat32(K, true), U[z + 1] = h.getFloat32(K + 4, true), U[z + 2] = h.getFloat32(K + 8, true), S[z] = k, S[z + 1] = Y, S[z + 2] = $, _ && (y.setRGB(d, p, g, yt), m[z] = y.r, m[z + 1] = y.g, m[z + 2] = y.b);
        }
      }
      return A.setAttribute("position", new ht(U, 3)), A.setAttribute("normal", new ht(S, 3)), _ && (A.setAttribute("color", new ht(m, 3)), A.hasColors = true, A.alpha = M), A;
    }
    function r(c) {
      ...
      for (; (w = u.exec(c)) !== null; ) {
        ...
        for (M.push(P); (w = d.exec(y)) !== null; ) {
          ...
          for (; (w = m.exec(V)) !== null; ) E.push(parseFloat(w[1]), parseFloat(w[2]), parseFloat(w[3])), b.push(L.x, L.y, L.z), Y++, S++;
          $ !== 1 && console.error("THREE.STLLoader: Something isn't right with the normal of face number " + g), Y !== 3 && console.error("THREE.STLLoader: Something isn't right with the vertices of face number " + g), g++;
        }
        const G = U, k = S - U;
...
class bx {
  ...
  static loadSTL(e, t) {
    new Ex().load(e, (i) => {
      const r = new Ju({ color: 11184810, specular: 1118481, shininess: 200 }), o = new at(i, r);
      t.onLoad(o);
    }, (i) => {
      if (i.lengthComputable && t.onProgress) {
        const r = Math.floor(i.loaded / i.total * 100);
...
class wx {
  constructor(e) {
    ...
    this.mainCamera = e, this.scene = new Nc(), this.scene.background = new ve(2236962), this.camera = new wt(50, 1, 0.1, 100), this.camera.position.set(0, 0, this.cameraDistance), this.camera.lookAt(0, 0, 0), this.renderer = new Jc({ antialias: true, alpha: true }), this.renderer.setSize(100, 100), this.renderer.setPixelRatio(window.devicePixelRatio);
  ...
  createAxes() {
    ...
    const t = new ys(0.05, 16, 16), n = new cn({ color: 16777215 }), i = new at(t, n);
    this.scene.add(i);
    const r = new yr(16777215, 1);
    r.position.set(1, 1, 1), this.scene.add(r);
    const o = new Xc(16777215, 0.5);
    this.scene.add(o);
  }
  createAxisLabel(e, t, n) {
    ...
    const o = new Zu(i), a = new Oc({ map: o, transparent: true }), l = new Hu(a);
    l.position.copy(t), l.scale.set(0.5, 0.5, 0.5), this.scene.add(l), this.axesLabels.push(l);
  }
  update() {
    if (this.mainCamera instanceof Cs || this.mainCamera instanceof wt) {
      const e = new R();
...
class Rx {
  ...
  createGrid() {
    this.gridHelper = new Id(this.gridSize, this.gridDivisions, 8947848, 13421772), this.gridHelper.position.y = -0.01, this.scene.add(this.gridHelper);
    const e = new As({ color: 4473924, linewidth: 2 }), t = new ft().setFromPoints([new R(-this.gridSize / 2, 0, 0), new R(this.gridSize / 2, 0, 0)]), n = new Ms(t, e);
    this.scene.add(n);
    const i = new ft().setFromPoints([new R(0, 0, -this.gridSize / 2), new R(0, 0, this.gridSize / 2)]), r = new Ms(i, e);
    this.scene.add(r);
  }
  createAxes() {
...
class Cx {
  ...
  updateModelInfo(e, t) {
    ...
    const a = new rn().setFromObject(e), l = new R();
...
class Lx {
  ...
  createTreeNode(e, t = false) {
    if (e instanceof Rs || e instanceof va || e.type === "GridHelper" || e.type === "AxesHelper" || e.name === "ViewCube") return null;
...
const _dt = class _dt {
  ...
  union(e) {
    let t = new an(this.clone().polygons), n = new an(e.clone().polygons);
...
__publicField(_dt, "fromGeometry", function(e, t) {
  ...
  for (let h = 0, u = 0, d = l.length; h < d; h += 3, u++) {
    ...
    for (let g = 0; g < 3; g++) {
      ...
      p[g] = new Es({ x: E, y: b, z: M }, { x: L, y: w, z: A }, o && { x: o.array[f], y: o.array[f + 1], z: 0 }, a && { x: a.array[f], y: a.array[f + 1], z: a.array[f + 2] });
    }
    n[u] = new Xi(p, t);
  }
...
__publicField(_dt, "toGeometry", function(e) {
  ...
  }), n.setAttribute("position", new ht(r.array, 3)), n.setAttribute("normal", new ht(o.array, 3)), a && n.setAttribute("uv", new ht(a.array, 2)), l && n.setAttribute("color", new ht(l.array, 3)), Object.keys(c).length) {
    let h = [], u = 0;
...
const _jt = class _jt {
  ...
  clone() {
    return new _jt(this.x, this.y, this.z);
  }
  negate() {
  ...
  lerp(e, t) {
    return this.add(_jt.tv0.copy(e).sub(this).times(t));
  }
  unit() {
...
__publicField(_jt, "tv0", new _jt());
__publicField(_jt, "tv1", new _jt());
let jt = _jt;
class Es {
  constructor(e, t, n, i) {
    ...
    this.pos = new jt().copy(e), this.normal = new jt().copy(t), n && (this.uv = new jt().copy(n)) && (this.uv.z = 0), i && (this.color = new jt().copy(i));
  }
  clone() {
    return new Es(this.pos, this.normal, this.uv, this.color);
  }
  flip() {
    this.normal.negate();
  }
  interpolate(e, t) {
    return new Es(this.pos.clone().lerp(e.pos, t), this.normal.clone().lerp(e.normal, t), this.uv && e.uv && this.uv.clone().lerp(e.uv, t), this.color && e.color && this.color.clone().lerp(e.color, t));
  }
}
const _ps = class _ps {
  constructor(e, t) {
  ...
  clone() {
    return new _ps(this.normal.clone(), this.w);
  }
  flip() {
  ...
  splitPolygon(e, t, n, i, r) {
    ...
    for (let d = 0; d < e.vertices.length; d++) {
      let p = this.normal.dot(e.vertices[d].pos) - this.w, g = p < -1e-5 ? 2 : p > _ps.EPSILON ? 1 : 0;
      h |= g, u.push(g);
    }
    switch (h) {
      case 0:
      ...
      case 3:
        ...
        for (let g = 0; g < e.vertices.length; g++) {
          ...
          if (m != 2 && d.push(E), m != 1 && p.push(m != 2 ? E.clone() : E), (m | f) == 3) {
            let M = (this.w - this.normal.dot(E.pos)) / this.normal.dot(jt.tv0.copy(b.pos).sub(E.pos)), L = E.interpolate(b, M);
            d.push(L), p.push(L.clone());
          }
        }
        d.length >= 3 && i.push(new Xi(d, e.shared)), p.length >= 3 && r.push(new Xi(p, e.shared));
        break;
    }
  }
};
__publicField(_ps, "EPSILON", 1e-5);
__publicField(_ps, "fromPoints", function(e, t, n) {
  let i = jt.tv0.copy(t).sub(e).cross(jt.tv1.copy(n).sub(e)).normalize();
  return new _ps(i.clone(), i.dot(e));
});
let ps = _ps;
class Xi {
  constructor(e, t) {
    ...
    this.vertices = e, this.shared = t, this.plane = ps.fromPoints(e[0].pos, e[1].pos, e[2].pos);
  }
  clone() {
    return new Xi(this.vertices.map((e) => e.clone()), this.shared);
  }
  flip() {
...
const _an = class _an {
  ...
  build(e) {
    ...
    t.length && (this.front || (this.front = new _an()), this.front.build(t)), n.length && (this.back || (this.back = new _an()), this.back.build(n));
  }
};
__publicField(_an, "fromJSON", function(e) {
  return dt.fromPolygons(e.polygons.map((t) => new Xi(t.vertices.map((n) => new Es(n.pos, n.normal, n.uv)), t.shared)));
});
let an = _an;
class Ix {
  constructor() {
  ...
  performSubtract(e, t) {
    ...
    try {
      ...
      const n = dt.fromMesh(e), i = dt.fromMesh(t), r = n.subtract(i), o = new br({ color: 16711680, roughness: 0.5, metalness: 0.1 }), a = dt.toMesh(r, e.matrixWorld, o);
...
class Dx {
  constructor() {
    ...
    this.sceneManager = new A_(), this.mainContentArea = document.createElement("div"), this.mainContentArea.classList.add("main-content-area"), document.body.appendChild(this.mainContentArea), this.mainContentArea.appendChild(this.sceneManager.getDomElement()), this.controlsManager = new H_(this.sceneManager.getCamera(), this.sceneManager.getRenderer(), this.sceneManager), this.alignmentManager = new Px(this.controlsManager), this.csgManager = new Ix(), this.sceneTreeViewer = new Lx("scene-tree-container"), this.sceneTreeViewer.onNodeSelected = this.handleNodeSelection.bind(this), this.sceneTreeViewer.onNodeVisibilityChange = this.handleNodeVisibilityChange.bind(this), this.loadingIndicator = new Tx(), this.messageHandler = new Ax(this.loadModel.bind(this), this.unloadModel.bind(this)), this.viewCube = new wx(this.sceneManager.getCamera());
    const e = document.getElementById("view-cube-container");
    if (e ? this.mainContentArea.appendChild(e) : console.warn("ViewCube element not found by ID 'view-cube-container'"), this.gridAndAxes = new Rx(this.sceneManager.getScene()), this.modelInfoPanel = new Cx(), this.modelInfoPanel.getElement) this.mainContentArea.appendChild(this.modelInfoPanel.getElement());
    else {
      ...
      try {
        ...
        console.error("Failed to append ModelInfoPanel", t);
      }
    }
  ...
  loadModel(e, t) {
    ...
    const n = { onLoad: (i) => {
      ...
      const o = new rn().setFromObject(i), a = o.getCenter(new R()), l = o.getSize(new R()), c = Math.max(l.x, l.y, l.z);
  ...
  unloadModel(e) {
    ...
    if (t) {
      ...
      n && (n.traverse((i) => {
        i instanceof at && (i.geometry && i.geometry.dispose(), Array.isArray(i.material) ? i.material.forEach((r) => r.dispose()) : i.material && i.material.dispose());
  ...
  createUI() {
    ...
    }, e.appendChild(this.alignButton), this.performCSGSubtractButton = document.createElement("button"), this.performCSGSubtractButton.textContent = "CSG \uBE7C\uAE30 (\uC120\uD0DD\uB41C 2\uAC1C)", this.performCSGSubtractButton.disabled = true, this.performCSGSubtractButton.onclick = this.performCSGSubtract.bind(this), e.appendChild(this.performCSGSubtractButton), this.mainContentArea.appendChild(e);
  }
  ...
  async performCSGSubtract() {
    ...
    if (!(i instanceof at) || !(r instanceof at)) {
